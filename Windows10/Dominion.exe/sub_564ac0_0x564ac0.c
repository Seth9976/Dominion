...
struct std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_0ddb585d263783132cd3ba43c0d7763b>,bool,enum CardID>::VTable
    * const var_d10 = &std::_Func_impl_no_alloc<class <lambda_0ddb585d263783132cd3ba43c0d7763b>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'}
void var_cb0
...
if (eax_8 != 0)
    ...
    result_1 = sub_563c40(&var_d40, 0xc, 0)
...
if (eax_8 == 0 || result_1 == 0)
    ...
    if (sub_583720(eax_13, *(eax_13 + 0xc), *(eax_13 + 4), result_1, 0x474, ecx, 0x476, 0, 0, 4)
            == 0)
        result_1 = nullptr
