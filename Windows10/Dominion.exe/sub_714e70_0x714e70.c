...
if (esi[0x1b] != 0)
    ...
    if (*edi_1 f<= arg3)
        ...
        switch (eax_1)
            case 0
                void* eax_14 = *esi
                esi[5] = xmm2_2 * arg4 f+ *(eax_14 + 0x10)
                esi[6] = xmm3_1 * arg4 f+ *(eax_14 + 0x14)
                return eax_14
            case 1, 2
                void* eax_15 = *esi
                esi[5] = (xmm2_2 f+ *(eax_15 + 0x10) f- esi[5]) * arg4 f+ esi[5]
                esi[6] = (xmm3_1 f+ *(eax_15 + 0x14) f- esi[6]) * arg4 f+ esi[6]
                return eax_15
            case 3
                float xmm3_14 = xmm3_1 * arg4 f+ esi[6]
                esi[5] = xmm2_2 * arg4 f+ esi[5]
                esi[6] = xmm3_14
    else
        if (arg5 == 0)
            void* ecx_1 = *esi
            esi[5] = *(ecx_1 + 0x10)
            int32_t eax_6 = *(ecx_1 + 0x14)
            esi[6] = eax_6
            return eax_6
        ...
        if (arg5 == 1)
            void* eax_4 = *esi
            esi[5] = (*(eax_4 + 0x10) f- esi[5]) * arg4 f+ esi[5]
            esi[6] = (*(eax_4 + 0x14) f- esi[6]) * arg4 f+ esi[6]
            return eax_4
