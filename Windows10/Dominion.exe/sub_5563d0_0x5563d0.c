...
if ((var_20.d | var_20:4.d) != 0)
    ...
    if (var_28_1 != 0)
        eax_4 = (*var_28_1)->vFunc_0(&var_d3c)
        int32_t* var_d18_2 = eax_4
    
    var_8_1.b = 0
    int32_t var_8_2 = 0xffffffff
    esi = GSI1::OffForSym(eax_4, esi, &var_cfc)
    int32_t var_7c_1 = esi
    
    if (var_28_1 != 0)
        struct std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_27f5207e4f31665c1a246b29a8d87f28>,bool,enum CardID>::VTable
            * const* eax_7
        eax_7.b = var_28_1 != &var_4c
        (*var_28_1)->vFunc_4(eax_7)
...
if (var_18 != 0)
    ...
    if (var_50_1 != 0)
        eax_8 = (*var_50_1)->vFunc_0(&var_d3c)
        void** var_d18_4 = eax_8
    
    var_8_3.b = 3
    esi = GSI1::OffForSym(eax_8, esi, &var_cfc)
