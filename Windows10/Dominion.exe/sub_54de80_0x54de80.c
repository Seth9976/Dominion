...
struct std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_5280eb68b2fdb9b45a2e3e8004dd66db>,bool,enum CardID>::VTable
    * const var_cc4 = &std::_Func_impl_no_alloc<class <lambda_5280eb68b2fdb9b45a2e3e8004dd66db>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'}
void var_c98
