...
do
    ...
    if (eax_4 != 0 || *ebx_1 != eax_4 || ebx_1[8] != eax_4 || ebx_1[0x10] != eax_4
        ...
        int32_t ecx_1 = sx.d(ebx_1[0x20])
        int32_t edx_1 = (ecx_1 + esi_2) * 0x8a9
        int32_t edi_3 = edx_1 - ecx_1 * 0x1d8f
        int32_t eax_9 = sx.d(ebx_1[0x10])
        int32_t ecx_3 = esi_2 * 0xc3f + edx_1
        ...
        int32_t ecx_5 = edi_4 + sx.d(ebx_1[8])
        int32_t edx_7 = sx.d(ebx_1[0x18]) + esi_6
        int32_t ecx_6 = ecx_5 * 0xffffe09e
        int32_t ebx_2 = (edx_7 + ecx_5) * 0x12d0
        ...
        int32_t esi_11 = sx.d(var_10c[8]) * 0x312a + ecx_6 + ebx_3
        int32_t var_114_3 = sx.d(var_10c[0x18]) * 0x20da + eax_19 + ebx_3
        int32_t ebx_7 = sx.d(var_10c[0x28]) * 0x4c7 + edi_6 + ecx_6
        edx = var_118
        *(var_118 - 0x20) = (esi_4 + ecx_3 + 0x200 + edx_11) s>> 0xa
        *(edx + 0xc0) = (esi_4 + ecx_3 + 0x200 - edx_11) s>> 0xa
        ...
        *(edx + 0x20) = (edx_4 - edi_3 + 0x200 + var_114_3) s>> 0xa
        ...
        ebx_1 = var_10c
        eax_6 = (esi_4 - ecx_3 + 0x200 + ebx_7) s>> 0xa
        edi_1 = (esi_4 - ecx_3 + 0x200 - ebx_7) s>> 0xa
    else
...
do
    int32_t ecx_12 = *ebx_8
    int32_t esi_19 = *(ebx_8 - 0x10)
    int32_t edx_14 = (ecx_12 + esi_19) * 0x8a9
    int32_t ecx_13 = *(ebx_8 - 8)
    int32_t esi_21 = esi_19 * 0xc3f + edx_14
    int32_t edi_14 = edx_14 - ecx_12 * 0x1d8f
    int32_t eax_32 = *(ebx_8 - 0x18)
    int32_t eax_34 = (eax_32 - ecx_13) << 0xc
    int32_t edx_16 = (ecx_13 + eax_32) << 0xc
    ...
    int32_t ecx_23 = esi_23 * 0xfffff9c3
    int32_t eax_39 = edi_15 * 0x1805 + ecx_23 + ebx_11
    int32_t eax_42 = *(var_10c_1 - 0xc) * 0x312a + edx_20 + var_118_2
    int32_t var_118_3 = var_118_2 + *(var_10c_1 - 4) * 0x20da + ecx_23
    int32_t eax_48 = *(var_10c_1 + 4) * 0x4c7 + ebx_11 + edx_20
    int32_t ecx_25 = (edx_16 + esi_21 + 0x1010000 + eax_39) s>> 0x11
    int32_t var_114_4 = ecx_25
    ...
    *(var_120 + 2) = result.b
    int32_t ecx_29 = (edx_16 - esi_21 + 0x1010000 - eax_48) s>> 0x11
    
    if (ecx_29 u> 0xff)
        if (ecx_29 s< 0)
            ecx_29.b = 0
        else if (ecx_29 s> 0xff)
            ecx_29.b = 0xff
