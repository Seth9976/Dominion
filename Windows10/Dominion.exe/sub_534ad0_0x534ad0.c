...
if (result != 0)
    ...
    struct std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_be9433cff920c5cde021ead431dfd5a7>,bool,enum CardID>::VTable
        * const var_d10 = &std::_Func_impl_no_alloc<class <lambda_be9433cff920c5cde021ead431dfd5a7>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'}
