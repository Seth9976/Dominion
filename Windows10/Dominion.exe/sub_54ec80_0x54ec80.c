...
struct std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_fa4bd6d4c0fea98e99a5e249a75dc232>,bool,enum CardID>::VTable
    * const var_cc4 = &std::_Func_impl_no_alloc<class <lambda_fa4bd6d4c0fea98e99a5e249a75dc232>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'}
void var_c98
