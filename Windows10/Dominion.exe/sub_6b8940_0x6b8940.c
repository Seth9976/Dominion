...
if (edi[2] != 1 || p_2)
    ...
    int32_t ecx_2 = (*(esi_1 + 0x2c) + *arg2) * *arg2
    float xmm1_1 = *(esi_1 + 0x2f0)
    int32_t edx_2 = (ecx_2 << 0xf) + not.d(ecx_2)
    int32_t ecx_4 = (edx_2 u>> 0xc ^ edx_2) * 5
    int32_t eax_8 = (ecx_4 u>> 4 ^ ecx_4) * 0x809
    int32_t eax_9 = *(esi_1 + 0x2f4)
    int32_t edx_3 = eax_9 - 1
    
    if (xmm1_1 f<= *(esi_1 + 0x2e8))
        edx_3 = eax_9
    
    var_8_1 =
        sub_706bb0(edi, edx_3, xmm1_1, (((eax_8 u>> 0x10 ^ eax_8) & 0x7fffff) | 0x3f800000) - 1f)
