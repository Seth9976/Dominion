...
float var_14 = (xmm4 f+ arg3[9]) * 0.5f
float var_10 = (xmm5 f+ arg3[0xa]) * 0.5f
float xmm1_1 = arg3[7] f- xmm5
float var_c = (xmm6 f+ arg3[0xb]) * 0.5f
...
if (9.99999975e-06f <= xmm0_19)
    ...
    var_34 = xmm1_15 * xmm3_3
    float var_30_1 = xmm1_15 * xmm1_10
    xmm0_20 = var_34.q
...
var_34.q = xmm0_20
float var_2c_2 = eax_3

if (esi == 0)
    void* eax_5 = *(sub_5af880(arg7) + 8)
    esi = sub_6dd280(eax_5, *(eax_5 + 8) + 8, &data_8ce7bc, 0x53)
    
    if (esi == 0)
        esi = data_1724a58

void* eax_8 = *(sub_5af880(arg7) + 8)
uint32_t result = sub_646580(&var_14, arg2, arg3, arg4, arg5, &var_14, &var_34, esi, 
    sub_6dd280(eax_8, *(eax_8 + 8) + 8, &data_8ce7bc, 0x54), arg7)
