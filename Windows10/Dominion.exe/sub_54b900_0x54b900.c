...
__chkstk(0x25a0)
void var_8
sub_561af0(__security_cookie ^ &var_8, 0, 3, 0)
...
uint32_t eax_6 = sub_588db0(eax_5, *(eax_5 + 0xc), *(eax_5 + 4), 5, 0x3ee, 1, *(eax_5 + 0x28), 
...
__builtin_memcpy(&var_8, 
    sub_5671b0(eax_6, eax_6, &arg_1908, &arg_c80, 0x3ee, var_1c_2, var_18_2, var_14_3), 0xc84)
