...
arg4[1] = (xmm5_2 * xmm0_1 - xmm3_2 * xmm0_7 + xmm4_2 * xmm0_9) ^ (data_8937c0.o).d
arg4[2] = xmm6_3 * xmm0_1 - xmm3_2 * xmm0_4 + xmm2_3 * xmm0_9
arg4[3] = (xmm7_3 * xmm0_1 - xmm4_2 * xmm0_4 + xmm2_3 * xmm0_7) ^ (data_8937c0.o).d
arg4[4] = (xmm5_2 * xmm0_3 - xmm6_3 * xmm0_6 + xmm7_3 * xmm0_8) ^ (data_8937c0.o).d
arg4[5] = xmm5_2 * xmm0 - xmm3_2 * xmm0_6 + xmm4_2 * xmm0_8
arg4[6] = (xmm6_3 * xmm0 - xmm3_2 * xmm0_3 + xmm2_3 * xmm0_8) ^ (data_8937c0.o).d
...
arg4[9] = (xmm2_7 * xmm0 - xmm5_8 * xmm0_6 + xmm6_10 * xmm0_8) ^ (data_8937c0.o).d
