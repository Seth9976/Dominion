...
void var_25dc
void var_c9c
__builtin_memcpy(&var_c9c, sub_566240(&var_25dc, edx, 3, &var_25dc, &data_7bfa0c), 0xc84)
...
struct std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_f5912014766a6c1a1030741512201879>,bool,enum CardID>::VTable
    * const var_1954 = &std::_Func_impl_no_alloc<class <lambda_f5912014766a6c1a1030741512201879>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'}
struct std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_f5912014766a6c1a1030741512201879>,bool,enum CardID>::VTable
...
*(eax_13 + 0xc)
*(eax_13 + 4)
uint32_t eax_14 = sub_582eb0(&var_c9c, eax_10, 0x3ee, 0xb, 7, 0, 0, 0, nullptr, nullptr)
int32_t edi_1 = var_ca4
int32_t esi_1 = 0

if (edi_1 s> 0)
    do
        eax_14 = sub_5695c0(eax_14, 0x3ee, *(&var_1924 + (esi_1 << 2)), 0xb)
        esi_1 += 1
    while (esi_1 s< edi_1)

void* eax_15 = sub_573400()
int32_t result = sub_588340(*(eax_15 + 4), *(eax_15 + 0xc))
fsbase->NtTib.ExceptionList = ExceptionList
