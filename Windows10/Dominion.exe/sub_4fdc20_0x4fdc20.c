...
if (ecx_2 != 0xffffffff)
    ...
    *(ecx_3 + eax_3 + 0x17558) |= 2
    struct 
        std::_Func_base<void>::std::_Func_impl_no_alloc<enum CardID (__cdecl *)(void), void>::VTable
        * const var_30 = &std::_Func_impl_no_alloc<enum CardID (__cdecl *)(void), void>::`vftable'{for `std::_Func_base<void>'}
    int32_t* (* var_2c)() = sub_565ce0
    struct 
        std::_Func_base<void>::std::_Func_impl_no_alloc<enum CardID (__cdecl *)(void), void>::VTable
