...
if (result_1 != 0)
    ...
    int32_t ebx
    ebx.b = sub_568470(result, edx_2, result_1.w, 2)
    ...
    if (ebx.b != 0)
        ...
        sub_582d10(eax_7, *(ebx_1 * 0x64 + eax_7 + 0x1a70), *(eax_6 + 4), result_1, 0x3eb, 0xb, 
            0x3ea, 3, *(eax_6 + 0x28), *(eax_6 + 0x2c), *(eax_6 + 0x30), 0, 0, nullptr, 0, nullptr, 
            nullptr)
        return sub_56e9c0(1)
