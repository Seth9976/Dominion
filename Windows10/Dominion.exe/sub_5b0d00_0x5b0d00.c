...
float xmm0[0x4] = __minps_xmmps_memps(data_893680, *arg1)
float xmm5[0x4] = data_8935f0
float xmm6_1[0x4] = _mm_max_ps(data_893890, xmm0)
...
float xmm1_1[0x4] = _mm_cmpeq_ps(xmm5_2, zx.o(0), 1)
float xmm0_1[0x4] = data_893370
...
uint32_t xmm2_4[0x4] =
    _mm_or_ps(_mm_and_ps(data_8937c0.o ^ xmm3_2, xmm1_1), _mm_andnot_ps(xmm1_1, xmm3_2))
float xmm3_3[0x4] = *"giP9giP9giP9giP9"
uint32_t xmm2_5[0x4] = _mm_and_ps(xmm2_4, xmm4_2)
int128_t xmm1_3 = data_8937c0.o
...
float xmm0_2[0x4] = _mm_mul_ps(xmm0_1, xmm2_7)
float xmm7_3[0x4] = _mm_add_ps(_mm_add_ps(_mm_mul_ps(xmm7, xmm2_7), xmm6_1), xmm0_2)
float xmm0_3[0x4] = data_8936d0
float xmm1_5[0x4] = _mm_max_ps(xmm1_3 ^ xmm0_3, xmm2_7)
float xmm3_4[0x4] = _mm_mul_ps(xmm3_3, xmm7_3)
float xmm0_4[0x4] = _mm_min_ps(xmm0_3, xmm1_5)
float xmm3_5[0x4] = __addps_xmmps_memps(xmm3_4, data_8933a0)
int32_t xmm5_5[0x4] = _mm_cvttps_epi32(xmm0_4)
...
int32_t xmm1_7[0x4] = __paddd_xmmdq_memdq(xmm2_9, data_891970)
float xmm0_6[0x4] = _mm_mul_ps(xmm4_5, xmm7_3)
int32_t xmm5_7[0x4] = _mm_sub_epi32(xmm5_6, xmm2_9)
uint32_t xmm1_8[0x4] = _mm_slli_epi32(xmm1_7, 0x17)
uint32_t xmm5_10[0x4] =
    _mm_slli_epi32(__paddd_xmmdq_memdq(_mm_sub_epi32(xmm5_7, xmm2_9), data_891970), 0x17)
float xmm3_9[0x4] = _mm_add_ps(_mm_mul_ps(xmm3_7, xmm0_6), 
    __addps_xmmps_memps(
        _mm_mul_ps(__addps_xmmps_memps(_mm_mul_ps(data_893410, xmm7_3), data_893460), xmm7_3), 
        data_8934e0))
float xmm0_13[0x4] = _mm_add_ps(data_8935b0, xmm7_3)
float xmm3_11[0x4] = _mm_add_ps(_mm_mul_ps(xmm3_9, xmm4_5), xmm0_13)
_mm_max_ps(*arg1, 
    _mm_mul_ps(_mm_mul_ps(_mm_mul_ps(_mm_mul_ps(xmm3_11, xmm1_8), xmm1_8), xmm1_8), xmm5_10))
