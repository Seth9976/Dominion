...
if (data_151345c s> 0)
    do
        char* eax_4 = sub_744f10((&data_151245c)[i], nullptr)
        float xmm0_3 = xmm0_1 f- *(eax_4 + 0x1c)
        float xmm5_2 = *(eax_4 + 0x10) + 0f
        float xmm1_2 = *(eax_4 + 0x18) + 0f
        float xmm4_2 = xmm0_3 f+ *(eax_4 + 0x14)
        float xmm0_4 = xmm0_3 f+ *(eax_4 + 0x1c)
        float xmm3_2
