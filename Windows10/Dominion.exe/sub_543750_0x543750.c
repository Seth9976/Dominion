...
struct std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_a78da4c8bb007749c20f1fcf89f880bb>,bool,enum CardID>::VTable
    * const var_ccc = &std::_Func_impl_no_alloc<class <lambda_a78da4c8bb007749c20f1fcf89f880bb>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'}
void var_c9c
