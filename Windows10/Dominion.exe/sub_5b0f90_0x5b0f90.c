...
label_5b10a7:
    ...
    sub_63b870(sub_4f7f30("Couldn't find network matrix %s!\n"), &data_801800, "Halt", 
        "C:\x\ax2017\Jams\Dominion\code\NeuralEigen.cpp", 0x63, "find_matrix")
else
    int32_t* edi_1 = arg_4
    ...
    while (true)
        ...
        if (eax_7 == 0)
            int32_t result = esi_1[4]
            
            if (result == 0)
                sub_63b870(eax_7, &data_801800, "w_ptr->matrix != NULL", 
                    "C:\x\ax2017\Jams\Dominion\code\NeuralEigen.cpp", 0x5b, "find_matrix")
                break
