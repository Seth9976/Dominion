...
int32_t eax_23 = MultiByteToWideChar(0xfde9, 0, *(data_cf65b8 + 0xc), 0xffffffff, &var_110, 0x80)
int32_t var_150_4
char* ecx_8

if (eax_23 != 0)
    int32_t eax_24 = data_147b074
    var_114
    ...
    label_6c692e:
        HWND hwnd = CreateWindowExW(WS_EX_LEFT, GameWindowClass", &var_110, dwStyle, 0x80000000, 
            data_147cc8c, rect.right - rect.left, rect.bottom - rect.top, nullptr, nullptr, arg1, 
            nullptr)
...
sub_63b870(eax_23, &data_801800, ecx_8, "C:\x\ax2017\Engine\Windows\WindowsApp.cpp", var_150_4, 
    "CreateMainWindow")
