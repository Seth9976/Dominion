...
struct std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_b96cf00606c12daee9e551d8af33a03e>,bool,enum CardID>::VTable
    * const var_1954 = &std::_Func_impl_no_alloc<class <lambda_b96cf00606c12daee9e551d8af33a03e>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'}
struct std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_b96cf00606c12daee9e551d8af33a03e>,bool,enum CardID>::VTable
...
int32_t var_24_5 = 3
void* result = sub_56c1b0(sub_564ce0(esi_2), sub_528550, 0xc, sub_528570, 0, 1)
fsbase->NtTib.ExceptionList = ExceptionList
