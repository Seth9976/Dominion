...
if (arg6 != 4 || arg5 s<= 7)
    ...
    do
        ...
        int16_t xmm2_2[0x8] = __pmulhw_xmmdq_memdq(xmm2_1, data_8938f0)
        edx += 8
        ...
        int16_t xmm0_7[0x8] = __pmulhw_xmmdq_memdq(xmm4_1, data_893300)
        int16_t xmm4_2[0x8] = __pmulhw_xmmdq_memdq(xmm4_1, data_893910)
        ...
        int64_t xmm4_6 = __packuswb_xmmdq_memdq(xmm4_5, data_893290)
...
do
    ...
    int32_t edi_8 = (zx.d(*(eax + edi_5)) << 0x14) + 0x80000
