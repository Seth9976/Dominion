...
void var_1984
int32_t esi = sub_590990(eax_3, *(eax_3 + 0xc), *(eax_3 + 4), 0x3e9, &var_1984)
int32_t var_d04 = esi
void* var_ca0
void var_50
...
if ((var_cac.d | var_cac:4.d) != 0)
    ...
    esi = GSI1::OffForSym(eax_5, esi, &var_1984)
...
if (var_ca4 != 0)
    ...
    int32_t var_d04_2 = GSI1::OffForSym(eax_10, esi, &var_1984)
...
int32_t var_24_5 = 0
char var_28_3 = 0
int32_t var_2c_5 = 0x13
void var_c9c
__builtin_memcpy(&var_c9c, &var_1984, 0xc84)
void var_260c
uint32_t result = sub_562540(&var_260c, 2, &var_c9c, &var_260c, 0x3e9, var_2c_5, var_28_3, var_24_5)
fsbase->NtTib.ExceptionList = ExceptionList
