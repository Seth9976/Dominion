...
int32_t* const var_20_1 = &data_7bf980
...
struct std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_8bc3d152a9124c25ce32f55beb09a236>,bool,enum CardID>::VTable
    * const var_1954 = &std::_Func_impl_no_alloc<class <lambda_8bc3d152a9124c25ce32f55beb09a236>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'}
struct std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_8bc3d152a9124c25ce32f55beb09a236>,bool,enum CardID>::VTable
    * const* var_1930 = &var_1954
int32_t var_8_1 = 0
void* var_ca4
int32_t* var_20_3 = &var_ca4
void var_1924
...
if (var_1930 != 0)
    eax_14 = (*var_1930)->vFunc_4(var_1930 != &var_1954)
    int32_t var_1930_1 = 0

sub_569330(sub_566140(eax_14, 0x3ee, &var_1924, 0x452, nullptr, 1, 0xb, nullptr, nullptr), 0x3ee, 
    &var_c9c, 0x18)
void* eax_18 = sub_573400()
*(eax_18 + 0xc)
*(eax_18 + 4)
uint32_t result = sub_582eb0(&var_1924, var_ca4, 0x452, 0xb, 7, 0, 0, 0, nullptr, nullptr)
fsbase->NtTib.ExceptionList = ExceptionList
