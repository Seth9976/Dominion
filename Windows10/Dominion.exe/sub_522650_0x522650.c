...
struct std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_1c979890a6dcb4cbed41b22840785eed>,bool,enum CardID>::VTable
    * const var_cc4 = &std::_Func_impl_no_alloc<class <lambda_1c979890a6dcb4cbed41b22840785eed>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'}
void var_c98
