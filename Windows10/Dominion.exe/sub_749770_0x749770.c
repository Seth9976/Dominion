...
if (data_151345c s> 0)
    do
        ...
        float xmm0_3 = xmm0_1 f- *(eax_4 + 0x18)
        float xmm4_2 = *(eax_4 + 0x14) + 0f
        float xmm5_2 = xmm0_3 f+ *(eax_4 + 0x10)
        float xmm3_2
        ...
        float xmm0_5 = xmm0_3 f+ *(eax_4 + 0x18) - xmm5_2
        float xmm1_3 = *(eax_4 + 0x1c) + 0f - xmm4_2
        ...
        float xmm0_8 = _mm_cvtepi32_ps(zx.o(int.d(xmm1_4)))
        var_30 = xmm1_6
        float var_2c_1 = xmm7_2
        float var_28_1 = xmm3_6 + xmm1_6
        float var_24_1 = xmm0_8 + xmm7_2
        *(eax_4 + 0x10) = var_30.o
