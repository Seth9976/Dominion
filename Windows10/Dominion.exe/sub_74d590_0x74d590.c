...
SendMessageA(*(data_19e2778 + 0x1c), 0x102, 0xd, 0)
...
if (ecx_3 != 0)
    ...
    if (result != 3)
        if (result == 8)
            LPARAM lParam = _mbsicmp(*(ecx_3 + 8), &data_8901e0)
