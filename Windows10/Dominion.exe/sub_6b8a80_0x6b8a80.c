...
long double x87_r7 = fconvert.t(xmm0_4)
floor(fconvert.d(x87_r7))
int32_t edx = *(arg3 + 0x2c)
int32_t edi = int.d(_mm_cvtpd_ps(zx.o(fconvert.d(x87_r7))))
...
int32_t esi_1 = (ecx_19 u>> 4 ^ ecx_19) * 0x809
...
var_48.d = ((esi_1 u>> 0x10 ^ esi_1) & 0x7fffff) | 0x3f800000
...
if (not(0f < xmm0_21))
    ...
    xmm1 = sub_4ae110(4, xmm0_21, xmm0_14, xmm0_8)
    xmm0_21 = var_58_1.d
else
    xmm1 = xmm0_8
...
if (not(0 f< xmm0_21))
    ...
    xmm1_2 = sub_4ae110(4, xmm0_21, xmm0_16, xmm0_10)
    xmm0_21 = var_58_1.d
else
    xmm1_2 = xmm0_10
...
if (xmm0_21 < 1f)
    arg5[2] = sub_4ae110(4, xmm0_21, var_48.d, xmm0_12)
    return result
