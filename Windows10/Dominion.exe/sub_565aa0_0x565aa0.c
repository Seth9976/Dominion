...
struct std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_d69ccaea5a0a2bfefbfa197248291e34>,bool,enum CardID>::VTable
    * const var_d18 = &std::_Func_impl_no_alloc<class <lambda_d69ccaea5a0a2bfefbfa197248291e34>,bool,enum CardID>::`vftable'{for `std::_Func_base<bool,enum CardID>'}
void var_cb0
__builtin_memcpy(&var_cb0, &var_19d0, 0xc84)
int32_t* var_d14 = &var_cc0
int32_t arg_4
int32_t* var_d10 = &arg_4
struct std::_Func_base<bool,enum CardID>::std::_Func_impl_no_alloc<class <lambda_d69ccaea5a0a2bfefbfa197248291e34>,bool,enum CardID>::VTable
...
if (eax_8 != 0)
    ...
    int32_t var_ce4_1 = 0
    int128_t var_d48 = ecx.o
    int128_t var_d38_1 = eax_12.o
    int64_t var_cd0
    int128_t var_d28_1 = var_cd0.o
    result_1 = sub_563c40(&var_d48, 0xc, 0)
...
if (eax_8 == 0 || result_1 == 0)
    ...
    if (sub_583720(eax_14, *(eax_14 + 0xc), *(eax_14 + 4), result_1, 0x476, nullptr, 0x476, 0, 0, 4)
            == 0)
        result_1 = nullptr
