...
if (*ecx_1 == 0)
    ...
    if (ecx_3 s>= 3)
        ...
        if (*(eax * 0x9c + 0x790198) == ecx_3)
            ...
            int32_t edx
            int32_t edx_1
            eax_1, edx_1 = sub_50a6a0(eax, edx, *(eax * 0x9c + 0x7901d4), 2, 0)
            sub_50a6a0(eax_1, edx_1, *(eax * 0x9c + 0x7901d8), 2, 0)
            sub_58ffd0(&data_cca794, *(eax * 0x9c + 0x7901d4))
            return sub_58ffd0(&data_cca794, *(eax * 0x9c + 0x7901d8))
