...
.method constructor <init>(Landroid/app/NotificationChannelGroup;Ljava/util/List;)V
    ...
    invoke-static {p1}, Landroidx/core/app/NotificationCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/NotificationChannelGroup;)Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0}, Landroidx/core/app/NotificationChannelGroupCompat;-><init>(Ljava/lang/String;)V

    invoke-static {p1}, Landroidx/core/app/NotificationCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/NotificationChannelGroup;)Ljava/lang/CharSequence;
    ...
    invoke-static {p1}, Landroidx/core/app/NotificationCompat$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/app/NotificationChannelGroup;)Ljava/lang/String;
    ...
    invoke-static {p1}, Landroidx/core/app/NotificationCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/NotificationChannelGroup;)Z

    move-result p2

    iput-boolean p2, p0, Landroidx/core/app/NotificationChannelGroupCompat;->mBlocked:Z

    invoke-static {p1}, Landroidx/core/app/NotificationCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/NotificationChannelGroup;)Ljava/util/List;
...
.method private getChannelsCompat(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static {v1}, Landroidx/core/app/NotificationCompat$$ExternalSyntheticApiModelOutline0;->m$4(Landroid/app/NotificationChannel;)Ljava/lang/String;
...
.method getNotificationChannelGroup()Landroid/app/NotificationChannelGroup;
    ...
    :cond_0
    invoke-static {}, Landroidx/core/app/NotificationCompat$$ExternalSyntheticApiModelOutline0;->m$1()V

    iget-object v0, p0, Landroidx/core/app/NotificationChannelGroupCompat;->mId:Ljava/lang/String;

    iget-object v1, p0, Landroidx/core/app/NotificationChannelGroupCompat;->mName:Ljava/lang/CharSequence;

    invoke-static {v0, v1}, Landroidx/core/app/NotificationCompat$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/String;Ljava/lang/CharSequence;)Landroid/app/NotificationChannelGroup;
    ...
    invoke-static {v0, v1}, Landroidx/core/app/NotificationCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/NotificationChannelGroup;Ljava/lang/String;)V
