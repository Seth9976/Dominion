// 函数: _ZNSt6__ndk15dequeINS_8functionIFvvEEENS_9allocatorIS3_EEE19__add_back_capacityEv
// 地址: 0xf4a340
...
if (x25_1 u>= x9_4 s>> 3)
    ...
    *x19 = j_9
    ...
    std::__ndk1::__split_buffer<std::__ndk1::function<void ()>*, std::__ndk1::allocator<std::__ndk1::function<void ()>*> >::push_front(
        x19)
    int64_t* x25_3 = x19[1]
    x26_1 = x19[2]
    x23 = *x25_3
    ...
    std::__ndk1::__split_buffer<std::__ndk1::function<void ()>*, std::__ndk1::allocator<std::__ndk1::function<void ()>*> >::push_back(
        x19)
