...
*result = &_vtable_for_std::__ndk1::__function::__func<Scepter()::$_14::operator()() const::'lambda0'(CardID), std::__ndk1::allocator<Scepter()::$_14::operator()() const::'lambda0'(CardID)>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
return result
