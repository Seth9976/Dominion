// 函数: _ZNK5Botan9Power_Mod8set_baseERKNS_6BigIntE
// 地址: 0xdd87d4
...
if (*(entry_x1 + 0x20) == 0)
    ...
    v0 = data_71ce10
    __builtin_strncpy(x0_2, "Power_Mod::set_base: arg must be non-negative", 0x2e)
...
int64_t var_50 = x0_7
int128_t var_60 = data_71b7f0
__builtin_strncpy(x0_7, "Power_Mod::set_base: m_core was NULL", 0x25)
