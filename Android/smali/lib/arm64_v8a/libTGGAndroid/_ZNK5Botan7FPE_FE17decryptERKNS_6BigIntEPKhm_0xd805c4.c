// 函数: _ZNK5Botan7FPE_FE17decryptERKNS_6BigIntEPKhm
// 地址: 0xd805c4
...
if (*(arg1 + 0x80) != 0)
    ...
    do
        Botan::ct_divide(entry_x8, arg1 + 0x30, &var_e0, &var_b8)
        Botan::FPE_FE1::F(arg1, &var_e0, *(arg1 + 0x80) + not.q(i), &result_1)
        uint32_t* var_110
        x21_1 = var_110
        void* var_108
        void* x23_1 = var_108
        ...
        x8_13 = var_100
        int64_t var_f8
        int64_t x28_1 = var_f8
        int32_t var_f0
        int32_t x22_1 = var_f0
        var_110 = x25_1
        var_100 = x26_1
        var_f8 = x24_1
        var_f0 = fp_1
        ...
        if (x25_1 != 0)
            var_108 = x25_1
            Botan::deallocate_memory(x25_1, (x26_1 - x25_1) s>> 2, 4)
        
        x24_1 = x28_1
        
        if (x28_1 == -1)
            void* x9_9 = x23_1 - x21_1
            ...
            if (x23_1 == x21_1)
                ...
                x9_10 = x10_1 s> x9_9 ? x10_1 : x9_9
                
                int64_t j_2 = x11_2 * (x9_10 u>> 2)
                uint64_t x10_2 = 1
                int64_t j
        ...
        Botan::BigInt* x25_2 = *(arg1 + 0x10)
        Botan::BigInt::add2(&var_b8, x21_1, x24_1, zx.q(x22_1 != 1 ? 1 : 0))
        Botan::Modular_Reducer::reduce(x25_2)
        void* var_160
        Botan::operator*(arg1 + 0x58, &var_160)
        int64_t x2_5 = var_c8
        uint32_t* x1_10 = var_e0
        
        if (x2_5 == -1)
            int64_t var_d8
            void* x9_12 = var_d8 - x1_10
            ...
            if (var_d8 == x1_10)
                ...
                x11_5 = x9_12 s>= 0 ? x9_12 : -ffffffffffffffff
                
                void* x10_3 = x1_10 - var_d8
                void* x11_6
                ...
                x9_13 = x10_3 s> x9_12 ? x10_3 : x9_12
                
                int64_t j_3 = x11_6 * (x9_13 u>> 2)
                uint64_t x10_4 = 1
                int64_t j_1
                
                do
                    int32_t x11_7 = *(x1_10 - 4 + (j_3 << 2))
                    j_1 = j_3
                    j_3 -= 1
        ...
        int128_t v0_1
        int128_t v1_1
        v0_1, v1_1 = Botan::BigInt::add2(&var_138, x1_10, x2_5, zx.q(var_c0))
        uint32_t* x0_13
        ...
        if (x0_14 != 0)
            ...
            int64_t var_128
            Botan::deallocate_memory(x0_14, (var_128 - x0_14) s>> 2, 4)
        
        void* x0_15 = var_160
        
        if (x0_15 != 0)
            void* var_158_1 = x0_15
            int64_t var_150
    ...
    if (x21_1 != 0)
        Botan::deallocate_memory(x21_1, (x8_13 - x21_1) s>> 2, 4)

uint32_t* x0_18 = var_e0

if (x0_18 != 0)
    uint32_t* var_d8_1 = x0_18
    int64_t var_d0
