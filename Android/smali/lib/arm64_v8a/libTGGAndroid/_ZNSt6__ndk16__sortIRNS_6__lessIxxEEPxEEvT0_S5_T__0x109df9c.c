// 函数: _ZNSt6__ndk16__sortIRNS_6__lessIxxEEPxEEvT0_S5_T_
// 地址: 0x109df9c
    ...
    label_109dfd8:
        ...
        if (x8_1 u<= 5)
            switch (x8_1)
                ...
                case 5
                    SystemHintOp_BTI()
                    return sub_109e4dc(x19, &x19[1], &x19[2], &x19[3], x20 - 8) __tailcall
        else if (x9_1 s<= 0xf7)
            int64_t x9_15 = *x19
            int64_t x8_16 = x19[1]
            ...
            if (x9_1 s< 0x1f39)
                ...
                arg1 = sub_109e4dc(x19, x19 + x8_4, x23_2, x23_2 + x8_4, x20 - 8)
