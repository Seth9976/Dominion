// 函数: _ZNSt6__ndk110__time_putC1EPKc
// 地址: 0x10d99e8
...
int64_t x8 = *(x21 + 0x28)
int64_t* entry_x1
int64_t result = newlocale(0x1fbf, entry_x1, nullptr)
*arg1 = result
...
if (x0_1 u>= 0x17)
    ...
    x21_1 = x0_3
    size_t var_60_1 = x0_1
    int64_t var_58_1 = x0_3
    var_68 = x22_1 | 1
    memcpy(x21_1, entry_x1, x0_1)
else
    x21_1 = &var_68 | 1
    var_68.b = (x0_1.d << 1).b
