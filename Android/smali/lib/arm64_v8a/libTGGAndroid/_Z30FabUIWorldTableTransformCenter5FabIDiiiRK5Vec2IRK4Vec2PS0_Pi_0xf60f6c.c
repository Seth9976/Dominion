// 函数: _Z30FabUIWorldTableTransformCenter5FabIDiiiRK5Vec2IRK4Vec2PS0_Pi
// 地址: 0xf60f6c
// 来自: E:\torrent\Cursor\Dominion_1.0.3315\split_config.arm64_v8a\lib\arm64-v8a\libTGGAndroid.so

uint64_t x21 = zx.q(arg1) & 0xffff
int64_t x20 = *gFabs
int64_t* x28 = *(x20 + mulu.dp.d(x21.d, 0x4e8))
uint64_t x26 = zx.q(arg2)
int64_t* x9_1 = *x28
int128_t v0
int128_t v1
...
if (x9_1 == 0)
    ...
    v0, v1 = AssetCatalogLoadAsset(x28, false, true)
    x9_1 = *x28

int64_t fp = **x9_1
int32_t* x25_1 = x20 + x21 * 0x4e8 + (sx.q(x26.d) << 2) + 0x88
int32_t x9_3 = *x25_1
FabState* x28_1
int32_t x8_2
...
label_f61070:
    ...
    *(gFabs + 0x10) = x10_3
    x28_1 = x9_4 + x8_3 * 0x4e8
    v0, v1 = memset(x28_1, 0, 0x4e0)
    *(x28_1 + 0x4e0) = x22_1.d | *(gFabs + 0x18) << 0x10
    ...
    *x25_1 = *(x28_1 + 0x4e0)
    ...
    x28_1 = *gFabs + x10_1 * 0x4e8
    
    if (*(x28_1 + 0x4e0) != x9_3)
        goto label_f61070
void* x8_10 = x20 + x21 * 0x4e8
v0 = *(x8_10 + 0x50)
int64_t x8_11 = sx.q(x26.d)
bool cond:1 = *(x28_1 + 0x48c) s<= *(x28_1 + 0x60)
*(x28_1 + 0x40) = *(x8_10 + 0x40)
*(x28_1 + 0x50) = v0
void* x9_8
void* x10_5
void* x11_3
...
v8.d = *(x28_1 + 0x40)
float v1_1 = *(x28_1 + 0x44)
float v0_3 = *(x28_1 + 0x48)
float v2_1 = *(x28_1 + 0x4c)
float v20 = *(x28_1 + 0x50)
...
v2_1 = *(x28_1 + 0x5c) + v8.d f* v2_1
v0_3 = *(x28_1 + 0x54) + v8.d f* (v24 + cosp_3)
v1_1 = *(x28_1 + 0x58) + v8.d f* (v16 + v25 + v11.d * v29)
int32_t* entry_x8
entry_x8[2] = v10_1
entry_x8[3] = v11_1
entry_x8[6] = v1_1
...
*entry_x8 = v8.d
entry_x8[1] = v12.d
uint32_t x0_8 = FabUIState(zx.q(arg1), x26.d)
ElBox(fp_1, x28_1)
...
UITransform var_110
UIStateTableTransform(x0_8, arg3, &var_110, arg5, arg7, arg8)
UITransform var_170
int64_t result = UIStateTransformItemCenter(UIStateSubstate(x0_8, arg3, arg5), arg4, &var_170, arg6)
float v0_6 = var_1d0
