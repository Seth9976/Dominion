// 函数: _ZN5Botan18probe_providers_ofINS_5PBKDFEEENSt6__ndk16vectorINS2_12basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEENS7_IS9_EEEERKS9_RKSB_
// 地址: 0xde6fcc
...
if (x20 != x24)
    ...
    do
        arg1 = Botan::PBKDF::create(x21_1, x20)
        int64_t* var_38
