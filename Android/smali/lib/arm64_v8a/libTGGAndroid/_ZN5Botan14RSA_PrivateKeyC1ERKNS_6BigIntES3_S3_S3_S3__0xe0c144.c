// 函数: _ZN5Botan14RSA_PrivateKeyC1ERKNS_6BigIntES3_S3_S3_S3_
// 地址: 0xe0c144
...
int64_t var_60 = *(arg2 + 0x18)
int32_t var_58 = *(arg2 + 0x20)
void* var_a0
std::__ndk1::vector<uint32_t, Botan::secure_allocator<uint32_t> >::vector(&var_a0)
int64_t var_88 = *(arg3 + 0x18)
int32_t var_80 = *(arg3 + 0x20)
void* var_d0
std::__ndk1::vector<uint32_t, Botan::secure_allocator<uint32_t> >::vector(&var_d0)
void* entry_x5
int64_t x8_5 = *(entry_x5 + 0x18)
int64_t var_b8 = x8_5
int32_t x9_1 = *(entry_x5 + 0x20)
int128_t var_100
int64_t var_f0
int64_t var_c0
...
if (x8_5 == -1)
    ...
    label_e0c280:
        ...
        void* x11_2 = x9_2 - var_c8
        void* x12_2
        
        x12_2 = x12_1 s< 1 ? x12_1 : 1
        
        int64_t x8_6 = x10_1 s>> 2
        void* x10_2
...
int64_t var_e8_2 = *(arg4 + 0x18)
int32_t var_e0_2 = *(arg4 + 0x20)
void* var_130
std::__ndk1::vector<uint32_t, Botan::secure_allocator<uint32_t> >::vector(&var_130)
int64_t x8_11 = *(arg5 + 0x18)
int32_t x8_12 = *(arg5 + 0x20)
uint32_t var_180 = 1
int32_t var_110 = x8_12
...
if (x8_11 == -1)
    ...
    label_e0c3d0:
        ...
        if (x0_11 != 0)
            Botan::deallocate_memory(x0_11, (x8_15 - x0_11) s>> 2, 4)
        ...
        void* x11_6 = x9_6 - var_128
        void* x12_7
        
        x12_7 = x12_6 s< 1 ? x12_6 : 1
        
        int64_t x8_14 = x10_5 s>> 2
        void* x10_6
...
if (x20_2 != 0)
    ...
    do
        x9_9 = __ldaxr(&x20_2[1])
        i_2 = __stlxr(x9_9 - 1, &x20_2[1])
    while (i_2 != 0)
