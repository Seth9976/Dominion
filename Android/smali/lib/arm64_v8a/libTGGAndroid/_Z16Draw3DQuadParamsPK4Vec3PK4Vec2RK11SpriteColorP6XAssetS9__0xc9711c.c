// 函数: _Z16Draw3DQuadParamsPK4Vec3PK4Vec2RK11SpriteColorP6XAssetS9_
// 地址: 0xc9711c
...
if (x22 == 0)
    XAsset* x0_3 = AttribMapGetAssetPtr(*gMaterialAttribTable, MaterialGetAttribMap(arg5), 0x53)
...
XAsset* var_70 = arg5
int64_t var_68 = 0
return Draw3DQuadFullComplete(arg1, arg2, arg3, 0, &var_50, &var_60, x22, 
    AttribMapGetAssetPtr(*gMaterialAttribTable, MaterialGetAttribMap(arg5), 0x54))
