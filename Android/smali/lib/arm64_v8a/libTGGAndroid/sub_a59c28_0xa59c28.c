...
*result = &_vtable_for_std::__ndk1::__function::__func<Bell_ImbalancedStart_AttackVsSameCost()::$_41, std::__ndk1::allocator<Bell_ImbalancedStart_AttackVsSameCost()::$_41>, bool (DomCardEnum)>{for `std::__ndk1::__function::__base<bool (DomCardEnum)>'}
result[1].d = *(arg1 + 8)
return result
