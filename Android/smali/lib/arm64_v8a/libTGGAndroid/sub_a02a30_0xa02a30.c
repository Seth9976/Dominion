    ...
    label_a02a78:
        ...
        if (x9_2 u<= 5)
            switch (x9_2)
                case 2
                    ...
                    if (x8_29 == 1)
                        ...
                        *(x20 - 0xc) = x9_23
                case 3
                    return sub_a03110(x19, &x19[3], x20 - 0xc) __tailcall
                case 4
                    sub_a03110(x19, &x19[3], &x19[6])
                        ...
                        if (x8_42 == 1)
                            ...
                            *(x19 + 0x18) = x9_34
                            ...
                            if (x8_48 == 1)
                                ...
                                *(x19 + 0xc) = x9_39
                case 5
                    return sub_a032cc(x19, &x19[3], &x19[6], &x19[9], x20 - 0xc) __tailcall
        else if (x8_1 s<= 0x173)
            int32_t* x21_3 = &x19[6]
            sub_a03110(x19, &x19[3], x21_3)
            int32_t* x8_53 = &x19[9]
            ...
            if (x8_1 s< 0x2ed5)
                ...
                arg1 = sub_a03110(x19, x22_2, x20 - 0xc)
            else
                x22_2 = x19 + x8_1 u/ 0x18 * 0xc
                arg1 = sub_a032cc(x19, &x19[x8_1 u/ 0x30 * 3], x22_2, &x22_2[x8_1 u/ 0x30 * 3], 
                    x20 - 0xc)
            ...
            label_a02ce0:
                ...
                if (((x23_1 - x19) s>> 2) * -0x5555555555555555
                    ...
                    sub_a02a30(x23_1 + 0xc, x20)
                    x20 = x23_1
                    break
                
                sub_a02a30(x19, x23_1)
                x22_1 = x23_1 + 0xc
                continue
            else
                int32_t x0_3 = sub_a03584(x19, x23_1)
                x22_1 = x23_1 + 0xc
                
                if ((sub_a03584(x22_1, x20).d & 1) != 0)
                    x20 = x23_1
