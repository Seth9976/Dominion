// 函数: _ZNSt6__ndk16vectorIPN5Botan6FilterENS_9allocatorIS3_EEE8__appendEm
// 地址: 0xf4389c
...
if (entry_x1 u<= (x8 - result) s>> 3)
    ...
    *(arg1 + 8) = result
    ...
    if (x25_1 == 0)
        ...
        x23_1 = operator new(x25_1 << 3)
    
    int64_t x0_2 = x23_1 + (x24_1 << 3)
