// 函数: _ZNSt6__ndk15dequeIN5Botan6BucketENS_9allocatorIS2_EEE20__add_front_capacityEv
// 地址: 0xf468bc
...
if (x10_2 - (entry_x0[5] + x9) u>= 0x38)
    entry_x0[4] = x9 + 0x38
    int64_t var_58_1 = *(x25 - 8)
    entry_x0[2] = x25 - 8
    return std::__ndk1::__split_buffer<Botan::Bucket*, std::__ndk1::allocator<Botan::Bucket*> >::push_front(
        entry_x0)
...
if (x8 u>= x10_5)
    ...
    *entry_x0 = j_8
    ...
    if (i == x9_1)
        ...
        std::__ndk1::__split_buffer<Botan::Bucket*, std::__ndk1::allocator<Botan::Bucket*> >::push_back(
            entry_x0)
        int64_t* x8_25 = entry_x0[2] - 8
        int64_t var_58_4 = *x8_25
        entry_x0[2] = x8_25
        result = std::__ndk1::__split_buffer<Botan::Bucket*, std::__ndk1::allocator<Botan::Bucket*> >::push_front(
            entry_x0)
        
        if (entry_x0[2] - entry_x0[1] == 8)
            x8_29 = 0x1c
        else
            x8_29 = entry_x0[4] + 0x38
    else
