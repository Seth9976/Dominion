// 函数: _Z16CampaignForceAdd11DomCardType
// 地址: 0xa2ea64
...
struct std::__ndk1::__function::__base<bool (DomCardEnum)>::std::__ndk1::__function::__func<CampaignForceAdd(DomCardType)::$_0, std::__ndk1::allocator<CampaignForceAdd(DomCardType)::$_0>, bool (DomCardEnum)>::VTable
    * const var_40 = &_vtable_for_std::__ndk1::__function::__func<CampaignForceAdd(DomCardType)::$_0, std::__ndk1::allocator<CampaignForceAdd(DomCardType)::$_0>, bool (DomCardEnum)>{for `std::__ndk1::__function::__base<bool (DomCardEnum)>'}
int64_t var_38 = arg1
struct std::__ndk1::__function::__base<bool (DomCardEnum)>::std::__ndk1::__function::__func<CampaignForceAdd(DomCardType)::$_0, std::__ndk1::allocator<CampaignForceAdd(DomCardType)::$_0>, bool (DomCardEnum)>::VTable
    * const* var_20 = &var_40
int32_t x0_1
...
return CampaignKingdomAdd(zx.q(x0_1), x1_1, 0, 1)
