...
*result = &_vtable_for_std::__ndk1::__function::__func<ArchitectsGuild_OnGain()::$_55, std::__ndk1::allocator<ArchitectsGuild_OnGain()::$_55>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
result[1].d = *(arg1 + 8)
return result
