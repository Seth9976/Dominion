// 函数: _ZNKSt6__ndk17num_getIcNS_19istreambuf_iteratorIcNS_11char_traitsIcEEEEE6do_getES4_S4_RNS_8ios_baseERjRb
// 地址: 0x10b0bc8
...
if ((zx.d(arg4[2].b) & 1) != 0)
    ...
    int64_t var_78_1 = 0
    var_88 = std::__ndk1::ctype<char>::id
    ...
    if (*std::__ndk1::ctype<char>::id != -1)
        var_98 = &var_90
        var_90 = &var_88
        std::__ndk1::__call_once(std::__ndk1::ctype<char>::id, &var_98, sub_10dd4b0)
    
    void* var_a8
    int64_t x8_6 = *(var_a8 + 0x10)
    int64_t x9_2 = sx.q(*(std::__ndk1::ctype<char>::id + 8)) - 1
    int64_t* x22_2
    ...
    var_88 = std::__ndk1::numpunct<char>::id
    int64_t (* const var_80_2)() = std::__ndk1::locale::id::__init
    
    if (*std::__ndk1::numpunct<char>::id != -1)
        var_98 = &var_90
        var_90 = &var_88
        std::__ndk1::__call_once(std::__ndk1::numpunct<char>::id, &var_98, sub_10dd4b0)
    
    int64_t x8_8 = *(var_a8 + 0x10)
    int64_t x9_4 = sx.q(*(std::__ndk1::numpunct<char>::id + 8)) - 1
    int64_t* x23_2
    ...
    (*(*x23_2 + 0x38))(x23_2)
    *entry_x5 =
        (sub_10b0e88(&result_1, arg3, &var_88, &var_58, x22_2, arg5, 1) == &var_88 ? 1 : 0).b
    result = result_1
    char var_70
    void* var_60
