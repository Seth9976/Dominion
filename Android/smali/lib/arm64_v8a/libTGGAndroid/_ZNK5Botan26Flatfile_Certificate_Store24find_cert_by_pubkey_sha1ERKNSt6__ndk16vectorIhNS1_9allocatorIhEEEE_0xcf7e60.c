// 函数: _ZNK5Botan26Flatfile_Certificate_Store24find_cert_by_pubkey_sha1ERKNSt6__ndk16vectorIhNS1_9allocatorIhEEEE
// 地址: 0xcf7e60
...
if (x9 - x10 != 0x14)
    ...
    v0 = data_71cfd0
    int64_t var_30 = x0_2
    __builtin_strncpy(x0_2, "Flatfile_Certificate_Store::find_cert_by_pubkey_sha1 invalid hash", 
        0x42)
    int128_t var_40 = v0
...
if (i != 0)
    void* __offset(std::__ndk1::vector<uint8_t, std::__ndk1::allocator<uint8_t> >, 0x40) i_2
