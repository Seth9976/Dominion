...
int64_t x8 = *(arg1 + 8)
*result = &_vtable_for_std::__ndk1::__function::__func<Swindler_Achievement_OnTrash(CardID const*, int32_t)::$_28, std::__ndk1::allocator<Swindler_Achievement_OnTrash(CardID const*, int32_t)::$_28>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
result[1] = x8
return result
