...
*result = &_vtable_for_std::__ndk1::__function::__func<Surprise_Combo()::$_45::operator()() const::'lambda0'(DomCardEnum), std::__ndk1::allocator<Surprise_Combo()::$_45::operator()() const::'lambda0'(DomCardEnum)>, bool (DomCardEnum)>{for `std::__ndk1::__function::__base<bool (DomCardEnum)>'}
return result
