// 函数: _ZNK5Botan8ARIA_2569encrypt_nEPKhPhm
// 地址: 0xcaca00
...
if (*(arg1 + 0x10) == *(arg1 + 8))
    ...
    return Botan::ARIA_128::decrypt_n(x0_1, x1_1, x2_1) __tailcall
...
if (entry_x3 != 0)
    uint64_t x2_3 = (*(arg1 + 0x10) - *(arg1 + 8)) s>> 2 u>> 2
    int64_t x12_2 = 0
    ...
    do
        ...
        x12_2 += 1
        *(arg3 + x23_2) =
            *(*(arg1 + 8) + x3_3 + 3) ^ (*(&data_849a80 + (zx.q(fp_1 u>> 0x18) << 2))).b
        *(arg3 + (x23_2 | 1)) = (*(*(arg1 + 8) + x3_3 + 2)).b
            ^ (*(&data_849e80 + ((zx.q(fp_1 u>> 0x10) & 0xff) << 2)) u>> 8).b
        *(arg3 + (x23_2 | 2)) = (*(&data_849280 + ((zx.q(fp_1 u>> 8) & 0xff) << 2))).b
            ^ ((*(arg1 + 8))[(x2_3 - 1) * 4] u>> 8).b
        *(arg3 + (x23_2 | 3)) =
            (*(*(arg1 + 8) + x3_3)).b ^ (*(&data_849680 + ((zx.q(fp_1) & 0xff) << 2))).b
        *(arg3 + (x23_2 | 4)) =
            *(*(arg1 + 8) + x4_3 + 3) ^ (*(&data_849a80 + (zx.q(x28_1 u>> 0x18) << 2))).b
        *(arg3 + (x23_2 | 5)) = (*(*(arg1 + 8) + x4_3 + 2)).b
            ^ (*(&data_849e80 + ((zx.q(x28_1 u>> 0x10) & 0xff) << 2)) u>> 8).b
        *(arg3 + (x23_2 | 6)) = (*(&data_849280 + ((zx.q(x28_1 u>> 8) & 0xff) << 2))).b
            ^ ((*(arg1 + 8))[1 | (0x3fffffffffffffff & (x2_3 - 1)) << 2] u>> 8).b
        *(arg3 + (x23_2 | 7)) =
            (*(*(arg1 + 8) + x4_3)).b ^ (*(&data_849680 + ((zx.q(x28_1) & 0xff) << 2))).b
        *(arg3 + (x23_2 | 8)) =
            *(*(arg1 + 8) + x5_3 + 3) ^ (*(&data_849a80 + (zx.q(x25_1 u>> 0x18) << 2))).b
        *(arg3 + (x23_2 | 9)) = (*(*(arg1 + 8) + x5_3 + 2)).b
        ...
        *(arg3 + (x23_2 | 0xa)) = (*(&data_849280 + ((zx.q(x25_1 u>> 8) & 0xff) << 2))).b
            ^ ((*(arg1 + 8))[2 | (0x3fffffffffffffff & (x2_3 - 1)) << 2] u>> 8).b
        *(arg3 + (x23_2 | 0xb)) = (*(*(arg1 + 8) + x5_3)).b ^ x25_3
        *(arg3 + (x23_2 | 0xc)) =
            *(*(arg1 + 8) + x6_3 + 3) ^ (*(&data_849a80 + (zx.q(x24_1 u>> 0x18) << 2))).b
        *(arg3 + (x23_2 | 0xd)) = (*(*(arg1 + 8) + x6_3 + 2)).b
        ...
        *(arg3 + (x23_2 | 0xe)) = (*(&data_849280 + ((zx.q(x24_1 u>> 8) & 0xff) << 2))).b
            ^ ((*(arg1 + 8))[3 | (0x3fffffffffffffff & (x2_3 - 1)) << 2] u>> 8).b
        *(arg3 + (x23_2 | 0xf)) = (*(*(arg1 + 8) + x6_3)).b ^ x24_3
