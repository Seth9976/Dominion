// 函数: _ZN5Botan14Montgomery_IntC1ENSt6__ndk110shared_ptrIKNS_17Montgomery_ParamsEEEPKjmb
// 地址: 0xdd2f44
...
if (x9_1 != 0)
    ...
    do
        i = __stxr(__ldxr(x9_1 + 8) + 1, x9_1 + 8)
    while (i != 0)
    ...
    *x19
    ...
    if ((Botan::BigInt::is_less_than(&x19[2]) & 1) == 0)
        sub_c776cc(Botan::assertion_failure("m_v < m_params->p()", &data_793a18, "Montgomery_Int", 
            "..\..\ExternalCode\botan\botanAM\arm\botan_all_android.cpp", 0xe619))
        noreturn
    ...
    if (&x19[2] == &var_60)
        ...
        *(x19 + 0x10) = v0_1
        ...
        if (x0_4 != 0)
            var_58_1 = x0_4
            Botan::deallocate_memory(x0_4, (x11_2 - x0_4) s>> 2, 4)
    result = result_1
