...
*result = &_vtable_for_std::__ndk1::__function::__func<Theme_DeckChangesA_ReplaceDuchies()::$_125, std::__ndk1::allocator<Theme_DeckChangesA_ReplaceDuchies()::$_125>, bool (DomCardEnum)>{for `std::__ndk1::__function::__base<bool (DomCardEnum)>'}
return result
