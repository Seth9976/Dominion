...
*result = &_vtable_for_std::__ndk1::__function::__func<Patient_OnStartOfCleanup()::$_81, std::__ndk1::allocator<Patient_OnStartOfCleanup()::$_81>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
return result
