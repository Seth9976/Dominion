// 函数: _Z24CollectWhileOwnedOngoingR10AbilityIDsR7DomGame9PlayerWho14DomOngoingType
// 地址: 0xbc4ae8
...
do
    ...
    if ((zx.d(*(*(arg2 + mulu.dp.d(x26_1, 0x68) + 0x1a68) + 0xcb)) & 8) != 0)
        uint64_t x23_1 = zx.q(x26_1.w)
        ...
        uint64_t x2 = zx.q(*(arg2 + x23_1 * 0x68 + 0x1a70))
        int32_t i_2
        int32_t x27_1
        ...
        if (x2.d != 0xe30)
            ...
            if ((ProjectIsOwned(arg2, zx.q(x20_1), x2, &i_2).d & 1) != 0)
            label_bc4c68:
                int32_t i_1 = i_2
                ...
                if (i_1 s>= 1)
                    ...
                    do
                        arg1 =
                            CardHasOngoing(arg2, zx.q(x20_1), zx.q(x27_1), zx.q(x26_1), zx.q(arg4))
                        
                        if (arg1.d != 0xffffffff)
                            int64_t x8_11 = sx.q(*(x22_1 + 0x400))
                            *(x22_1 + 0x400) = x8_11.d + 1
                            *(x22_1 + (x8_11 << 2)) = arg1.d
                        
                        int32_t x26_2 = x26_1 & 0xffff
                        ...
                        x26_1 = *(arg2 + mulu.dp.d(x26_2, 0x68) + 0x1ac8)
                        i = i_1
                        i_1 -= 1
                    while (i != 1)
        else
            ...
            if ((ProjectIsOwned(arg2, zx.q(x27_1), x2, &i_2).d & 1) != 0)
                goto label_bc4c68
        x9_4 = var_cf8_1
