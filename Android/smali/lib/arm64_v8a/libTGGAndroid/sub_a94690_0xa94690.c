...
*result = &_vtable_for_std::__ndk1::__function::__func<Cardinal()::$_7::operator()() const::'lambda'(CardID), std::__ndk1::allocator<Cardinal()::$_7::operator()() const::'lambda'(CardID)>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
return result
