// 函数: _Z44GameClientCreateNewtorkBackedCampaignMissionR9GameSetup
// 地址: 0x9ae024
...
void* var_40 = x0_9 + 0x5760
int64_t x9 = sx.q(*(x0_9 + 0x5960))
int32_t var_38 = x9.d
int32_t var_34 = memcrc32(x0_9 + 0x5760, x9 << 3, 0)
