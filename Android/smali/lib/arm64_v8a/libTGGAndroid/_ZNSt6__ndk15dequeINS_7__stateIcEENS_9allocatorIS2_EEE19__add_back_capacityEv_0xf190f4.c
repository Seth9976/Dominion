// 函数: _ZNSt6__ndk15dequeINS_7__stateIcEENS_9allocatorIS2_EEE19__add_back_capacityEv
// 地址: 0xf190f4
...
if (x25_1 u>= x9_4 s>> 3)
    ...
    int64_t x0_4 = operator new(0xfc0)
    ...
    *x19 = j_9
    ...
    int64_t var_48_2 = operator new(0xfc0)
    std::__ndk1::__split_buffer<std::__ndk1::__state<char>*, std::__ndk1::allocator<std::__ndk1::__state<char>*> >::push_front(
        x19)
    int64_t* x25_3 = x19[1]
    x26_1 = x19[2]
    x23 = *x25_3
    ...
    int64_t var_48_1 = operator new(0xfc0)
