// 函数: _ZNK5Botan18McEliece_PublicKey15public_key_bitsEv
// 地址: 0xda14dc
...
void* entry_x0
*(entry_x0 + 0x28)
uint64_t x0_5 = Botan::DER_Encoder::encode(&var_d0)
*(entry_x0 + 0x20)
Botan::DER_Encoder::encode(x0_5)
int64_t x0_6 = Botan::DER_Encoder::end_cons()
*(entry_x0 + 0x10)
Botan::DER_Encoder::add_object(x0_6, 4, nullptr, *(entry_x0 + 8))
...
if (x0_9 != 0)
    var_a0 = x0_9
    Botan::deallocate_memory(x0_9, var_90.q - x0_9, 1)
