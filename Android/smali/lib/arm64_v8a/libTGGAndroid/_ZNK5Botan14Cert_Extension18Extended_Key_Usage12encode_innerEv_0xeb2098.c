// 函数: _ZNK5Botan14Cert_Extension18Extended_Key_Usage12encode_innerEv
// 地址: 0xeb2098
...
void* entry_x0
void* x8_4 = *(entry_x0 + 8)

if (*(entry_x0 + 0x10) != x8_4)
    int64_t x22_1 = 0
    int64_t i = 0
    
    do
        int64_t* x0_3 = x8_4 + x22_1
        (**x0_3)(x0_3, &var_d0)
        x8_4 = *(entry_x0 + 8)
        i += 1
        x22_1 += 0x20
    while (i != (*(entry_x0 + 0x10) - x8_4) s>> 5)

Botan::DER_Encoder::end_cons()
void* x22_2 = var_90:8.q
