...
int64_t x8 = *(x22 + 0x28)
int64_t var_60 = 0
int64_t (* const var_70)() = std::__ndk1::time_get<char, std::__ndk1::istreambuf_iterator<char, std::__ndk1::char_traits<char> > >::id
...
int64_t x23 = sx.q(*(std::__ndk1::time_get<char, std::__ndk1::istreambuf_iterator<char, std::__ndk1::char_traits<char> > >::id
    + 8)) - 1
