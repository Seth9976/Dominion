...
int64_t x8 = *(x22 + 0x28)
int64_t var_60 = 0
int64_t (* const var_70)() = std::__ndk1::moneypunct<wchar_t, false>::id
...
if (*std::__ndk1::moneypunct<wchar_t, false>::id != -1)
    ...
    std::__ndk1::__call_once(std::__ndk1::moneypunct<wchar_t, false>::id, &var_58, sub_10dd4b0)

int64_t x23 = sx.q(*(std::__ndk1::moneypunct<wchar_t, false>::id + 8)) - 1
