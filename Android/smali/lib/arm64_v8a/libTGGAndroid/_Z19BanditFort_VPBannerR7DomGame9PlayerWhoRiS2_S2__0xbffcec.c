// 函数: _Z19BanditFort_VPBannerR7DomGame9PlayerWhoRiS2_S2_
// 地址: 0xbffcec
...
if (x8 s>= 2)
    ...
    do
        ...
        x27_1 += 1
        x26 += (*(x9_1 + 0x1a94) == x21 ? 1 : 0) & (*(x9_1 + 0x1a70) == 0x106 ? 1 : 0)
    while (x27_1 s< x8)
...
if (x8_6 s< 2)
    ...
    do
        ...
        x26_1 += 1
        x25 += (*(x9_7 + 0x1a94) == x21 ? 1 : 0) & (*(x9_7 + 0x1a70) == 0x105 ? 1 : 0)
    while (x26_1 s< x8_6)
