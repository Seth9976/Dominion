// 函数: _ZNKSt6__ndk18time_getIcNS_19istreambuf_iteratorIcNS_11char_traitsIcEEEEE11do_get_yearES4_S4_RNS_8ios_baseERjP2tm
// 地址: 0x10bd168
...
int64_t var_60 = 0
int64_t (* const var_70)() = std::__ndk1::ctype<char>::id
...
if (*std::__ndk1::ctype<char>::id != -1)
    ...
    var_50 = &var_70
    std::__ndk1::__call_once(std::__ndk1::ctype<char>::id, &var_58, sub_10dd4b0)
...
if (x9_1 u< (*(var_80 + 0x18) - x8_2) s>> 3)
    ...
    if (x22_1 != 0)
        ...
        int32_t x0_4 = sub_10be170(&result, arg3, arg5, x22_1, 4)
