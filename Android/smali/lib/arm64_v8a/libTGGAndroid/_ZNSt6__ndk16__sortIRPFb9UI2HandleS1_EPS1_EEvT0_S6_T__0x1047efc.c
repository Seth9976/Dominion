// 函数: _ZNSt6__ndk16__sortIRPFb9UI2HandleS1_EPS1_EEvT0_S6_T_
// 地址: 0x1047efc
...
while (true)
    void* __offset(UI2Handle, 0x4) x23_1 = x19
    ...
    label_1047f2c:
        ...
        uint64_t x0_48
        uint64_t x1_32
        bool (* x8_46)(UI2Handle, UI2Handle)
        int32_t x9_18
        ...
        if (x8_1 u<= 5)
                ...
                case 3
                    ...
                    label_10484c4:
                        ...
                        if ((arg1.d & 1) != 0)
                            ...
                            *x19 = vrev64_s32(v0_4)
                case 4
                    return std::__ndk1::__sort4<bool (*&)(UI2Handle, UI2Handle), UI2Handle*>(x19, 
                        x19 + 4, x19 + 8, x21 - 4, arg3) __tailcall
                case 5
                    std::__ndk1::__sort4<bool (*&)(UI2Handle, UI2Handle), UI2Handle*>(x19, x19 + 4, 
                        x19 + 8, x19 + 0xc, arg3)
            ...
            if (x9_1 s<= 0x7b)
                return std::__ndk1::__insertion_sort_3<bool (*&)(UI2Handle, UI2Handle), UI2Handle*>(
            ...
            void* __offset(UI2Handle, -0x4) x23_2 = x19 + (x10_1 << 1 & 0xfffffffffffffffc)
            int32_t x24_1
            ...
            if (x9_1 s< 0xf9d)
                ...
                void* x25_1 = x19 + x8_3
                UI2Handle* x26_1 = x23_2 + x8_3
                x24_1 = std::__ndk1::__sort4<bool (*&)(UI2Handle, UI2Handle), UI2Handle*>(x19, 
            ...
            UI2Handle* x25_2
            void* __offset(UI2Handle, -0x4) x26_2
            
            if (((*arg3)(zx.q(*x19), zx.q(*x23_2)) & 1) == 0)
                void* __offset(UI2Handle, -0x8) x26_3 = x21 - 8
                int32_t x0_21
                
                do
                    if (x19 == x26_3)
                        int32_t* x24_4 = x19
                        void* __offset(UI2Handle, 0x8) x24_5 = &x24_4[1]
                        ...
                        void* __offset(UI2Handle, -0x4) x25_3 = x21 - 4
            ...
            if (x25_2 u< x26_2)
            label_10481a0:
                void* __offset(UI2Handle, -0x4) x28_1
            ...
            label_1048248:
                ...
                if (x25_2 - x19 s>= x21 - x25_2)
                    std::__ndk1::__sort<bool (*&)(UI2Handle, UI2Handle), UI2Handle*>(x25_2 + 4, 
                        x21, arg3)
                    x21 = x25_2
                    break
                
                std::__ndk1::__sort<bool (*&)(UI2Handle, UI2Handle), UI2Handle*>(x19, x25_2, arg3)
                x23_1 = x25_2 + 4
                continue
            else
                int32_t x0_29 = std::__ndk1::__insertion_sort_incomplete<bool (*&)(UI2Handle, UI2Handle), UI2Handle*>(
                    x19, x25_2, arg3)
                x23_1 = x25_2 + 4
                
                if ((std::__ndk1::__insertion_sort_incomplete<bool (*&)(UI2Handle, UI2Handle), UI2Handle*>(
