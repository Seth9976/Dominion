...
*(entry_x0 + 0x40) = 0
*(entry_x0 + 0x48) = 0
*entry_x0 = _vtable_for_Botan::RIPEMD_160 + 0x10
*(entry_x0 + 0x38) = 0
...
*(entry_x0 + 0x58) = 0
*(entry_x0 + 0x60) = 0
int64_t x0_1 = Botan::allocate_memory(5, 4)
*(entry_x0 + 0x50) = x0_1
*(entry_x0 + 0x58) = x0_1 + 0x14
*(entry_x0 + 0x60) = x0_1 + 0x14
__builtin_memset(x0_1, 0, 0x14)
