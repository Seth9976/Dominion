// 函数: _ZNSt6__ndk16vectorINS_6futureIvEENS_9allocatorIS2_EEE21__push_back_slow_pathIS2_EEvOT_
// 地址: 0xf5a6e4
        ...
        if (x11 == x20_2)
            ...
            *(arg1 + 0x10) = x10_4
            ...
            if (x21_1 != x20_2)
                do
                    x21_1 -= 8
                    result = std::__ndk1::future<void>::~future()
                while (x20_2 != x21_1)
