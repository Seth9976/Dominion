...
label_f32a08:
    ...
    if (x20_1 == 0)
        return 0xffffffd8
(*(*x20_1 + 0x18))(x20_1, *(arg1 + 0x10), zx.q(*(arg1 + 0x18)), 0)

if (*(arg1 + 0x20) != 0)
    **(arg1 + 0x20) = (*(*var_50 + 0x18))()

if (*(arg1 + 0x28) != 0)
    **(arg1 + 0x28) = (*(*var_50 + 0x28))()

if (*(arg1 + 0x30) != 0)
    **(arg1 + 0x30) = (*(*var_50 + 0x20))()

int64_t* x0_13 = var_50
(*(*x0_13 + 0x38))(x0_13, *(arg1 + 0x38), *(arg1 + 0x10), *(arg1 + 0x40), *(arg1 + 0x48), 
    *(arg1 + 0x50), *(arg1 + 0x58))
