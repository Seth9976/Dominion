// 函数: _Z13MayDiscardOne11DomCardEnum15DomChoiceUIType
// 地址: 0xad3c4c
// 来自: E:\torrent\Cursor\Dominion_1.0.3315\split_config.arm64_v8a\lib\arm64-v8a\libTGGAndroid.so

int32_t var_cfc = arg1
CardsWhereType(0x3ea, 0, 0)
struct std::__ndk1::__function::__base<bool (CardID)>::std::__ndk1::__function::__func<MayDiscardOne(DomCardEnum, DomChoiceUIType)::$_7, std::__ndk1::allocator<MayDiscardOne(DomCardEnum, DomChoiceUIType)::$_7>, bool (CardID)>::VTable
    * const var_19b0 = &_vtable_for_std::__ndk1::__function::__func<MayDiscardOne(DomCardEnum, DomChoiceUIType)::$_7, std::__ndk1::allocator<MayDiscardOne(DomCardEnum, DomChoiceUIType)::$_7>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
...
var_cf0 = &_vtable_for_std::__ndk1::__function::__func<MayDiscardOne(DomCardEnum, DomChoiceUIType)::$_7, std::__ndk1::allocator<MayDiscardOne(DomCardEnum, DomChoiceUIType)::$_7>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
