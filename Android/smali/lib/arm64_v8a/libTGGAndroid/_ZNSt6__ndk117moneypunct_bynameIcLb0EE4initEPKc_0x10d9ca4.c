// 函数: _ZNSt6__ndk117moneypunct_bynameIcLb0EE4initEPKc
// 地址: 0x10d9ca4
...
std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >::assign(
    &arg1[0x18])
x0_1->currency_symbol
std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >::assign(
    &arg1[0x30])
uint32_t frac_digits = zx.d(x0_1->frac_digits)
uint32_t frac_digits_1

frac_digits_1 = frac_digits == 0xff ? 0 : frac_digits

*(arg1 + 0x78) = frac_digits_1

if (zx.d(x0_1->p_sign_posn) == 0)
    std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >::assign(
        &arg1[0x48])
else
    x0_1->positive_sign
...
std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >::basic_string(
    &ps)
sub_10da124(&arg1[0x7c], &ps, 0, x0_1->p_cs_precedes, x0_1->p_sep_by_space, x0_1->p_sign_posn)
sub_10da124(&arg1[0x80], &arg1[0x30], 0, x0_1->n_cs_precedes, x0_1->n_sep_by_space, 
    x0_1->n_sign_posn)
void* var_60
