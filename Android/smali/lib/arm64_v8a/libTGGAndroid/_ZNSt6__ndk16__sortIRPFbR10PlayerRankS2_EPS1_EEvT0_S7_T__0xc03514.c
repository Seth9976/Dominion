// 函数: _ZNSt6__ndk16__sortIRPFbR10PlayerRankS2_EPS1_EEvT0_S7_T_
// 地址: 0xc03514
...
while (true)
    void* __offset(PlayerRank, 0x10) x23_1 = x19
    ...
    label_c0354c:
        ...
        if (x8_1 u<= 5)
                ...
                case 3
                    ...
                    label_c03b98:
                        ...
                        if ((arg1.d & 1) != 0)
                            ...
                            *x22_1 = var_70_20
                case 4
                    return std::__ndk1::__sort4<bool (*&)(PlayerRank&, PlayerRank&), PlayerRank*>(
                        x19, x19 + 0x10, x19 + 0x20, x22 - 0x10, arg3) __tailcall
                case 5
                    x22_1 = x19 + 0x10
                    std::__ndk1::__sort4<bool (*&)(PlayerRank&, PlayerRank&), PlayerRank*>(x19, 
                        x22_1, x19 + 0x20, x19 + 0x30, arg3)
                    int128_t v0_15
            ...
            if (x9_1 s<= 0x1ef)
                return std::__ndk1::__insertion_sort_3<bool (*&)(PlayerRank&, PlayerRank&), PlayerRank*>(
            ...
            void* __offset(PlayerRank, -0x10) x23_2 = x19 + (x10_1 << 3 & 0xfffffffffffffff0)
            int32_t x24_1
            ...
            if (x9_1 s< 0x3e71)
                ...
                void* x25_1 = x19 + x8_4
                PlayerRank* x26_1 = x23_2 + x8_4
                x24_1 = std::__ndk1::__sort4<bool (*&)(PlayerRank&, PlayerRank&), PlayerRank*>(x19, 
            ...
            PlayerRank* x25_2
            void* __offset(PlayerRank, -0x10) x26_2
            
            if (((*arg3)(x19, x23_2) & 1) == 0)
                void* __offset(PlayerRank, -0x20) x25_3 = x22 - 0x20
                int32_t x0_21
                
                do
                    if (x19 == x25_3)
                        void* __offset(PlayerRank, 0x20) x25_4 = x19 + 0x10
                        ...
                        void* __offset(PlayerRank, -0x10) x24_4 = x22 - 0x10
            ...
            if (x25_2 u< x26_2)
            label_c03824:
                void* __offset(PlayerRank, -0x10) x27_1
            ...
            label_c038dc:
                ...
                if (x25_2 - x19 s>= x22 - x25_2)
                    std::__ndk1::__sort<bool (*&)(PlayerRank&, PlayerRank&), PlayerRank*>(
                        x25_2 + 0x10, x22, arg3)
                    x22 = x25_2
                    break
                
                std::__ndk1::__sort<bool (*&)(PlayerRank&, PlayerRank&), PlayerRank*>(x19, x25_2, 
                    arg3)
                x23_1 = x25_2 + 0x10
                continue
            else
                int32_t x0_29 = std::__ndk1::__insertion_sort_incomplete<bool (*&)(PlayerRank&, PlayerRank&), PlayerRank*>(
                    x19, x25_2, arg3)
                x23_1 = x25_2 + 0x10
                
                if ((std::__ndk1::__insertion_sort_incomplete<bool (*&)(PlayerRank&, PlayerRank&), PlayerRank*>(
