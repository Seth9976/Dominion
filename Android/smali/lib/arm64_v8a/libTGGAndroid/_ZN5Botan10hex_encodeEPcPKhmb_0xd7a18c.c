// 函数: _ZN5Botan10hex_encodeEPcPKhmb
// 地址: 0xd7a18c
...
label_d7a1a8:
    i_6 = 0
label_d7a1ac:
    int64_t i_3 = arg3 - i_6
    void* x11_1 = &arg2[i_6]
    void* x9_2 = &arg1[(i_6 << 1) + 1]
    int64_t i
    
    do
        uint32_t x12_1 = zx.d(*x11_1)
        x11_1 += 1
        i = i_3
        i_3 -= 1
        ...
        *(x9_2 - 1) = ((x14_1.b | 0x30) & x16_1.b) | (((x14_1 - 0xa).b + x8_1) & (not.d(x16_1)).b)
        *x9_2 = ((0x30 | (x12_1 & 0xf).b) & x16_2.b)
            | ((((x12_1 & 0xf) - 0xa).b + x8_1) & (not.d(x16_2)).b)
        x9_2 += 2
    while (i != 1)
    return 

int64_t x12_6 = (arg3 - 1) * 2
int32_t x10_2 = (arg3 - 1) * 2 u< arg3 - 1 ? 1 : 0
i_6 = 0

if (&arg1[x12_6] u< arg1 || (x10_2 & 1) != 0 || &arg1[1 + x12_6] u< &arg1[1] || (x10_2 & 1) != 0)
    goto label_d7a1ac

if (&arg2[arg3] u> arg1 && &arg1[arg3 << 1] u> arg2)
    goto label_d7a1a8
