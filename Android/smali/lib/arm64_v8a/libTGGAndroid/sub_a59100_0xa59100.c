...
int64_t x8 = *(arg1 + 8)
*result = &_vtable_for_std::__ndk1::__function::__func<CampaignContextFavoredLandscapeOrRandomOrAdd(bool (*)(DomCardEnum))::$_9, std::__ndk1::allocator<CampaignContextFavoredLandscapeOrRandomOrAdd(bool (*)(DomCardEnum))::$_9>, bool (DomCardEnum)>{for `std::__ndk1::__function::__base<bool (DomCardEnum)>'}
result[1] = x8
return result
