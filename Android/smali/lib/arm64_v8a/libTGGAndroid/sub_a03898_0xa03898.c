    ...
    label_a038bc:
        ...
        if (x8_1 u<= 5)
                        ...
                        if (x8_17 s< x9_19)
                            ...
                            if (x8_17 s< x10_14)
                                *x19 = x8_17
                                x19[1] = x10_14
                case 5
                    return sub_a03dc4(x19, &x19[1], &x19[2], &x19[3], x20 - 4) __tailcall
        else if (x9_1 s<= 0x7b)
            int32_t x9_15 = *x19
            int32_t x8_15 = x19[1]
            ...
            if (x9_1 s>= 0xf9d)
                ...
                arg1 = sub_a03dc4(x19, x19 + x8_3, x22_2, x22_2 + x8_3, x20 - 4)
                x9_3 = *x19
                x10_4 = *x22_2
        ...
        label_a0392c:
            ...
            label_a03ab4:
                ...
                if (x23_1 - x19 s>= x20 - x23_1)
                    sub_a03898(x23_1 + 4, x20)
                    x20 = x23_1
                    break
                
                sub_a03898(x19, x23_1)
                x22_1 = x23_1 + 4
                continue
            else
                int32_t x0_2 = sub_a03f90(x19, x23_1)
                x22_1 = x23_1 + 4
                
                if ((sub_a03f90(x22_1, x20).d & 1) != 0)
                    x20 = x23_1
