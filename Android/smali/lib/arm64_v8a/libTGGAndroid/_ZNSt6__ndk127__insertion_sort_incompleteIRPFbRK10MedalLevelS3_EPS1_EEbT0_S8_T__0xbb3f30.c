// 函数: _ZNSt6__ndk127__insertion_sort_incompleteIRPFbRK10MedalLevelS3_EPS1_EEbT0_S8_T_
// 地址: 0xbb3f30
...
if (x8_1 u> 5)
    void* __offset(MedalLevel, 0x30) x22_2 = arg1 + 0x20
    ...
    void* __offset(MedalLevel, 0x30) x8_17 = arg1 + 0x30
    char x8_20
    ...
    label_bb42f8:
        ...
        while (true)
            void* __offset(MedalLevel, 0x30) x1_15 = x22_2
            x22_2 = x8_17
            int32_t x0_29
            int128_t v0_9
    ...
    x8_2 = 1
    void* __offset(MedalLevel, 0x10) x22_1
    int128_t v0_7
