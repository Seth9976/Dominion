// 函数: _ZNKSt6__ndk18time_getIwNS_19istreambuf_iteratorIwNS_11char_traitsIwEEEEE14do_get_weekdayES4_S4_RNS_8ios_baseERjP2tm
// 地址: 0x10bea9c
...
if (x9_1 u< (*(var_90 + 0x18) - x8_2) s>> 3)
    ...
    if (x23_1 != 0)
        ...
        void* x8_5 = sub_10b3ff4(&result, arg3, x0_4, &x0_4[0x150], x23_1, arg5, 0) - x0_4
