...
*result = &_vtable_for_std::__ndk1::__function::__func<RollThemeLandscape()::$_134, std::__ndk1::allocator<RollThemeLandscape()::$_134>, bool (DomCardEnum)>{for `std::__ndk1::__function::__base<bool (DomCardEnum)>'}
return result
