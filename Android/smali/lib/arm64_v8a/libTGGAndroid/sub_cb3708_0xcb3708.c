...
while (true)
    ...
    while (true)
        ...
        if ((arg7 & 0x20) != 0)
            ...
            if (x0_26 != 0)
                Botan::deallocate_memory(x0_26, arg_190 - x0_26, 1)
        else
            x20 = x19_1
            x27 = x21_1
            char arg_c0
            ...
            if ((arg7 & 0xc0) == 0)
                ...
                label_cb2eec:
                    ...
                    uint8_t* x0_85 = arg_e0.q
                    Botan::hex_encode(x0_85, x8_86 - x0_85, true)
                    (*(*arg4 + 0x10))(arg4, zx.q(arg5), zx.q(arg7), x27, arg8, &arg_c0)
                    uint64_t x8_110 = zx.q(arg_120.b)
                    ...
                    label_cb3258:
                        ...
                        if (x0_88 != 0)
                            arg31 = x0_88
                            operator delete(x0_88)
                    uint64_t x0_89 = arg_170.q
                    
                    if (x0_89 == 0)
                        continue
                    else
                        arg41 = x0_89
                        Botan::deallocate_memory(x0_89, (arg42 - x0_89) s>> 2, 4)
                        continue
                ...
                if (x8_15 u>= 3 && (zx.d(*x10_1) | 4) == 0x86)
                    ...
                    if (x8_15 - 2 == i_2)
                        ...
                        if (i_2.d u>= 0x17)
                            void* x20_5 = (x8_15 + 0xe) & 0xfffffffffffffff0
                            uint64_t x0_79 = operator new(x20_5)
                            fp_2 = x0_79
                            arg31 = i_2
                            arg32 = x0_79
                            arg_e0.q = x20_5 | 1
