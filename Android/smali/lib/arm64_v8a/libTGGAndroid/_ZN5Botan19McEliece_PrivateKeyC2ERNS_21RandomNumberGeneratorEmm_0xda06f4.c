// 函数: _ZN5Botan19McEliece_PrivateKeyC2ERNS_21RandomNumberGeneratorEmm
// 地址: 0xda06f4
...
if ((entry_x3 & 0xffffffff80000000) != 0)
    ...
    do
        x9_3 <<= 1
        x8_6 += 1
    while (x9_3 u< entry_x3)

uint64_t entry_x4
Botan::generate_mceliece_key(arg3, zx.q(x8_6.b), entry_x3, entry_x4)
    ...
    if (x21_2 != var_100)
        do
            ...
            if (x19_2 != 0)
                ...
                do
                    x9_6 = __ldaxr(&x19_2[1])
                    i_1 = __stlxr(x9_6 - 1, &x19_2[1])
                while (i_1 != 0)
            ...
            if (x19_2 != 0 && x9_6 == 0)
                ...
                if (x0_13 != 0)
                label_da0934:
                    int64_t x8_14 = *(x21_2 - 0x18)
                    *(x21_2 - 0x20) = x0_13
                    Botan::deallocate_memory(x0_13, (x8_14 - x0_13) s>> 1, 2)
            x21_2 -= 0x30
        while (x21_2 != var_100)
