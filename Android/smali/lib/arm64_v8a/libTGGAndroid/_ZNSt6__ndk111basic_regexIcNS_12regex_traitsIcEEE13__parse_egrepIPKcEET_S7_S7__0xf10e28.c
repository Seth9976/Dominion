// 函数: _ZNSt6__ndk111basic_regexIcNS_12regex_traitsIcEEE13__parse_egrepIPKcEET_S7_S7_
// 地址: 0xf10e28
        ...
        do
            ...
            if (entry_result_1 == entry_result_3)
                ...
                *(arg1 + 0x38) = *(*(arg1 + 0x38) + 8)
                ...
                std::__ndk1::basic_regex<char, std::__ndk1::regex_traits<char> >::__parse_extended_reg_exp<char const*>(
                    arg1, entry_result_3)
