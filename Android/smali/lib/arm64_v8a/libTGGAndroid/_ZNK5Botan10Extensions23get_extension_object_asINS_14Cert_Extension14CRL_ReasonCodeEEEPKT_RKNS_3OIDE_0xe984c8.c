// 函数: _ZNK5Botan10Extensions23get_extension_object_asINS_14Cert_Extension14CRL_ReasonCodeEEEPKT_RKNS_3OIDE
// 地址: 0xe984c8
        ...
        if ((x8_3 & 1) != 0)
            ...
            label_e985f8:
                int64_t result = __dynamic_cast(x19_1, _typeinfo_for_Botan::Certificate_Extension, 
                    _typeinfo_for_Botan::Cert_Extension::CRL_ReasonCode, 0)
