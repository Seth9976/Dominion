// 函数: _Z10TrashOneOfRK7CardIDsP8DomWhere15DomChoiceUIType15DomChoiceAIHint14DomChoiceFlags
// 地址: 0xaddd68
...
int32_t var_d40 = 9
int32_t var_48
uint64_t result = QueueChoiceCards(x0_2, &var_cd0, x2, 1, &i_1, zx.q(var_48), 1, 1)
