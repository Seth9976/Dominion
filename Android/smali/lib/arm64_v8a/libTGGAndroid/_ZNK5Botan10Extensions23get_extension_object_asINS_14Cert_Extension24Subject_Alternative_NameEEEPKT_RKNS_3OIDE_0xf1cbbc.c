// 函数: _ZNK5Botan10Extensions23get_extension_object_asINS_14Cert_Extension24Subject_Alternative_NameEEEPKT_RKNS_3OIDE
// 地址: 0xf1cbbc
        ...
        if ((x8_3 & 1) != 0)
            ...
            label_f1ccec:
                int64_t result = __dynamic_cast(x19_1, _typeinfo_for_Botan::Certificate_Extension, 
                    _typeinfo_for_Botan::Cert_Extension::Subject_Alternative_Name, 0)
