...
struct std::__ndk1::__function::__base<bool (CardID)>::std::__ndk1::__function::__func<Farmland_OnBuy()::$_14, std::__ndk1::allocator<Farmland_OnBuy()::$_14>, bool (CardID)>::VTable
    * const var_ce0 = &_vtable_for_std::__ndk1::__function::__func<Farmland_OnBuy()::$_14, std::__ndk1::allocator<Farmland_OnBuy()::$_14>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
