...
*result = &_vtable_for_std::__ndk1::__function::__func<Surprise_CardMods()::$_47, std::__ndk1::allocator<Surprise_CardMods()::$_47>, bool (DomCardEnum)>{for `std::__ndk1::__function::__base<bool (DomCardEnum)>'}
return result
