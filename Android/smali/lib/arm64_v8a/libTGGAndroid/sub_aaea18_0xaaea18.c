...
int64_t x8 = *(arg1 + 8)
*result = &_vtable_for_std::__ndk1::__function::__func<CardsWhereAnyone(DomWhere, DomCardType, DomCardEnum)::$_1, std::__ndk1::allocator<CardsWhereAnyone(DomWhere, DomCardType, DomCardEnum)::$_1>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
result[1] = x8
return result
