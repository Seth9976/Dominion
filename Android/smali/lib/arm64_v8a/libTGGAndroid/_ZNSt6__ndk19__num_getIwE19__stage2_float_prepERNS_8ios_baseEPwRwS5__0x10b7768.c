// 函数: _ZNSt6__ndk19__num_getIwE19__stage2_float_prepERNS_8ios_baseEPwRwS5_
// 地址: 0x10b7768
...
if (x9_1 u< (*(var_88 + 0x18) - x8_2) s>> 3)
    ...
    if (x0_1 != 0)
        (*(*x0_1 + 0x60))(x0_1, std::__ndk1::__num_get_base::__src, 
            std::__ndk1::__num_get_base::__src + 0x20, arg2)
        int64_t var_70_1 = 0
        var_80 = std::__ndk1::numpunct<wchar_t>::id
        int64_t (* const var_78_1)() = std::__ndk1::locale::id::__init
        
        if (*std::__ndk1::numpunct<wchar_t>::id != -1)
            var_68 = &var_60
            var_60 = &var_80
            std::__ndk1::__call_once(std::__ndk1::numpunct<wchar_t>::id, &var_68, sub_10dd4b0)
        
        int64_t x8_6 = *(var_88 + 0x10)
        int64_t x9_3 = sx.q(*(std::__ndk1::numpunct<wchar_t>::id + 8)) - 1
        
        if (x9_3 u< (*(var_88 + 0x18) - x8_6) s>> 3)
            int64_t* x22_2 = *(x8_6 + (x9_3 << 3))
            
            if (x22_2 != 0)
                *arg3 = (*(*x22_2 + 0x18))(x22_2)
                *arg4 = (*(*x22_2 + 0x20))(x22_2)
                (*(*x22_2 + 0x28))(x22_2)
