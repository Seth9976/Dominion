// 函数: _ZN5Botan14XTS_Encryption7processEPhm
// 地址: 0xed699c
...
Botan::assertion_failure("sz % BS == 0", "Input is full blocks", "process", 
    "..\..\ExternalCode\botan\botanAM\arm\botan_all_android.cpp", 0x18da6)
return Botan::XTS_Mode::update_granularity() __tailcall
