// 函数: _ZN5Botan4Pipe22Invalid_Message_NumberC2ERKNSt6__ndk112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEEm
// 地址: 0xd7cdcc
...
*arg1 = _vtable_for_Botan::Pipe::Invalid_Message_Number + 0x10
return result
