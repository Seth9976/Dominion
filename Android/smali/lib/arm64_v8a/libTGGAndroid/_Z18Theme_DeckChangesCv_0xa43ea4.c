// 函数: _Z18Theme_DeckChangesCv
// 地址: 0xa43ea4
// 来自: E:\torrent\Cursor\Dominion_1.0.3315\split_config.arm64_v8a\lib\arm64-v8a\libTGGAndroid.so

int64_t* x8_2 = *gCampaignData + ((zx.q(*(gCampaignData + 8)) & 0x8dd) << 3)
int32_t* x9_1
...
label_a43f2c:
    ...
    label_a43fc8:
        ...
        int64_t* x8_15 = *gCampaignData + ((zx.q(*(gCampaignData + 8)) & 0x9dc) << 3)
        int32_t* x9_15
...
XNoReturn()
return Theme_PileChangesA_Colonies_Test() __tailcall
