// 函数: _ZN5Botan11BER_Decoder15decode_optionalINS_7X509_DNEEERS0_RT_NS_8ASN1_TagES6_RKS4_
// 地址: 0xe9eefc
    ...
    if (x20 != entry_x4)
        *(entry_x4 + 0x10)
        std::__ndk1::vector<std::__ndk1::pair<Botan::OID, Botan::ASN1_String>, std::__ndk1::allocator<std::__ndk1::pair<Botan::OID, Botan::ASN1_String> > >::assign<std::__ndk1::pair<Botan::OID, Botan::ASN1_String>*>(
            &x20[1], *(entry_x4 + 8))
        *(entry_x4 + 0x28)
        std::__ndk1::vector<uint8_t, std::__ndk1::allocator<uint8_t> >::assign<uint8_t*>(&x20[4], 
            *(entry_x4 + 0x20))
