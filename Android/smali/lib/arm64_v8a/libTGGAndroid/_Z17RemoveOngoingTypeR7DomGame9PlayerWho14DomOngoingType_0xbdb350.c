// 函数: _Z17RemoveOngoingTypeR7DomGame9PlayerWho14DomOngoingType
// 地址: 0xbdb350
...
if (x8 s< 1)
    ...
    do
        ...
        if (*(fp_1 + 0x3c21c) == x22_1)
            int64_t x9_3 = sx.q(x23_1)
            
            if (*(arg1 + x9_3 * 0xb8 + 0x3c254) == 3 && *(arg1 + x9_3 * 0xb8 + 0x3c258) == x19_1)
                ...
                if (x11_2 - 3 u>= 4)
                    int32_t x8_6 = *(arg1 + x9_3 * 0xb8 + 0x3c220)
                    uint64_t x2
                    ...
                    int32_t var_78_1 = 0
                    int32_t var_80_1 = 0
                    v0, v1, v2, v3 = DomNotifyEffect(zx.q(x11_2 == 2 ? 1 : 0), 0x1c, x2, 
                        zx.q(x19_1), zx.q(*(arg1 + x9_3 * 0xb8 + 0x3c25c)), 0, 0, 0)
                    x8 = *(arg1 + 0x19c0)
