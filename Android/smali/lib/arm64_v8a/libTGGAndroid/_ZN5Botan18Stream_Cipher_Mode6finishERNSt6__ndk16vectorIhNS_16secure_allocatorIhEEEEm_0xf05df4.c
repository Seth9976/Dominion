// 函数: _ZN5Botan18Stream_Cipher_Mode6finishERNSt6__ndk16vectorIhNS_16secure_allocatorIhEEEEm
// 地址: 0xf05df4
...
if (x9_1 u< entry_x2)
    return Botan::Stream_Cipher_Mode::output_length(Botan::assertion_failure(
