...
int16_t var_90 = 0
Botan::AEAD_Mode::create_or_throw(&var_78, 1, &var_90)
void* var_80
...
if (arg3 != -0x10)
    int64_t x0_7 = Botan::allocate_memory(arg3 + 0x10, 1)
    void* x24_1 = var_78.q
...
std::__ndk1::vector<uint8_t, Botan::secure_allocator<uint8_t> >::assign<uint8_t const*>(&var_78, 
    arg2)
std::__ndk1::vector<uint8_t, Botan::secure_allocator<uint8_t> >::insert<uint8_t const*>(&var_78, 
    var_77:7.q, arg4)
...
if (x8_10 != x21_1)
    ...
    memmove(arg1, x21_1, x8_10 - x21_1)
    var_77:7.q = x21_1
    Botan::deallocate_memory(x21_1, var_77:0xf.q - x21_1, 1)
else if (x21_1 != 0)
    var_77:7.q = x21_1
    Botan::deallocate_memory(x21_1, var_77:0xf.q - x21_1, 1)
