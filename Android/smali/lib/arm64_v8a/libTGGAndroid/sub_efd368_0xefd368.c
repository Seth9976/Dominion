            ...
            if ((Botan::BigInt::cmp(&var_a0, Botan::EC_Group::data() - 0x18) & 0x80000000) != 0
                ...
                label_efd63c:
                    ...
                    if ((Botan::BigInt::cmp(&var_c8, Botan::EC_Group::data() - 0x18) & 0x80000000)
                            != 0)
                        Botan::inverse_mod(&var_c8, Botan::EC_Group::data() + 0xe8)
                        Botan::Modular_Reducer::reduce(Botan::EC_Group::data() + 0x138)
                        void* var_1c8
                        Botan::Modular_Reducer::multiply(Botan::EC_Group::data() + 0x138, &var_1c8)
                        void* x0_29 = var_1c8
                        
                        if (x0_29 != 0)
                            void* var_1c0_1 = x0_29
                            int64_t var_1b8
                            Botan::deallocate_memory(x0_29, (var_1b8 - x0_29) s>> 2, 4)
                        ...
                        if (x8_17 == 0)
                            ...
                            void* var_1f0
                            int32_t x0_39 = Botan::BigInt::is_equal(&var_1f0)
                            void* x8_20 = var_1f0
                            x21_1 = x0_39
                            
                            if (x8_20 != 0)
                                void* var_1e8_1 = x8_20
                                int64_t var_1e0
                                Botan::deallocate_memory(x8_20, (var_1e0 - x8_20) s>> 2, 4)
                        ...
                        if (x0_42 != 0)
                            void* var_110_1 = x0_42
                            int64_t var_108
                            Botan::deallocate_memory(x0_42, (var_108 - x0_42) s>> 2, 4)
