...
*result = &_vtable_for_std::__ndk1::__function::__func<CamelTrain()::$_0, std::__ndk1::allocator<CamelTrain()::$_0>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
return result
