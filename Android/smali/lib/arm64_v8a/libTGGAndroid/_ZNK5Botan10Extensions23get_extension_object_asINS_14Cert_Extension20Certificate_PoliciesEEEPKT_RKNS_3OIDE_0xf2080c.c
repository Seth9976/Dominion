// 函数: _ZNK5Botan10Extensions23get_extension_object_asINS_14Cert_Extension20Certificate_PoliciesEEEPKT_RKNS_3OIDE
// 地址: 0xf2080c
        ...
        if ((x8_3 & 1) != 0)
            ...
            label_f2093c:
                int64_t result = __dynamic_cast(x19_1, _typeinfo_for_Botan::Certificate_Extension, 
                    _typeinfo_for_Botan::Cert_Extension::Certificate_Policies, 0)
