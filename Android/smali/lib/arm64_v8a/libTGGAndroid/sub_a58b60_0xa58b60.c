...
*result = &_vtable_for_std::__ndk1::__function::__func<CampaignRule_Adventures()::$_1, std::__ndk1::allocator<CampaignRule_Adventures()::$_1>, bool (DomCardEnum)>{for `std::__ndk1::__function::__base<bool (DomCardEnum)>'}
return result
