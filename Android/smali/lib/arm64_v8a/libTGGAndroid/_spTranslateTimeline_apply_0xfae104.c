...
if (arg6 <= arg7)
    ...
    label_fae3ac:
        ...
        v4 = x8[5].d
        v3 = *(x8 + 0x2c)
        x8[5].d = v4 + (arg7 - v4) * arg8
        *(x8 + 0x2c) = v3 + (arg6 + *(x9_9 + 0x20) - v3) * arg8
    else
    label_fae1d8:
        
        if (arg5 == 3)
            x8[5].d = v3 * arg8 f+ x8[5].d
            *(x8 + 0x2c) = arg6 * arg8 + *(x8 + 0x2c)
        else if (arg5 == 0)
            void* x9_5 = *x8
            x8[5].d = v3 * arg8 + *(x9_5 + 0x1c)
            *(x8 + 0x2c) = arg6 * arg8 + *(x9_5 + 0x20)
else if (arg5 == 1)
    void* x9_6 = *x8
    arg7 = x8[5].d
    v3 = *(x8 + 0x2c)
    x8[5].d = arg7 + (*(x9_6 + 0x1c) - arg7) * arg8
    *(x8 + 0x2c) = v3 + (*(x9_6 + 0x20) - v3) * arg8
else if (arg5 == 0)
    void* x9_3 = *x8
    x8[5].d = *(x9_3 + 0x1c)
    *(x8 + 0x2c) = *(x9_3 + 0x20)
