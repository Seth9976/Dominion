...
*result = &_vtable_for_std::__ndk1::__function::__func<Inheritance()::$_32, std::__ndk1::allocator<Inheritance()::$_32>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
return result
