// 函数: _Z14PropDynamicSetIfEfR14UI2PropDynamicIT_ERK9PropGraphIS1_ERK8BlendDeff
// 地址: 0x101973c
        ...
        if (x24 == *(arg1 + 0x34) && *(arg2 + 0x38) == *(arg1 + 0x38) && x23_1.d == *(arg1 + 0x30))
            ...
            if (x23_1.d == 0 || x0_3 == 0)
                ...
                if (x8_6 u> 0x19 || (1 << x8_6 & 0x290001d) == 0)
                    ...
                    UI2PropDynamic<Vec2>* x0_6
                    PropGraph<Vec2>* x1_2
                    BlendDef* x2_2
                    float v0_2
                    x0_6, x1_2, x2_2, v0_2 = XNoReturn()
                    return PropDynamicSet<Vec2>(x0_6, x1_2, x2_2, v0_2) __tailcall
        
        arg4, v1, v2, v3 = UI2PropDynamic<float>::Eval(v8)
        *arg1 = arg4
        v1.q = 0
        v1:8.q = 0
        *(arg1 + 0x38) = 0
