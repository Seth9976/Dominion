// 函数: _ZNK5Botan3DES9decrypt_nEPKhPhm
// 地址: 0xd0cf28
...
if (x4 == *(arg1 + 0x10))
    ...
    return sub_d0d3c4(x0_19, x1_19, x2_6, x3_8, x4_7) __tailcall
...
if (entry_x3 u>= 2)
    while (true)
        ...
        sub_d0d3c4(&var_44, &var_48, &var_54, &var_58, x4)
...
for (int64_t i = 0; i != -0x80; )
    void* x2_1 = *(x20 + 8) + i
    i -= 0x10
    int32_t x3_2 = *(x2_1 + 0x78) ^ ror.d(arg1.d, 4)
    int32_t x4_2 = *(x2_1 + 0x7c) ^ arg1.d
    ...
    int32_t x3_5 = *(x2_1 + 0x70) ^ ror.d(x1_11, 4)
    int32_t x2_3 = *(x2_1 + 0x74) ^ x1_11
