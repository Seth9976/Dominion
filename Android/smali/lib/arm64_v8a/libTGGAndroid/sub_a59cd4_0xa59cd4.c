...
*result = &_vtable_for_std::__ndk1::__function::__func<Start_AddEachKingdomPile()::$_42, std::__ndk1::allocator<Start_AddEachKingdomPile()::$_42>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
return result
