// 函数: _ZN5Botan14OCB_Encryption7processEPhm
// 地址: 0xdde908
...
if (entry_result u% x9_1 != 0)
    ...
    x0_1, x1 = Botan::assertion_failure("sz % update_granularity() == 0", "Invalid OCB input size", 
        "process", "..\..\ExternalCode\botan\botanAM\arm\botan_all_android.cpp", 0xf203)
    return Botan::OCB_Encryption::finish(x0_1, x1) __tailcall

Botan::OCB_Encryption::encrypt(arg1, arg2)
return entry_result
