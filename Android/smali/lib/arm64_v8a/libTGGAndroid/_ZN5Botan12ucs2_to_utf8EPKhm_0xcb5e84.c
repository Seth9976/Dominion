// 函数: _ZN5Botan12ucs2_to_utf8EPKhm
// 地址: 0xcb5e84
...
if ((arg2.d & 1) != 0)
    ...
    __builtin_strncpy(x0_2, "Invalid length for UCS-2 string", 0x20)
...
do
    sub_e8ad28(entry_x8.b, _byteswap(zx.d(*x20_1)) u>> 0x10)
    i = i_1
    i_1 -= 1
    x20_1 = &x20_1[2]
while (i != 1)
