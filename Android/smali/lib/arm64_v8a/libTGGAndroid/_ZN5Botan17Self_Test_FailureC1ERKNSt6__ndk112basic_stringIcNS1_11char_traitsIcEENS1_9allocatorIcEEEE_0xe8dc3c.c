// 函数: _ZN5Botan17Self_Test_FailureC1ERKNSt6__ndk112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEE
// 地址: 0xe8dc3c
...
*arg1 = _vtable_for_Botan::Internal_Error + 0x10
void* var_40

if ((zx.d(var_50) & 1) != 0)
    result = operator delete(var_40)
*arg1 = _vtable_for_Botan::Self_Test_Failure + 0x10
return result
