// 函数: _ZNK5Botan15ECDSA_PublicKey22create_verification_opERKNSt6__ndk112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEES9_
// 地址: 0xd3802c
...
struct Botan::PK_Ops::Verification_with_EMSA::Botan::(anonymous namespace)::ECDSA_Verification_Operation::VTable
    ** x20_1 = x0_2
Botan::PK_Ops::Verification_with_EMSA::Verification_with_EMSA(x0_2)
*x20_1 = &_vtable_for_Botan::(anonymous namespace)::ECDSA_Verification_Operation{for `Botan::PK_Ops::Verification_with_EMSA'}
