// 函数: _Z20GetReplacementTestFnR7DomGame11DomCardEnum
// 地址: 0xbe468c
...
for (int32_t i = *x9_2; i != 9; i = *x9_2)
    if (i == 0)
        ...
        int64_t x1_2
        x0_6, x1_2 = XNoReturn()
        return DeferReducePlayCount(x0_6, x1_2) __tailcall
    
    x8_6 += 1
    x9_2 = &x9_2[0x30]

return *(x0_3 + (x8_6 & 0xffffffff) * 0xc0 + 0x188)
