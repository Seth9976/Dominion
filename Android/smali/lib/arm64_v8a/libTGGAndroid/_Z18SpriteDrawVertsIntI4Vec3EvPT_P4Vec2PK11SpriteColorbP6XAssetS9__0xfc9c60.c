// 函数: _Z18SpriteDrawVertsIntI4Vec3EvPT_P4Vec2PK11SpriteColorbP6XAssetS9_
// 地址: 0xfc9c60
...
if (zx.d(*(x25 + 0x167)) != 0)
    ...
    float cosp_2
    float sinp_2
    sincosf(&sinp_2, &cosp_2, v10.d f* *(arg1 + 0xc))
    float var_94_1 = v8.d f* sinp_2
    float var_90_1 = cosp_2 f* v8.d
    float var_8c_1 = v9.d f* *(arg1 + 0x10)
    float cosp_1
    float sinp_1
    sincosf(&sinp_1, &cosp_1, v10.d f* *(arg1 + 0x18))
    float var_88_1 = v8.d f* sinp_1
    float var_84_1 = cosp_1 f* v8.d
    float var_80_1 = v9.d f* *(arg1 + 0x1c)
    float cosp
    float sinp
    sincosf(&sinp, &cosp, v10.d f* *(arg1 + 0x24))
    float var_7c_1 = v8.d f* sinp
    float var_78_1 = cosp f* v8.d
    float var_74_1 = v9.d f* *(arg1 + 0x28)
    
    if (x23 == 0)
        x23 = *(x25 + 0x3b8)
        
        if (x23 == 0)
            if ((zx.d(*guard variable for void SpriteDrawVertsInt<Vec3>(Vec3*, Vec2*, SpriteColor const*, bool, XAsset*, XAsset*)::materialParticle)
                    & 1) == 0 && __cxa_guard_acquire(guard variable for void SpriteDrawVertsInt<Vec3>(Vec3*, Vec2*, SpriteColor const*, bool, XAsset*, XAsset*)::materialParticle)
                    != 0)
                *void SpriteDrawVertsInt<Vec3>(Vec3*, Vec2*, SpriteColor const*, bool, XAsset*, XAsset*)::materialParticle =
                    AssetPtrFromPath("sys/sprite_3d.material", 5)
                __cxa_guard_release(guard variable for void SpriteDrawVertsInt<Vec3>(Vec3*, Vec2*, SpriteColor const*, bool, XAsset*, XAsset*)::materialParticle)
            
            x23 = *void SpriteDrawVertsInt<Vec3>(Vec3*, Vec2*, SpriteColor const*, bool, XAsset*, XAsset*)::materialParticle
...
if (zx.d(*(x25 + 0x164)) != 0)
    ...
    float v18 = *(x25 + 0x140)
    float v22 = *(x25 + 0x150)
    var_a0 = v0 + v1 * v4 + v2 * v5 + v3 * v6
    float var_9c_2 = v18 + v1 * v7 + v2 * v16 + v3 * v17
    float var_98_2 = v22 + v1 * v19 + v2 * v20 + v3 * v21
    v1 = *(arg1 + 0xc)
    v2 = *(arg1 + 0x10)
    v3 = *(arg1 + 0x14)
    float var_94_2 = v0 + v1 * v4 + v2 * v5 + v3 * v6
    float var_90_2 = v18 + v1 * v7 + v2 * v16 + v3 * v17
    float var_8c_2 = v22 + v1 * v19 + v2 * v20 + v3 * v21
    v1 = *(arg1 + 0x18)
    v2 = *(arg1 + 0x1c)
    v3 = *(arg1 + 0x20)
    float var_88_2 = v0 + v1 * v4 + v2 * v5 + v3 * v6
    float var_84_2 = v18 + v1 * v7 + v2 * v16 + v3 * v17
    float var_80_2 = v22 + v1 * v19 + v2 * v20 + v3 * v21
    v0 = *(arg1 + 0x24)
    v1 = *(arg1 + 0x28)
    v2 = *(arg1 + 0x2c)
    float var_7c_2 =
        *(x25 + 0x130) + v0 * *(x25 + 0x124) + v1 * *(x25 + 0x128) + v2 * *(x25 + 0x12c)
    float var_78_2 =
        *(x25 + 0x140) + v0 * *(x25 + 0x134) + v1 * *(x25 + 0x138) + v2 * *(x25 + 0x13c)
    float var_74_2 =
        *(x25 + 0x150) + v0 * *(x25 + 0x144) + v1 * *(x25 + 0x148) + v2 * *(x25 + 0x14c)
