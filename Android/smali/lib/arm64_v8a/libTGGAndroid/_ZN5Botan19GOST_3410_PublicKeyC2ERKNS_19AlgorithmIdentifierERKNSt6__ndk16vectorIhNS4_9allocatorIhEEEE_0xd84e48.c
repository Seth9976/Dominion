// 函数: _ZN5Botan19GOST_3410_PublicKeyC2ERKNS_19AlgorithmIdentifierERKNSt6__ndk16vectorIhNS4_9allocatorIhEEEE
// 地址: 0xd84e48
...
int64_t x9_2 = var_160
int64_t x8_14 = *(*arg1 - 0x88)
var_160 = 0
int64_t* var_158_1 = nullptr
void* x8_15 = arg1 + x8_14
int64_t* x21 = *(x8_15 + 0x10)
*(x8_15 + 8) = x9_2
int64_t var_158
*(x8_15 + 0x10) = var_158
...
if (var_158_1 != 0)
    ...
    do
        x9_4 = __ldaxr(&var_158_1[1])
        i_1 = __stlxr(x9_4 - 1, &var_158_1[1])
    while (i_1 != 0)
...
*(*arg1 - 0x88)
uint64_t x21_2 = *(Botan::EC_Group::data() + 0x1e0)

if (x21_2 == 0x100 || x21_2 == 0x200)
    char* var_b0
    ...
    char* x1_7 = var_b0
    int64_t var_a8
    void* x9_5 = var_a8 - x1_7
    uint64_t x8_29 = x9_5 u>> 2
    uint64_t x20_1 = x9_5 u>> 1
    
    if (x8_29 != 0)
        void* x10_3 = &x1_7[x20_1]
        char x12_1 = *x1_7
        void* x9_6 = x9_5 & 0xfffffffffffffffe
        *x1_7 = *(x10_3 - 1)
        *(x10_3 - 1) = x12_1
        char* x10_4 = var_b0
        void* x11_4 = x9_6 + x10_4
    ...
    int64_t var_c0_1 = -1
    int32_t var_b8_1 = 1
    Botan::BigInt::binary_decode(&var_d8, &x8_30[x20_1])
    *(*arg1 - 0x88)
    int128_t v0_1
    int128_t v1_1
    v0_1, v1_1 = Botan::PointGFp::PointGFp(&var_160, Botan::EC_Group::data(), &var_98)
    void* x8_37 = arg1 + *(*arg1 - 0x88) + 0x18
    
    if (&var_160 != x8_37)
        int64_t x12_5 = *x8_37
        int64_t x10_6 = *(x8_37 + 8)
        *x8_37 = var_160
        *(x8_37 + 8) = var_158_1
        var_160 = x12_5
        int64_t var_158_2 = x10_6
        v1_1 = *(x8_37 + 0x10)
        *(x8_37 + 0x10) = var_150.o
        var_150.o = v1_1
        int64_t x12_6 = *(x8_37 + 0x20)
        int64_t x10_7 = *(x8_37 + 0x28)
        *(x8_37 + 0x20) = var_140
        int64_t var_138
        *(x8_37 + 0x28) = var_138
        int64_t var_140_1 = x12_6
        int64_t var_138_1 = x10_7
        int32_t x10_8 = *(x8_37 + 0x30)
        *(x8_37 + 0x30) = var_130_2
        var_130_2 = x10_8
        v1_1 = *(x8_37 + 0x38)
        int128_t var_128
        *(x8_37 + 0x38) = var_128
        int128_t var_128_1 = v1_1
        int64_t x12_7 = *(x8_37 + 0x48)
        int64_t x10_9 = *(x8_37 + 0x50)
        int64_t var_118
        *(x8_37 + 0x48) = var_118
        int64_t var_110
        *(x8_37 + 0x50) = var_110
        ...
        *(x8_37 + 0x60) = var_100
        ...
        int64_t x12_8 = *(x8_37 + 0x70)
        int64_t x10_11 = *(x8_37 + 0x78)
        int64_t var_f0
        *(x8_37 + 0x70) = var_f0
        int64_t var_e8
        *(x8_37 + 0x78) = var_e8
    ...
    *(*arg1 - 0x88)
    ...
    Botan::assertion_failure("m_public_key.on_the_curve()", 
