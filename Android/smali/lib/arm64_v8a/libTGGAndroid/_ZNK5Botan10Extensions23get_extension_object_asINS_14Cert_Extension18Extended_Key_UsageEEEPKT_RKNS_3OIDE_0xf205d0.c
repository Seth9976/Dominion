// 函数: _ZNK5Botan10Extensions23get_extension_object_asINS_14Cert_Extension18Extended_Key_UsageEEEPKT_RKNS_3OIDE
// 地址: 0xf205d0
        ...
        if ((x8_3 & 1) != 0)
            ...
            label_f20700:
                int64_t result = __dynamic_cast(x19_1, _typeinfo_for_Botan::Certificate_Extension, 
                    _typeinfo_for_Botan::Cert_Extension::Extended_Key_Usage, 0)
