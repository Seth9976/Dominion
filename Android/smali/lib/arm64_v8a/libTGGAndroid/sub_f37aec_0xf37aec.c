...
**(arg1 + 8) = 0
Botan::Private_Key* x0 = operator new(0x10)
Botan::RandomNumberGenerator* x0_2 =
    Botan_FFI::safe_get<Botan::Private_Key, 2140551262u>(*(arg1 + 0x10))
Botan::system_rng()
char* x23 = *(arg1 + 0x18)
...
*(x24 + x0_4) = 0
int16_t var_70 = 0
Botan::PK_Decryptor_EME::PK_Decryptor_EME(x0, x0_2, &data_23ecbc0, &var_58)
...
x0_11[2] = x0
x0_11[1].d = 0x912f3c37
*x0_11 = _vtable_for_botan_pk_op_decrypt_struct + 0x10
**(arg1 + 8) = x0_11
return 0
