...
*result = &_vtable_for_std::__ndk1::__function::__func<Landmod_Event_Stamp_GotItAlready()::$_12, std::__ndk1::allocator<Landmod_Event_Stamp_GotItAlready()::$_12>, void ()>{for `std::__ndk1::__function::__base<void ()>'}
return result
