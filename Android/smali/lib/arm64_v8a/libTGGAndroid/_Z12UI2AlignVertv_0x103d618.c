...
if (*(gUI2Editor + 0x704c) s>= 1)
    ...
    do
        ...
        float v1_1 = v0_4.d f+ UI2PropDynamic<float>::Eval(v0_1.d).d
        float v3_1 = v15.d f+ (v0_4.d f+ v1_1) f* v13.d
        float v4_1 = v0_4.d f+ v3_1
        float v2_2 = v0_6.d f+ v14.d
        float v0_10 = v0_6.d f+ UI2PropDynamic<float>::Eval(v0_1.d) f+ v14.d
        v1_1 = v1_1 + v3_1 - v4_1
        ...
        v0_10 = v3_1 + float.s(sx.d(vcvts_s32_f32(v0_10 + v2_2)))
        float var_90 = v4_1
        float var_8c_1 = v3_1
