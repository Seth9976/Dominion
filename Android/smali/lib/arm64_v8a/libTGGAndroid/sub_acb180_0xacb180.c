...
*result = &_vtable_for_std::__ndk1::__function::__func<Shadow_OnShuffle()::$_10, std::__ndk1::allocator<Shadow_OnShuffle()::$_10>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
return result
