// 函数: _Z12NumVillagersR7DomGame9PlayerWho
// 地址: 0xbc1620
...
if (x10.d s< 1)
    ...
    if (x10.d u>= 3)
        ...
        do
            ...
            int32_t x2 = x4_4 & (entry_x19.d != 0xe00 ? 1 : 0)
            entry_x19 = zx.q(x15_5 == x9 ? 1 : 0)
            entry_x16 =
                (entry_x19.d & (entry_x16 != arg2 ? 1 : 0)) | (x3_4 & (x5_3 != 0xe00 ? 1 : 0))
    ...
    label_bc17a8:
        ...
        do
            if (*(x12_3 + 8) == x9 && *(x12_3 + 4) == arg2 && *x12_3 == 0xe00)
                x8 += *(x12_3 + 0x14)
