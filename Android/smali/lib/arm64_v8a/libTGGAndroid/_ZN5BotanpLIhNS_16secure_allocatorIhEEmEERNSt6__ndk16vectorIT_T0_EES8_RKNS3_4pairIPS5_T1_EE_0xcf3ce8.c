// 函数: _ZN5BotanpLIhNS_16secure_allocatorIhEEmEERNSt6__ndk16vectorIT_T0_EES8_RKNS3_4pairIPS5_T1_EE
// 地址: 0xcf3ce8
...
*(arg2 + 8)
std::__ndk1::vector<uint8_t, Botan::secure_allocator<uint8_t> >::insert<uint8_t*>(arg1, x21, *arg2)
return arg1
