...
int64_t result
char* x1_4
result, x1_4 = RandomizerDeck_DrawOneFilter(gCampaignSetup + 0x19b8, &var_60, 0)
int32_t x19_1 = result.d

if (&var_60 == var_40_1)
    result, x1_4 = (*var_40_1)->vFunc_4(var_40_1)
else if (var_40_1 != 0)
    result, x1_4 = (*var_40_1)->j_operator delete(var_40_1)

if (x19_1 == 0)
    return result

CampaignKingdomAdd(zx.q(x19_1), x1_4, 0, 0)
return CampaignAddExtra(zx.q(var_24), zx.q(x19_1), 0xffffffff, 0, 0)
