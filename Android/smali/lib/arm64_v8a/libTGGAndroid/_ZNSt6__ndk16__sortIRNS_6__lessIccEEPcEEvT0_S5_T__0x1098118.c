// 函数: _ZNSt6__ndk16__sortIRNS_6__lessIccEEPcEEvT0_S5_T_
// 地址: 0x1098118
    ...
    label_109814c:
        ...
        if (x8_1 u<= 5)
            switch (x8_1)
                ...
                case 5
                    SystemHintOp_BTI()
                    return sub_1098664(x19, &x19[1], &x19[2], &x19[3], x20 - 1) __tailcall
        else if (x8_1 s<= 0x1e)
            ...
            if (x8_1 s< 0x3e8)
                ...
                arg1 = sub_1098664(x19, &x19[x8_2], x23_2, x23_2 + x8_2, x20 - 1)
