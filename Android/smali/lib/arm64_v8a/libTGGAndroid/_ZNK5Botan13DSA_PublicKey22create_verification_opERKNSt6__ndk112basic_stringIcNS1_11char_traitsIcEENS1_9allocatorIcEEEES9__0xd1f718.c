// 函数: _ZNK5Botan13DSA_PublicKey22create_verification_opERKNSt6__ndk112basic_stringIcNS1_11char_traitsIcEENS1_9allocatorIcEEEES9_
// 地址: 0xd1f718
...
struct Botan::PK_Ops::Verification_with_EMSA::Botan::(anonymous namespace)::DSA_Verification_Operation::VTable
    ** x0_2 = operator new(0x48)
int64_t result = Botan::PK_Ops::Verification_with_EMSA::Verification_with_EMSA(x0_2)
*x0_2 = &_vtable_for_Botan::(anonymous namespace)::DSA_Verification_Operation{for `Botan::PK_Ops::Verification_with_EMSA'}
void* x8_2 = *arg1
