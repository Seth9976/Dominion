// 函数: _ZNK5Botan14Cert_Extension30CRL_Issuing_Distribution_Point12encode_innerEv
// 地址: 0xeb718c
...
int64_t var_30 = x0_1
int128_t var_40 = data_71c500
__builtin_strncpy(x0_1, "CRL_Issuing_Distribution_Point encoding", 0x28)
