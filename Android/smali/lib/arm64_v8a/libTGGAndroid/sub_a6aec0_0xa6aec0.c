...
*result = &_vtable_for_std::__ndk1::__function::__func<Counterfeit()::$_20, std::__ndk1::allocator<Counterfeit()::$_20>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
return result
