// 函数: _ZN5Botan4Pipe14prepend_filterEPNS_6FilterE
// 地址: 0xd7c654
...
if (*(x8 + 0x28) == neg.q(*(x8 + 0x30)))
    return Botan::Pipe::do_prepend(arg1) __tailcall
...
int64_t var_30 = x0_2
v0_1 = data_71b3f0
__builtin_strncpy(x0_2, "Cannot call Pipe::prepend_filter after start_msg", 0x31)
