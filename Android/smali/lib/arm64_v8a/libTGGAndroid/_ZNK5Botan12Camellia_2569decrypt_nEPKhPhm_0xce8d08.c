// 函数: _ZNK5Botan12Camellia_2569decrypt_nEPKhPhm
// 地址: 0xce8d08
...
if (*(arg1 + 8) == *(arg1 + 0x10))
    uint8_t* x0
    uint64_t x1_1
    x0, x1_1 = Botan::SymmetricAlgorithm::throw_key_not_set_error()
    return Botan::Camellia_128::key_schedule(x0, x1_1) __tailcall
