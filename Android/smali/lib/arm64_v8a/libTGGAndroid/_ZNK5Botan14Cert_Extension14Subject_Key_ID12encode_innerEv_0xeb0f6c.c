// 函数: _ZNK5Botan14Cert_Extension14Subject_Key_ID12encode_innerEv
// 地址: 0xeb0f6c
...
void* entry_x0
*(entry_x0 + 0x10)
Botan::DER_Encoder::add_object(&var_d0, 4, nullptr, *(entry_x0 + 8))
void* x22 = var_90:8.q
...
if (x0_5 != 0)
    var_a0 = x0_5
    Botan::deallocate_memory(x0_5, var_90.q - x0_5, 1)
