// 函数: _ZNSt6__ndk16__sortIRPFbPK6DomGfxS3_EPPS1_EEvT0_S9_T_
// 地址: 0xbb4330
...
while (true)
    ...
    label_bb4364:
        ...
        uint64_t x0_48
        DomGfx* x1_32
        bool (* x8_47)(DomGfx const*, DomGfx const*)
        DomGfx* x9_18
        ...
        if (x8_1 u<= 5)
            switch (x8_1)
                ...
                case 4
                    return std::__ndk1::__sort4<bool (*&)(DomGfx const*, DomGfx const*), DomGfx**>(
                        x19, &x19[1], &x19[2], x21 - 8, arg3) __tailcall
                case 5
                    std::__ndk1::__sort4<bool (*&)(DomGfx const*, DomGfx const*), DomGfx**>(x19, 
            ...
            if (x9_1 s<= 0xf7)
                return std::__ndk1::__insertion_sort_3<bool (*&)(DomGfx const*, DomGfx const*), DomGfx**>(
            ...
            if (x9_1 s< 0x1f39)
                ...
                void* x25_1 = x19 + x8_4
                DomGfx** x26_1 = x23_2 + x8_4
                x24_1 = std::__ndk1::__sort4<bool (*&)(DomGfx const*, DomGfx const*), DomGfx**>(
            ...
            label_bb4684:
                ...
                if (x25_2 - x19 s>= x21 - x25_2)
                    std::__ndk1::__sort<bool (*&)(DomGfx const*, DomGfx const*), DomGfx**>(
                        &x25_2[1], x21, arg3)
                    x21 = x25_2
                    break
                
                std::__ndk1::__sort<bool (*&)(DomGfx const*, DomGfx const*), DomGfx**>(x19, x25_2, 
                    arg3)
                x23_1 = &x25_2[1]
                continue
            else
                int32_t x0_29 = std::__ndk1::__insertion_sort_incomplete<bool (*&)(DomGfx const*, DomGfx const*), DomGfx**>(
                    x19, x25_2, arg3)
                x23_1 = &x25_2[1]
                
                if ((std::__ndk1::__insertion_sort_incomplete<bool (*&)(DomGfx const*, DomGfx const*), DomGfx**>(
