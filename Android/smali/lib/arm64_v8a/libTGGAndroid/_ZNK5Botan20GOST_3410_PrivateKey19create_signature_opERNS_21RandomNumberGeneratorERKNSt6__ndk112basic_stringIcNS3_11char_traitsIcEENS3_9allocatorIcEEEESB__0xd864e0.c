// 函数: _ZNK5Botan20GOST_3410_PrivateKey19create_signature_opERNS_21RandomNumberGeneratorERKNSt6__ndk112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEESB_
// 地址: 0xd864e0
...
struct Botan::PK_Ops::Signature_with_EMSA::Botan::(anonymous namespace)::GOST_3410_Signature_Operation::VTable
    ** x19_1 = x0_2
Botan::PK_Ops::Signature_with_EMSA::Signature_with_EMSA(x0_2)
*x19_1 = &_vtable_for_Botan::(anonymous namespace)::GOST_3410_Signature_Operation{for `Botan::PK_Ops::Signature_with_EMSA'}
