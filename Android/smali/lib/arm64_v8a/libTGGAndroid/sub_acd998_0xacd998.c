...
*result = &_vtable_for_std::__ndk1::__function::__func<PirateShip_Attack()::$_11::operator()() const::'lambda'(CardID), std::__ndk1::allocator<PirateShip_Attack()::$_11::operator()() const::'lambda'(CardID)>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
return result
