...
if (arg1[1] - x8_1 u< 2 || zx.d(*x8_1) != 0x54)
    ...
    if (zx.d(x8_1[1]) == 0x79)
        ...
        *(x20_2 + 0x10) = x21_1
        var_c0 = x20_2
        sub_10f52c8(*(arg1[0x54] - 8), &var_c0)
        x21_2 = arg1[0x266]
    ...
    label_10f4d48:
        ...
        *(x21_5 + x8_15 + 0x20) = x20_5
        ...
        sub_10ef86c(&arg1[0x53], &var_c8)
        int64_t i_2
        char* x8_19
        
        while (true)
            i_2 = __strlen_chk(&data_79a4e4, 2)
            x8_19 = *arg1
        ...
        label_10f4f90:
            int128_t** x0_12 = sub_10f4c28(arg1)
            var_c8 = x0_12
            ...
            sub_10ede98(&arg1[2], &var_c8)
        
        if (i_2 != 0)
            int64_t i_1 = i_2
            char* x10_4 = x8_19
            void* const x11_2 = &data_79a4e4
            int64_t i
        ...
        *arg1 = &x8_19[i_2]
        void* x0_15
        int64_t x1_7
        x0_15, x1_7 = sub_10f7304(arg1, x1_6, x2_1)
