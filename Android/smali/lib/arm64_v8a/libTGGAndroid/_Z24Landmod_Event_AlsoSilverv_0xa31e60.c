// 函数: _Z24Landmod_Event_AlsoSilverv
// 地址: 0xa31e60
...
int32_t var_cd8 = 0
int32_t var_ce0 = 0
NotifyEffect(*(x0 + 8), 0x1b, 0xffffffff, 0x14, 0x2b, x5, 0, 0)
...
if (CardsLandscapeTops(*(DomGetContext() + 8), &var_cb8) == 0)
    ...
    XNoReturn()
    return Landmod_Event_Motivational() __tailcall
...
var_cb8.d = 0
Forever(8, sub_a568c4, sub_a568dc, 0x10000, &var_cb8, 0x65)
