// 函数: _ZNSt6__ndk127__insertion_sort_incompleteIRPFb9UI2HandleS1_EPS1_EEbT0_S6_T_
// 地址: 0x10487f4
...
if (x8_1 u> 5)
    ...
    void* __offset(UI2Handle, 0xc) x23_2 = arg1 + 8
    int32_t x0_9
    int32_t x9_4
    int128_t v0_1
    ...
    void* __offset(UI2Handle, 0xc) x8_25 = arg1 + 0xc
    char x8_30
    ...
    switch (x8_1)
        ...
        case 4
            std::__ndk1::__sort4<bool (*&)(UI2Handle, UI2Handle), UI2Handle*>(arg1, arg1 + 4, 
                arg1 + 8, arg2 - 4, arg3)
            x8_2 = 1
        case 5
            std::__ndk1::__sort4<bool (*&)(UI2Handle, UI2Handle), UI2Handle*>(arg1, arg1 + 4, 
