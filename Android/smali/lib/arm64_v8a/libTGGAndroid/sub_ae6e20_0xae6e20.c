...
*result = &_vtable_for_std::__ndk1::__function::__func<GetPlayableFromHand(DomCardEnum)::$_25, std::__ndk1::allocator<GetPlayableFromHand(DomCardEnum)::$_25>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
result[1].d = *(arg1 + 8)
return result
