// 函数: _ZN5Botan11BER_Decoder15decode_optionalINS_19AlgorithmIdentifierEEERS0_RT_NS_8ASN1_TagES6_RKS4_
// 地址: 0xf07bb0
    ...
    if (x20 != entry_x4)
        *(entry_x4 + 0x18)
        std::__ndk1::vector<uint32_t, std::__ndk1::allocator<uint32_t> >::assign<uint32_t*>(
            &x20[2], *(entry_x4 + 0x10))
        *(entry_x4 + 0x30)
        std::__ndk1::vector<uint8_t, std::__ndk1::allocator<uint8_t> >::assign<uint8_t*>(&x20[5], 
            *(entry_x4 + 0x28))
