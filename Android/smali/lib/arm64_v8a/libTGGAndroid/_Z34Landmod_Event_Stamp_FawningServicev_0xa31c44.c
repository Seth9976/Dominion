// 函数: _Z34Landmod_Event_Stamp_FawningServicev
// 地址: 0xa31c44
...
int32_t var_cd8 = 0
int32_t var_ce0 = 0
NotifyEffect(*(x0 + 8), 0x1b, 0xffffffff, 0x14, 0x27, x5, 0, 0)
...
if (CardsLandscapeTops(*(DomGetContext() + 8), &var_cb8) == 0)
    ...
    XNoReturn()
    return Landmod_Event_Cost2DebtLess() __tailcall
...
var_cb8.d = 0
Forever(6, sub_a56884, sub_a568bc, 0x10000, &var_cb8, 0x60)
