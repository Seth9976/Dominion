...
*result = &_vtable_for_std::__ndk1::__function::__func<CardMod_StartTrashAPile()::$_11, std::__ndk1::allocator<CardMod_StartTrashAPile()::$_11>, bool (DomCardEnum)>{for `std::__ndk1::__function::__base<bool (DomCardEnum)>'}
return result
