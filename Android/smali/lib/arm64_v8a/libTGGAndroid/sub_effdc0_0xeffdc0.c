...
Botan::EC_Group::blinded_var_point_multiply(arg1 + 0x138, &var_c8, 
    Botan::EC_PrivateKey::private_value(), *(arg1 + 0x1d8))
char var_198
void* var_188
...
if ((Botan::PointGFp::on_the_curve() & 1) != 0)
    ...
    if (x0_11 != 0)
        ...
        Botan::deallocate_memory(x0_11, (var_188 - x0_11) s>> 2, 4)
...
int64_t var_160 = x0_14
int128_t var_170 = data_71b5b0
__builtin_strncpy(x0_14, "ECDH agreed value was not on the curve", 0x27)
