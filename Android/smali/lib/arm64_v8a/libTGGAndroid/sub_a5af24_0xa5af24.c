...
*result = &_vtable_for_std::__ndk1::__function::__func<Theme_DeckChangesA_ReplaceCard()::$_122, std::__ndk1::allocator<Theme_DeckChangesA_ReplaceCard()::$_122>, bool (DomCardEnum)>{for `std::__ndk1::__function::__base<bool (DomCardEnum)>'}
return result
