// 函数: _ZNSt6__ndk117moneypunct_bynameIwLb1EE4initEPKc
// 地址: 0x10db8fc
...
std::__ndk1::basic_string<wchar_t, std::__ndk1::char_traits<wchar_t>, std::__ndk1::allocator<wchar_t> >::basic_string(
    &pwc)
sub_10db370(&arg1[0x7c], &pwc, 1, x21[0xb].b, *(x21 + 0x59), *(x21 + 0x5c))
sub_10db370(&arg1[0x80], &arg1[0x30], 1, *(x21 + 0x5a), *(x21 + 0x5b), *(x21 + 0x5d))
void* var_1f8
