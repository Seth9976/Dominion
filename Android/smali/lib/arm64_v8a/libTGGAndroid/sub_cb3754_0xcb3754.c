...
x1_13 = temp0_1 == 0 ? arg21 : arg41

std::__ndk1::__put_character_sequence<char, std::__ndk1::char_traits<char> >(arg27, x1_13, x2_8)
label_cb2920:

if ((zx.d(arg_170.b) & 1) != 0)
label_cb2928:
    operator delete(arg41)
...
while (true)
    ...
    while (true)
        ...
        if (arg49 != 0)
            void* arg_298 = arg49
            Botan::deallocate_memory(arg49, arg50 - arg49, 1)
        ...
        if (&arg_280 == arg50)
            ...
            (*arg50)->j_operator delete()
        
        Botan::DER_Encoder::add_object(&arg_170, zx.q(arg5), zx.q(arg7), arg38)
        void* x28_1 = arg46.q
        ...
        if (arg44 != 0)
            arg_1a8 = arg44
            Botan::deallocate_memory(arg44, arg45 - arg44, 1)
        ...
        if ((arg7 & 0x20) != 0)
            Botan::BER_Decoder::BER_Decoder(&arg_170, arg38)
            x20_1 = x19_1
            x27 = x21_1
            ...
            if ((arg7 & 0xc0) == 0)
                ...
                if (arg5 == 6)
                    ...
                    label_cb2eb0:
                        x0_72 = arg_178
                        arg_170 = _vtable_for_Botan::OID + 0x10
                ...
                label_cb2eec:
                    ...
                    if (x0_95 == 0)
                        ...
                        arg_178 = x0_95
                        Botan::deallocate_memory(x0_95, (arg41 - x0_95) s>> 2, 4)
                        continue
