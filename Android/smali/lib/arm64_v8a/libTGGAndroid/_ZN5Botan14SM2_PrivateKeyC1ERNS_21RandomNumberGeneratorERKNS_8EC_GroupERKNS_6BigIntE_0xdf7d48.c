// 函数: _ZN5Botan14SM2_PrivateKeyC1ERNS_21RandomNumberGeneratorERKNS_8EC_GroupERKNS_6BigIntE
// 地址: 0xdf7d48
...
Botan::EC_PrivateKey::EC_PrivateKey(arg1 + 8, _VTT_for_Botan::SM2_PrivateKey + 0x20, arg2, arg3.b)
*(arg1 + 0x40) = 0
*(arg1 + 0x48) = 0
