// 函数: _ZNSt6__ndk118__insertion_sort_3IRPFbiiEPiEEvT0_S5_T_
// 地址: 0xc9d3e0
// 来自: E:\torrent\Cursor\Dominion_1.0.3315\split_config.arm64_v8a\lib\arm64-v8a\libTGGAndroid.so

int32_t x0_1 = (*arg3)(zx.q(arg1[1]), zx.q(*arg1))
void* x23_1 = &arg1[2]
int32_t result
int128_t v0
result, v0 = (*arg3)(zx.q(*x23_1), zx.q(arg1[1]))

if ((x0_1 & 1) != 0)
    int32_t x1_2 = *arg1
    
    if ((result & 1) == 0)
        uint64_t x0_4 = zx.q(arg1[2])
        *arg1 = arg1[1]
        arg1[1] = x1_2
        int128_t v0_3
