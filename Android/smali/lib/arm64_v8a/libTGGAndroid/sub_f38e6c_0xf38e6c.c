...
**(arg1 + 8) = 0
Botan::Private_Key* x0 = operator new(8)
...
*(x24 + x0_4) = 0
int16_t var_70 = 0
Botan::PK_Key_Agreement::PK_Key_Agreement(x0, x0_2, &data_23ecbc0, &var_58)
...
x0_11[2] = x0
x0_11[1].d = 0x2939cab1
*x0_11 = _vtable_for_botan_pk_op_ka_struct + 0x10
**(arg1 + 8) = x0_11
return 0
