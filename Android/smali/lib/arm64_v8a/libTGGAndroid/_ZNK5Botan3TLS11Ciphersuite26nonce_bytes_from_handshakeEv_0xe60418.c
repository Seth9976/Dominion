// 函数: _ZNK5Botan3TLS11Ciphersuite26nonce_bytes_from_handshakeEv
// 地址: 0xe60418
...
if (x8 != 0)
    ...
    v2 = data_71a790
    __builtin_strncpy(x0_10, "In Ciphersuite::nonce_bytes_from_handshake invalid enum value", 0x3e)
    var_50 = v2
