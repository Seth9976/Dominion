// 函数: _ZNK5Botan14Cert_Extension17Unknown_Extension4copyEv
// 地址: 0xee7e6c
// 来自: E:\torrent\Cursor\Dominion_1.0.3315\split_config.arm64_v8a\lib\arm64-v8a\libTGGAndroid.so

void** result = operator new(0x48)
void* entry_x0
char x24 = *(entry_x0 + 0x28)
result[3] = 0
result[4] = 0
*result = _vtable_for_Botan::Cert_Extension::Unknown_Extension + 0x10
