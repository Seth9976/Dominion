...
*result = &_vtable_for_std::__ndk1::__function::__func<Farmhands_OnGain()::$_11, std::__ndk1::allocator<Farmhands_OnGain()::$_11>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
return result
