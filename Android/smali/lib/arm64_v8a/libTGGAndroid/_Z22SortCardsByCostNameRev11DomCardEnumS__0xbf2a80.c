// 函数: _Z22SortCardsByCostNameRev11DomCardEnumS_
// 地址: 0xbf2a80
...
label_bf3080:
    ...
    x9_25 = *(*(x8_19 + 8) + 0xc4)
    int32_t x8_28 = x9_25 & 0xff
    cond:0 = x27_1 u> x8_28
    ...
    label_bf31a4:
        ...
        int32_t x12_49 = x9_25 u>> 0x10 & 1
        
        if (x10_1 u>= x12_49)
            if (x10_1 u> x12_49)
                return 1
            
            int32_t x8_36 = x24_1 s>> 0x18
            int32_t x11_17 = x9_25 s>> 0x18
            int32_t x13_1 = x24_1 & 0x1a0000
            int32_t x9_27 = x9_25 & 0x1a0000
            
            if (x8_36 s>= x11_17 && (x8_36 s> x11_17 || (x13_1 != 0 && x9_27 == 0)))
                return 1
            
            if (x10_1 u> x12_49)
                return zx.q(
                    strcmp(DomDefNameSort(x20_1, 0, nullptr), DomDefNameSort(x22_3, 0, nullptr))
                    s> 0 ? 1 : 0)
            
            if (x8_36 s>= x11_17 && (x13_1 != 0 || x8_36 s> x11_17 || x9_27 == 0))
                return zx.q(
                    strcmp(DomDefNameSort(x20_1, 0, nullptr), DomDefNameSort(x22_3, 0, nullptr))
                    s> 0 ? 1 : 0)
else
label_bf3004:
    ...
    *(x0_24 + 8) = x8_34
    x9_25 = *(x8_34 + 0xc4)
    int32_t x8_35 = x9_25 & 0xff
    cond:0 = x27_1 u> x8_35
