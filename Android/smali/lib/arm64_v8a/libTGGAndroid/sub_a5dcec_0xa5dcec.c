...
*result = &_vtable_for_std::__ndk1::__function::__func<YoungWitch()::$_3::operator()() const::'lambda'(CardID), std::__ndk1::allocator<YoungWitch()::$_3::operator()() const::'lambda'(CardID)>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
return result
