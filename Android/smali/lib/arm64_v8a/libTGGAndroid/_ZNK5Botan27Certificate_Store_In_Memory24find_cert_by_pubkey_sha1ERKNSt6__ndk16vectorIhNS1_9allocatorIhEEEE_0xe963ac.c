// 函数: _ZNK5Botan27Certificate_Store_In_Memory24find_cert_by_pubkey_sha1ERKNSt6__ndk16vectorIhNS1_9allocatorIhEEEE
// 地址: 0xe963ac
...
if (entry_x1[1] - *entry_x1 != 0x14)
    ...
    __builtin_strncpy(x0_10, "Certificate_Store_In_Memory::find_cert_by_pubkey_sha1 invalid hash", 
        0x43)
    var_50 = v0
    ...
    *entry_x8 = 0
    ...
    while (true)
        *x22
        ...
        int64_t x1_1 = *(x0_4 + 0x178)
        (*(*result + 0x18))(result, x1_1, *(x0_4 + 0x180) - x1_1)
