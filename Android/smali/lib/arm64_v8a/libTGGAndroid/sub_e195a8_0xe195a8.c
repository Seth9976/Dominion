...
int64_t* x0_3 = __cxa_begin_catch(arg1)
void** x0_4 = __cxa_allocate_exception(0x20)
char* x0_6 = (*(*x0_3 + 0x10))(x0_3)
size_t x0_7 = strlen(x0_6)
...
if (x0_7 u>= 0x17)
    uint64_t x23_1 = (x0_7 + 0x10) & 0xfffffffffffffff0
    int64_t x0_9 = operator new(x23_1)
    x22 = x0_9
    size_t arg_48 = x0_7
    int64_t arg_50 = x0_9
    arg_40 = x23_1 | 1
    memcpy(x22, x0_6, x0_7)
else
    x22 = &arg_40 | 1
    arg_40.b = (x0_7.d << 1).b
...
int128_t* x0_12
int128_t v0
x0_12, v0 = std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >::insert(
    &arg_40, nullptr)
arg4 = x0_12[1].q
arg3.o = *x0_12
