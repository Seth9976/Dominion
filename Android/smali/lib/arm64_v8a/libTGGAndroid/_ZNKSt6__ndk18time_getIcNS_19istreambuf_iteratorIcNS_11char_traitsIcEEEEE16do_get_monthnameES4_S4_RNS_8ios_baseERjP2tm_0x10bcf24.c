// 函数: _ZNKSt6__ndk18time_getIcNS_19istreambuf_iteratorIcNS_11char_traitsIcEEEEE16do_get_monthnameES4_S4_RNS_8ios_baseERjP2tm
// 地址: 0x10bcf24
...
if (x9_1 u< (*(var_90 + 0x18) - x8_2) s>> 3)
    ...
    if (x23_1 != 0)
        ...
        void* x8_5 = sub_10b0e88(&result, arg3, x0_4, &x0_4[0x240], x23_1, arg5, 0) - x0_4
