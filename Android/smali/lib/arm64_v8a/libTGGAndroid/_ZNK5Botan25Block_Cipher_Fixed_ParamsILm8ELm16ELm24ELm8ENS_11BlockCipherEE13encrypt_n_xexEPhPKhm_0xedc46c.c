// 函数: _ZNK5Botan25Block_Cipher_Fixed_ParamsILm8ELm16ELm24ELm8ENS_11BlockCipherEE13encrypt_n_xexEPhPKhm
// 地址: 0xedc46c
// 来自: E:\torrent\Cursor\Dominion_1.0.3315\split_config.arm64_v8a\lib\arm64-v8a\libTGGAndroid.so

int64_t entry_x3
int64_t x23 = entry_x3 << 3
...
if (x23 != x22)
    ...
    if ((entry_x3 & 3) != 0 && (x9_3 u>= arg3 + x23 || x10_6 u>= &arg2[x23]))
        int64_t i_9 = x23 & 0x18
        int64_t i_2
...
int128_t v6
int128_t v7
result, v0, v1, v2, v3, v4, v5, v6, v7 = (*(*arg1 + 0x48))(arg1, arg2, arg2, entry_x3, entry_v0, 
...
if (x23 != x22)
    ...
    if ((entry_x3 & 3) != 0 && (x9_7 u>= arg3 + x23 || x10_13 u>= &arg2[x23]))
        int64_t i_11 = x23 & 0x18
        int64_t i_6
