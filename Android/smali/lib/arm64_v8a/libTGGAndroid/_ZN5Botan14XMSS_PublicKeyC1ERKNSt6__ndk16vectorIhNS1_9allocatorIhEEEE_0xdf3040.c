// 函数: _ZN5Botan14XMSS_PublicKeyC1ERKNSt6__ndk16vectorIhNS1_9allocatorIhEEEE
// 地址: 0xdf3040
...
if (x22 != 0)
    ...
    int64_t x8_4 = *(arg1 + 0x100)
    *(arg1 + 0xf0) = x22_1
    *(arg1 + 0xf8) = result_1
    *(arg1 + 0x100) = x24_1
    
    if (x21_1 != 0)
        result = Botan::deallocate_memory(x21_1, x8_4 - x21_1, 1)
...
int64_t x8_5 = *(arg1 + 0x108)
int64_t x9_3 = *(arg1 + 0x118)
*(arg1 + 0x110) = x8_5
...
int64_t x8_7 = *(arg1 + 0x118)
*(arg1 + 0x108) = x24_2
*(arg1 + 0x110) = x0_9
*(arg1 + 0x118) = x0_9 + i_2

if (x22_2 != 0)
    Botan::deallocate_memory(x22_2, x8_7 - x22_2, 1)
