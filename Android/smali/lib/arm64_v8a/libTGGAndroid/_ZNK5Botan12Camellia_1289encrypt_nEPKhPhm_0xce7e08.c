// 函数: _ZNK5Botan12Camellia_1289encrypt_nEPKhPhm
// 地址: 0xce7e08
...
if (x2 != 0)
    ...
    *(sp - 0x88) = x4 - 1
    ...
    do
        ...
        int64_t* x19_7 = **(sp - 0x68)
        int64_t x24_10 = x19_7[1]
        int64_t* x21_12 = *(sp - 0x80) + x2_13
        uint64_t x21_13 = x21_12[1]
        int64_t x25_11 = x19_7[2]
        int64_t x26_6 = x19_7[3]
        void* x22_11 = &x19_7[4]
        int64_t x20_3 = *x19_7 ^ _byteswap(*x21_12)
        int64_t x19_9 = x24_10 ^ _byteswap(x21_13)
        int64_t x21_15 = x25_11 ^ x20_3
        uint32_t x27_5 = (x21_15 u>> 0x20).d
        uint32_t lr_4 = (x21_15 u>> 8).d
        uint32_t x25_13 = zx.d(*(&data_84a680 + (x21_15 u>> 0x28 & 0xff)))
        uint32_t x24_12 = zx.d(*(&data_84a680 + (x21_15 u>> 0x30 & 0xff)))
        uint32_t x28_4 = zx.d(*(&data_84a680 + (x21_15 u>> 0x18 & 0xff)))
        uint32_t fp_3 = zx.d(*(&data_84a680 + (x21_15 u>> 0x10 & 0xff)))
        uint32_t x21_17 = zx.d(*(&data_84a680 + (x21_15 & 0xff)))
        uint32_t x23_9 = zx.d(*(&data_84a680 + (x21_15 u>> 0x38)))
        ...
        int32_t x24_13 = x21_17 ^ lr_6
        int32_t x3_12 = (0xffff807f & fp_3 u>> 1) | (0xff & fp_3) << 7
        char x25_14 = x27_7 ^ x23_9.b
        char x27_8 = lr_6.b ^ x27_7
        char x1_15 = x7_3 ^ x10_33.b
        int32_t x28_5 = x9_10 ^ x3_12
        char x9_11 = x9_10.b ^ x1_15
        int64_t x9_16 = (-0xff00000001 & ((-0xff000000000001
            & (zx.q(x9_11) ^ zx.q(x23_9.b) ^ zx.q(x3_12.b)))
            | ((zx.q(x9_11) ^ zx.q(x25_14) ^ zx.q(x21_17.b)) & 0xff) << 0x30))
            | ((zx.q(x9_11) ^ zx.q(x27_8) ^ zx.q(x3_12.b)) & 0xff) << 0x20
        int64_t x9_19 = (-0xff000001 & ((-0xff01 & ((-0xff0001 & x9_16)
            | (zx.q(x9_10.b) ^ zx.q(x27_8) ^ zx.q(x7_3) ^ zx.q(x21_17.b)) << 0x10))
            | (zx.q(x3_12.b) ^ zx.q(x1_15) ^ zx.q(lr_6.b) ^ zx.q(x21_17.b)) << 8))
            | (zx.q(x21_17.b) ^ zx.q(x25_14) ^ zx.q(x28_5.b)) << 0x18
        uint64_t x19 = x19_9 ^ (x9_19
            | (zx.q(x24_13.b) ^ zx.q(x25_14) ^ zx.q(x7_3) ^ zx.q(x3_12.b)) << 0x28
            | (zx.q(x24_13) ^ zx.q(x23_9) ^ zx.q(x10_33) ^ zx.q(x28_5)) << 0x38)
        int64_t x9_22 = x19 ^ x26_6
        uint32_t x3_14 = (x9_22 u>> 0x20).d
        uint32_t x23_12 = (x9_22 u>> 8).d
        uint32_t x0_15 = zx.d(*(&data_84a680 + (x9_22 u>> 0x30 & 0xff)))
        uint32_t x1_21 = zx.d(*(&data_84a680 + (x9_22 u>> 0x28 & 0xff)))
        uint32_t x7_8 = zx.d(*(&data_84a680 + (x9_22 u>> 0x18 & 0xff)))
        uint32_t x21_20 = zx.d(*(&data_84a680 + (x9_22 u>> 0x10 & 0xff)))
        uint32_t x3_16 = zx.d(
        ...
        int32_t x27_11 = (0xffff807f & x21_20 u>> 1) | (0xff & x21_20) << 7
        char x7_9 = x25_20.b ^ x24_20
        char x28_6 = x26_8 ^ x3_16.b
        int32_t x0_16 = x9_24 ^ x25_20
        char x1_22 = x24_20 ^ x10_37.b
        int32_t x21_21 = x23_14 ^ x27_11
        char x23_15 = x23_14.b ^ x28_6
        int64_t x10_43 = (-0xff0001 & ((-0xff00000001 & ((-0xff000000000001
            & (zx.q(x23_15) ^ zx.q(x10_37.b) ^ zx.q(x27_11.b)))
            | (zx.q(x23_15) ^ zx.q(x1_22) ^ zx.q(x9_24.b)) << 0x30))
            | (zx.q(x23_15) ^ zx.q(x7_9) ^ zx.q(x27_11.b)) << 0x20))
            | (zx.q(x23_14.b) ^ zx.q(x7_9) ^ zx.q(x26_8) ^ zx.q(x9_24.b)) << 0x10
        int64_t x9_27 = (-0xff000001 & ((-0xff01 & x10_43)
            | (zx.q(x27_11.b) ^ zx.q(x28_6) ^ zx.q(x25_20.b) ^ zx.q(x9_24.b)) << 8))
            | ((zx.q(x9_24.b) ^ zx.q(x1_22) ^ zx.q(x21_21.b)) & 0xff) << 0x18
            | (zx.q(x0_16.b) ^ zx.q(x1_22) ^ zx.q(x26_8) ^ zx.q(x27_11.b)) << 0x28
        uint64_t x20 =
            (x9_27 | (zx.q(x0_16) ^ zx.q(x10_37) ^ zx.q(x3_16) ^ zx.q(x21_21)) << 0x38) ^ x20_3
        void* x21
        ...
        if (*(sp - 0x88) == 1)
            ...
            do
                if (x23_17 == neg.q(x25_22 u/ 3 * 3))
                    ...
                    int32_t x20_4 = x20.d ^ ror.d(*(x22_11 + 4) & x0_33, 0x1f)
                    int64_t x9_41 = *(x22_11 + 8)
                    int32_t x10_60 = (x20_4 | *x22_11) ^ x0_33
                    x22_11 += 0x10
                    int32_t x9_43 = (x9_41.d | x19.d) ^ (x19 u>> 0x20).d
                    x20 = zx.q(x20_4) | zx.q(x10_60) << 0x20
                    x19 = (zx.q(x19.d) ^ zx.q(ror.d(x9_43 & (x9_41 u>> 0x20).d, 0x1f)))
                        | zx.q(x9_43) << 0x20
                
                x21 = x22_11 + 0x10
                x25_22 += 1
                i -= 1
                int64_t x9_30 = *x22_11 ^ x20
                int64_t x0_29 = *(&data_84a780 + (x9_30 u>> 0x35 & 0x7f8)) ^ x19
                ...
                x19 = x0_29 ^ *(&data_84d780 + ((x9_30 u>> 8 & 0xff) << 3))
                    ^ *(&data_84df80 + ((x9_30 & 0xff) << 3))
                int64_t x9_33 = x19 ^ *(x22_11 + 8)
                int64_t x10_56 = *(&data_84a780 + (x9_33 u>> 0x35 & 0x7f8)) ^ x20
                ...
                x20 = x10_56 ^ *(&data_84d780 + ((x9_33 u>> 8 & 0xff) << 3))
        ...
        uint32_t x10_4 = zx.d(*(&data_84a680 + (x0_2 u>> 0x38)))
        uint32_t x3_3 = zx.d(
        ...
        int64_t x10_10 = (-0xff0001 & ((-0xff00000001 & ((-0xff000000000001
            & (zx.q(x24_3) ^ zx.q(x10_4.b) ^ zx.q(x28_1.b)))
        ...
        int64_t x10_13 = (-0xff000001 &
            ((-0xff01 & x10_10) | (zx.q(x28_1.b) ^ zx.q(fp) ^ zx.q(x26_3.b) ^ zx.q(x0_4.b)) << 8))
            | ((zx.q(x0_4.b) ^ zx.q(x2_3) ^ zx.q(x22_3.b)) & 0xff) << 0x18
            | (zx.q(x1_3.b) ^ zx.q(x2_3) ^ zx.q(x27_1) ^ zx.q(x28_1.b)) << 0x28
        int64_t x10_15 =
            (x10_13 | (zx.q(x1_3) ^ zx.q(x10_4) ^ zx.q(x3_3) ^ zx.q(x22_3)) << 0x38) ^ x19
        int64_t x0_7 = x10_15 ^ *(x21 + 8)
        ...
        uint32_t x10_17 = zx.d(*(&data_84a680 + (x0_7 u>> 0x38)))
        ...
        int64_t x10_23 = (-0xff0001 & ((-0xff00000001 & ((-0xff000000000001
            & (zx.q(x22_9) ^ zx.q(x10_17.b) ^ zx.q(x26_5.b)))
        ...
        uint64_t x10_28 = *(x21 + 0x18) ^ x20
            ^ (x10_26 | (zx.q(x1_10) ^ zx.q(x10_17) ^ zx.q(x3_8) ^ zx.q(x21_9)) << 0x38)
        uint64_t x9_4 = _byteswap(x10_15 ^ *(x21 + 0x10))
