...
int64_t x8 = *(arg1 + 8)
*result = &_vtable_for_std::__ndk1::__function::__func<RollCategoryCard(DomCardCategory, bool)::$_113, std::__ndk1::allocator<RollCategoryCard(DomCardCategory, bool)::$_113>, bool (DomCardEnum)>{for `std::__ndk1::__function::__base<bool (DomCardEnum)>'}
result[1] = x8
return result
