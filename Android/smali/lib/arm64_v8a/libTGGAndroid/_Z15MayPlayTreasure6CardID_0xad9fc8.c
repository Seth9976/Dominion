...
if (x0_5 != 0)
    int32_t x20_2 = var_cf0
    GameAssert((x0_5 == 1 ? 1 : 0).b)
    void* x0_7 = DomGetContext()
    DomGame* x21_1 = *(x0_7 + 8)
    int32_t x22_1 = *(x0_7 + 0x18)
    var_cf0.q = ToCardRef(x21_1, zx.q(x20_2))
    var_68.q = 0
    var_cf8.q = 0
    PlayCard(x21_1, zx.q(x22_1), &var_cf0, &var_68, &var_cf8, 0)
