...
*result = &_vtable_for_std::__ndk1::__function::__func<Theme_PileChangesB_SplitPileShuffle()::$_130, std::__ndk1::allocator<Theme_PileChangesB_SplitPileShuffle()::$_130>, bool (DomCardEnum)>{for `std::__ndk1::__function::__base<bool (DomCardEnum)>'}
return result
