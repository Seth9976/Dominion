...
int64_t x8 = *(arg1 + 8)
*result = &_vtable_for_std::__ndk1::__function::__func<CampaignForceAdd(DomCardType)::$_0, std::__ndk1::allocator<CampaignForceAdd(DomCardType)::$_0>, bool (DomCardEnum)>{for `std::__ndk1::__function::__base<bool (DomCardEnum)>'}
result[1] = x8
return result
