...
*result = &_vtable_for_std::__ndk1::__function::__func<Smugglers_Hint()::$_6, std::__ndk1::allocator<Smugglers_Hint()::$_6>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
return result
