// 函数: _ZNSt6__ndk127__insertion_sort_incompleteIRPFbRK11DomExpSetupRS1_EPS1_EEbT0_S9_T_
// 地址: 0xbb1ff8
...
if (x8_1 u> 5)
    void* __offset(DomExpSetup, 0x30) x22_2 = arg1 + 0x20
    ...
    void* __offset(DomExpSetup, 0x30) x8_17 = arg1 + 0x30
    char x8_20
    ...
    label_bb23c0:
        ...
        while (true)
            void* __offset(DomExpSetup, 0x30) x1_15 = x22_2
            x22_2 = x8_17
            int32_t x0_29
            int128_t v0_9
    ...
    x8_2 = 1
    void* __offset(DomExpSetup, 0x10) x22_1
    int128_t v0_7
    ...
    switch (x8_1)
        ...
        case 3
            ...
            if ((x0_3 & 1) == 0)
                ...
                *(arg2 - 0x10) = var_50
        case 4
            std::__ndk1::__sort4<bool (*&)(DomExpSetup const&, DomExpSetup&), DomExpSetup*>(arg1, 
                arg1 + 0x10, arg1 + 0x20, arg2 - 0x10, arg3)
            x8_2 = 1
        case 5
            x22_1 = arg1 + 0x10
            std::__ndk1::__sort4<bool (*&)(DomExpSetup const&, DomExpSetup&), DomExpSetup*>(arg1, 
                x22_1, arg1 + 0x20, arg1 + 0x30, arg3)
            int32_t x0_13
            int128_t v0_4
