// 函数: _ZNSt6__ndk16__sortIRPFbP6DomGfxS2_EPS2_EEvT0_S7_T_
// 地址: 0xbafcf0
    ...
    label_bafd24:
        ...
        if (x8_1 u<= 5)
            switch (x8_1)
                ...
                case 4
                    return std::__ndk1::__sort4<bool (*&)(DomGfx*, DomGfx*), DomGfx**>(x19, 
                        &x19[1], &x19[2], x21 - 8, arg3) __tailcall
                case 5
                    std::__ndk1::__sort4<bool (*&)(DomGfx*, DomGfx*), DomGfx**>(x19, &x19[1], 
                        &x19[2], &x19[3], arg3)
            ...
            if (x9_1 s<= 0xf7)
                return std::__ndk1::__insertion_sort_3<bool (*&)(DomGfx*, DomGfx*), DomGfx**>(x19, 
                    x21, arg3) __tailcall
            ...
            if (x9_1 s< 0x1f39)
                ...
                x24_1 = std::__ndk1::__sort4<bool (*&)(DomGfx*, DomGfx*), DomGfx**>(x19, x25_1, 
                    x23_2, x26_1, arg3)
            ...
            label_bb0044:
                ...
                if (x25_2 - x19 s>= x21 - x25_2)
                    std::__ndk1::__sort<bool (*&)(DomGfx*, DomGfx*), DomGfx**>(&x25_2[1], x21, arg3)
                    x21 = x25_2
                    break
                
                std::__ndk1::__sort<bool (*&)(DomGfx*, DomGfx*), DomGfx**>(x19, x25_2, arg3)
                x23_1 = &x25_2[1]
                continue
            else
                int32_t x0_29 =
                    std::__ndk1::__insertion_sort_incomplete<bool (*&)(DomGfx*, DomGfx*), DomGfx**>(
                    x19, x25_2, arg3)
                x23_1 = &x25_2[1]
                
                if ((std::__ndk1::__insertion_sort_incomplete<bool (*&)(DomGfx*, DomGfx*), DomGfx**>(
