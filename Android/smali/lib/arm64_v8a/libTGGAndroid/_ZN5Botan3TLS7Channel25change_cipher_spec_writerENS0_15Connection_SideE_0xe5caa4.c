// 函数: _ZN5Botan3TLS7Channel25change_cipher_spec_writerENS0_15Connection_SideE
// 地址: 0xe5caa4
...
if (x24 == 0 || x8_1 == 0)
    Botan::assertion_failure("pending && pending->server_hello()", "Have received server hello", 
        "change_cipher_spec_writer", "..\..\ExternalCode\botan\botanAM\arm\botan_all_android.cpp", 
        0x13e7b)
else
    if (zx.d(*(x8_1 + 0x42)) != 0)
        goto label_e5cde4
    ...
    int32_t x0_2 = (*(*x0_1 + 0x28))()
    entry_x26 = entry_x19 + 0x58
    void* x8_7 = *entry_x26
    entry_x21 = zx.q(x0_2)
    ...
    if (x8_7 != 0)
        ...
        Botan::assertion_failure("m_write_cipher_states.count(epoch) == 0", 
            "No write cipher state currently set for next epoch", "change_cipher_spec_writer", 
            "..\..\ExternalCode\botan\botanAM\arm\botan_all_android.cpp", 0x13e85)
    else
    label_e5cb18:
        int64_t x0_3 = operator new(0x40)
        entry_x23 = zx.q(*(x24 + 0x20))
        entry_x20 = x0_3
        entry_x25 = x24 + 0x28
        int64_t* i_5 = *(x24 + 0x108) + 0x50
        int64_t* i = *i_5
        x24 += 0x70
...
Botan::TLS::Connection_Cipher_State::Connection_Cipher_State(entry_x20, entry_x23, entry_x22.b, 1, 
    entry_x25, x24.b)
void** result = operator new(0x20)
int64_t* x24_2 = &result[1]
*x24_2 = 0
result[2] = 0
result[3] = entry_x20
...
if (x8_11 == 0)
    ...
    label_e5cc9c:
        ...
        *x25 = x0_8
        x23 = x0_8
        int64_t x8_13 = **(entry_x19 + 0x50)
        int64_t* x1_3
        
        if (x8_13 == 0)
            x1_3 = x23
        else
            *(entry_x19 + 0x50) = x8_13
            x1_3 = *x25
...
do
    i_1 = __stxr(__ldxr(x24_2) + 1, x24_2)
while (i_1 != 0)
int64_t* x19 = x23[6]
x23[5] = entry_x20
x23[6] = result_1
