// 函数: _ZNSt6__ndk127__insertion_sort_incompleteIRPFb9AbilityIDS1_EPS1_EEbT0_S6_T_
// 地址: 0xc031c4
...
if (x8_1 u> 5)
    ...
    void* __offset(AbilityID, 0xc) x23_2 = arg1 + 8
    int32_t x0_9
    int32_t x9_4
    int128_t v0_1
    ...
    void* __offset(AbilityID, 0xc) x24_2 = arg1 + 0xc
    char x8_29
    ...
    label_c034f0:
        ...
        while (true)
            int32_t x0_29
            x0_29, x9_4 = (*arg3)(zx.q(*x24_2), zx.q(*x23_2))
            
            if ((x0_29 & 1) != 0)
                uint64_t x22_4 = zx.q(*x24_2)
                int64_t x23_4 = x25_1
                int32_t x0_31
                
                do
                    void* x8_26 = arg1 + x23_4
                    x9_4 = *(x8_26 + 8)
                    *(x8_26 + 0xc) = x9_4
                    ...
                    x0_31, x9_4 = (*arg3)(x22_4, zx.q(*(x8_26 + 4)))
                    x23_4 -= 4
                while ((x0_31 & 1) != 0)
                x26_1 += 1
                *(arg1 + x23_4 + 0xc) = x22_4.d
                
                if (x26_1 == 8)
                label_c034e4:
                    x8_29 = 0
                    x9_4 = x24_2 + 4 == arg2 ? 1 : 0
                    break
    ...
    switch (x8_1)
        ...
        case 4
            std::__ndk1::__sort4<bool (*&)(AbilityID, AbilityID), AbilityID*>(arg1, arg1 + 4, 
                arg1 + 8, arg2 - 4, arg3)
            x8_2 = 1
        case 5
            std::__ndk1::__sort4<bool (*&)(AbilityID, AbilityID), AbilityID*>(arg1, arg1 + 4, 
