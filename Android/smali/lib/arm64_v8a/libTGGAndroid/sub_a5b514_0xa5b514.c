...
*result = &_vtable_for_std::__ndk1::__function::__func<Theme_DeckChangesB_5Curses()::$_128, std::__ndk1::allocator<Theme_DeckChangesB_5Curses()::$_128>, bool (DomCardEnum)>{for `std::__ndk1::__function::__base<bool (DomCardEnum)>'}
return result
