// 函数: _ZNK5Botan4SEED9encrypt_nEPKhPhm
// 地址: 0xe10bd4
...
if (x13 == *(arg1 + 0x10))
    ...
    return Botan::SEED::decrypt_n(x0, x1, x2) __tailcall
...
while (true)
    ...
    do
        int32_t* x5_2 = x13 + i
        i += 0x10
        int32_t x6_2 = x17_2 ^ x4_2 ^ x5_2[1]
        ...
        x15_2 ^= x6_9
        x16_1 ^= x6_9 + x7_6
        int32_t x5_5 = x5_2[3] ^ x15_2 ^ x16_1
        ...
        int32_t x6_15 = x5_8 + (x16_1 ^ x5_2[2])
