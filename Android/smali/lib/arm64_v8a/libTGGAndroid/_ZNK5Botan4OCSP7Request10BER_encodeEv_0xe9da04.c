// 函数: _ZNK5Botan4OCSP7Request10BER_encodeEv
// 地址: 0xe9da04
...
Botan::DER_Encoder::start_cons(&var_d0, 0x10)
Botan::DER_Encoder::start_cons(&var_d0, 0)
int64_t x0_6 = Botan::DER_Encoder::encode(&var_d0)
Botan::DER_Encoder::end_cons()
Botan::DER_Encoder::start_cons(x0_6, 0x10)
Botan::DER_Encoder::start_cons(x0_6, 0x10)
void* entry_x0
(**(entry_x0 + 0x88))(entry_x0 + 0x88, x0_6)
Botan::DER_Encoder::end_cons()
Botan::DER_Encoder::end_cons()
Botan::DER_Encoder::end_cons()
Botan::DER_Encoder::end_cons()
void* x21_1 = var_90:8.q
...
int64_t x0_16 = var_a0

if (x0_16 != 0)
    var_a0 = x0_16
    Botan::deallocate_memory(x0_16, var_90.q - x0_16, 1)
