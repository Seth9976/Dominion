                ...
                label_10eed08:
                    *arg1 = x10_2 + 1
                    ...
                    if (x9_1 != 0 || zx.d(*(arg1 + 0x309)) == 0)
                        int64_t x10_12 = arg1[0x53]
                        int64_t x8_8 = (arg1[0x54] - x10_12) s>> 3
                        ...
                        label_10eee50:
                            ...
                            if (x9_1 u<= x8_8 && arg1[0x62] == x9_1)
                                ...
                                *(result + 8) = 0x1010107
                                *(result + 0x10) = "auto"
                                *(result + 0x18) = &data_746a16[4]
                        else
                            int64_t* x10_13 = *(x10_12 + (x9_1 << 3))
                            
                            if (x10_13 == 0)
                                goto label_10eee50
                            
                            int64_t x10_14 = *x10_13
                            
                            if (x21_1 u>= (x10_13[1] - x10_14) s>> 3)
                                goto label_10eee50
                            
                            result = *(x10_14 + (x21_1 << 3))
                    else
                        ...
                        if (x8_5 != arg1[0x5c])
                            ...
                            *x8_5 = result
                            ...
                            if (oldmem == &arg1[0x5d])
                                ...
                                int64_t x0_2 = realloc(oldmem, x21_2 << 1)
                                x22_2 = x0_2
                                arg1[0x5a] = x0_2
                            ...
                            x8_5 = x22_2 + (x21_2 s>> 3 << 3)
                            arg1[0x5c] = x22_2 + (x21_2 s>> 2 << 3)
                            arg1[0x5b] = &x8_5[1]
                            *x8_5 = result
                else if (zx.d(*x10_2) - 0x30 u> 9)
                    result = nullptr
                else
                    int64_t x11_6 = 0
                    
                    while (true)
                        int64_t x11_8 = x11_6 * 0xa
