// 函数: _ZNKSt6__ndk18time_getIcNS_19istreambuf_iteratorIcNS_11char_traitsIcEEEEE14do_get_weekdayES4_S4_RNS_8ios_baseERjP2tm
// 地址: 0x10bccd8
...
if (x9_1 u< (*(var_90 + 0x18) - x8_2) s>> 3)
    ...
    if (x23_1 != 0)
        ...
        char* x0_4 = (**(arg1 + 0x10))(arg1 + 0x10)
        void* x8_5 = sub_10b0e88(&result, arg3, x0_4, &x0_4[0x150], x23_1, arg5, 0) - x0_4
        
        if (x8_5 s<= 0x14f)
            int64_t x8_7 = (x8_5 s>> 3) * -0x5555555555555555
            int64_t x9_2 = (muls.dp.q(x8_7, 0x4924924924924925) u>> 0x40).q
            void* entry_x5
            *(entry_x5 + 0x18) = x8_7.d - ((x9_2 u>> 1).d + (x9_2 u>> 0x3f).d) * 7
