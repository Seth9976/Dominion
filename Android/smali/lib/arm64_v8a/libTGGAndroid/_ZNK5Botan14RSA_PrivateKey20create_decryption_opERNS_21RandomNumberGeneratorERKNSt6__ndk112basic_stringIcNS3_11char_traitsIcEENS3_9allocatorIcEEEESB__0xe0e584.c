// 函数: _ZNK5Botan14RSA_PrivateKey20create_decryption_opERNS_21RandomNumberGeneratorERKNSt6__ndk112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEESB_
// 地址: 0xe0e584
...
struct Botan::PK_Ops::Decryption_with_EME::Botan::(anonymous namespace)::RSA_Decryption_Operation::VTable
...
*x0_2 = &_vtable_for_Botan::(anonymous namespace)::RSA_Decryption_Operation{for `Botan::PK_Ops::Decryption_with_EME'}
void** entry_x8
*entry_x8 = x0_2
return result
