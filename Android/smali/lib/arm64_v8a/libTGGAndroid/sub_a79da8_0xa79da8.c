...
*result = &_vtable_for_std::__ndk1::__function::__func<Taxman()::$_1::operator()() const::'lambda'(CardID), std::__ndk1::allocator<Taxman()::$_1::operator()() const::'lambda'(CardID)>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
result[1].d = *(arg1 + 8)
return result
