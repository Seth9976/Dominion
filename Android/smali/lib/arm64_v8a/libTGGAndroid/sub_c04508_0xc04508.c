...
int64_t x8 = *(arg1 + 8)
*result = &_vtable_for_std::__ndk1::__function::__func<ComputeBuyMinTreasures(DomGame&, PlayerWho, CardIDs const&, DomCost, bool, int32_t)::$_6, std::__ndk1::allocator<ComputeBuyMinTreasures(DomGame&, PlayerWho, CardIDs const&, DomCost, bool, int32_t)::$_6>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
result[1] = x8
return result
