...
if (GetZoomPileStyle(zx.q(*(gDomClient + 0x20758))) != 3)
    return 0
...
if (x9_1.d != 0)
    ...
    do
        if (zx.d(*(x0_3 + 0x21d2)) != 0)
            if (x0_3 != 0xffffffff)
                while (true)
                    if (*(x0_3 + 0x2c) == 3 && *(x0_3 + 0x58) == 0xffffffff && *(x0_3 + 0x5c) == 2
                            && *(x0_3 + 0x60) == 0)
                        if (x0_3 != 0)
...
label_b45f84:
x0_3 = DomCreatePile_Other(2, 0xffffffff, 0, 0)
return zx.q(*(gDomClient + 0x1f8e4) != *(x0_3 + 0x21d0) ? 1 : 0)
