// 函数: _ZN5Botan11Keccak_160012final_resultEPh
// 地址: 0xd949f4
...
if ((x8 & 0x3f) != 0)
    uint64_t x0_1
    std::__ndk1::vector<uint64_t, Botan::secure_allocator<uint64_t> >* x1
    uint64_t x2_1
    uint8_t x3
    uint8_t x4
    x0_1, x1, x2_1, x3, x4 = Botan::throw_invalid_argument("SHA-3 bitrate must be multiple of 64", 
        "finish", "..\..\ExternalCode\botan\botanAM\arm\botan_all_android.cpp")
    return Botan::SHA_3::finish(x0_1, x1, x2_1, x3, x4) __tailcall

int64_t x9 = *(arg1 + 0x30)
int64_t* x10 = *(arg1 + 0x18)
int64_t x9_1 = x9 & 0xfffffffffffffff8
*(x10 + x9_1) ^= 1 << (zx.q(x9.d << 3) & 0x38)
int64_t* entry_x1
