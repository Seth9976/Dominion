...
__FD_SET_chk(zx.q(*(arg1 + 0x98)), &readfds, 0x80, v0)
...
if (select(*(arg1 + 0x98) + 1, &readfds, nullptr, nullptr, &timeout) == 0)
...
ssize_t result = recvfrom(*(arg1 + 0x98), arg2, arg3, 0, 0, nullptr)
