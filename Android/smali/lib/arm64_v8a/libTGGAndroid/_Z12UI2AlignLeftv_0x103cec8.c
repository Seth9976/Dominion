...
if (*(gUI2Editor + 0x704c) s>= 1)
    ...
    do
        ...
        float v2_1 = v0_2.d f- v0_4.d
        float v4_1 = v0_4.d f+ v2_1
        float v3_1 = v0_6.d f+ v13.d
        float v0_10 = v0_6.d f+ UI2PropDynamic<float>::Eval(v0_1.d) f+ v13.d
        float v1_1 = v2_1 + v0_4.d f+ v0_8.d - v4_1
        ...
        v0_10 = v3_1 + float.s(sx.d(vcvts_s32_f32(v0_10 + v2_1)))
        float var_90 = v4_1
        float var_8c_1 = v3_1
