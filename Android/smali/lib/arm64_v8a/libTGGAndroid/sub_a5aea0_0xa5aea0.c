...
*result = &_vtable_for_std::__ndk1::__function::__func<CardMod_CardTrait()::$_119, std::__ndk1::allocator<CardMod_CardTrait()::$_119>, bool (DomCardEnum)>{for `std::__ndk1::__function::__base<bool (DomCardEnum)>'}
return result
