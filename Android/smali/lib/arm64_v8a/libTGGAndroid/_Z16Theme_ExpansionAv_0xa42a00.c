...
if (x10_2.d == 2)
    x22 = x8_5 + (sx.q(*(gCampaignSetup + 0x19a8)) << 0xb) + 0x540
else
    x22 = x8_5 + (x10_2 << 3) + 0x5010

int32_t var_58 = *(x22 + 4)
...
if (x0_4 == 0)
    ...
    XNoReturn()
    return Theme_ExpansionB() __tailcall
...
if (x0_8 != 0)
    ...
    if (x0_12 == 0)
        ...
        if (x0_16 == 0)
            ...
            x20_1 = 4
            int32_t var_64_1 = x0_16

int64_t x0_22
char* x1_9
x0_22, x1_9 = CampaignDrawRandomCombo(zx.q((&var_70)[sx.q(RandomInt(gCampaignSetup, x20_1))]))
return CampaignKingdomAdd(x0_22, x1_9, 2, 0)
