...
*result = &_vtable_for_std::__ndk1::__function::__func<Shy_StartOfTurn()::$_84, std::__ndk1::allocator<Shy_StartOfTurn()::$_84>, bool (CardID)>{for `std::__ndk1::__function::__base<bool (CardID)>'}
return result
