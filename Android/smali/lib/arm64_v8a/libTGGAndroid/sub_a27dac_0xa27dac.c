...
int64_t x8 = *(arg1 + 8)
*result = &_vtable_for_std::__ndk1::__function::__func<Spy()::$_6::operator()() const::'lambda0'(), std::__ndk1::allocator<Spy()::$_6::operator()() const::'lambda0'()>, void ()>{for `std::__ndk1::__function::__base<void ()>'}
result[1] = x8
return result
