// 函数: _ZNK5Botan16X509_Certificate20raw_issuer_dn_sha256Ev
// 地址: 0xebd42c
...
if (*(x0 + 0x2f8) == *(x0 + 0x300))
    ...
    __builtin_strncpy(x0_4, 
        "X509_Certificate::raw_issuer_dn_sha256 called but SHA-256 disabled in build", 0x4c)
...
int64_t x8_1 = *(result + 0x300)
int64_t x9_1 = *(result + 0x2f8)
...
if (x8_1 != x9_1)
    ...
    *entry_x8 = result
    ...
    int64_t x1_1 = *(result_1 + 0x2f8)
    void* __saved_x0_1 = result
    size_t x21_1 = *(result_1 + 0x300) - x1_1
