...
if (*(gUI2Editor + 0x704c) s>= 1)
    ...
    do
        ...
        float v2_1 = v1_1.d f- v0_5.d
        float v3_1 = v0_3.d f+ v13.d
        float v4_1 = v0_5.d f+ v2_1
        float v0_9 = v2_1 + v0_5.d f+ UI2PropDynamic<float>::Eval(v0_1.d)
        ...
        float v1_2 = v0_3.d f+ v0_7.d f+ v13.d - v3_1
        v0_9 = v0_9 - v4_1
        v2_1 = v3_1 + v2_1
        ...
        v0_9 = v3_1 + float.s(sx.d(vcvts_s32_f32(v0_9 + v2_1)))
        float var_90 = v4_1
        float var_8c_1 = v3_1
        float var_88_1 = v4_1 + v1_2
        float var_84_1 = v0_9
        *(x0_2 + 0x1370) = 0
        *(x0_2 + 0x1694) = 0
