// 函数: _ZNSt6__ndk127__insertion_sort_incompleteIRPFbPK10DomTypeDefS3_EPS3_EEbT0_S8_T_
// 地址: 0xbaf9a0
...
if (x8_1 u> 5)
    ...
    if ((x0_7 & 1) != 0)
        ...
        if ((x0_9 & 1) == 0)
            ...
            *arg1 = arg1[1]
            ...
            DomTypeDef* x8_10 = arg1[2]
            arg1[2] = x1_6
            *arg1 = x8_10
    else if ((x0_9 & 1) != 0)
        v0_1 = *(arg1 + 8)
        DomTypeDef const* x1_14 = *arg1
    ...
    label_bafccc:
        ...
        while (true)
            DomTypeDef* x1_15 = *x23_2
            x23_2 = x8_25
            int32_t x0_29
            x0_29, x9_4 = (*arg3)(*x23_2, x1_15)
            
            if ((x0_29 & 1) != 0)
                DomTypeDef* x22_4 = *x23_2
                int64_t x26_1 = x24_2
                int32_t x0_31
    ...
    switch (x8_1)
        ...
        case 4
            std::__ndk1::__sort4<bool (*&)(DomTypeDef const*, DomTypeDef const*), DomTypeDef const**>(
                arg1, &arg1[1], &arg1[2], arg2 - 8, arg3)
            x8_2 = 1
        case 5
            std::__ndk1::__sort4<bool (*&)(DomTypeDef const*, DomTypeDef const*), DomTypeDef const**>(
                arg1, &arg1[1], &arg1[2], &arg1[3], arg3)
            
            if (((*arg3)(arg2[-1], arg1[3]) & 1) == 0)
                x8_2 = 1
            else
                DomTypeDef* x9_5 = arg1[3]
                arg1[3] = arg2[-1]
                arg2[-1] = x9_5
                int32_t x0_15
                uint128_t v0_2
