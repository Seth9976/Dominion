// 函数: _ZNSt6__ndk127__insertion_sort_incompleteIRNS_6__lessIssEEPsEEbT0_S5_T_
// 地址: 0x109ae10
...
if (x8_1 u> 5)
    ...
    label_109b014:
        ...
        while (true)
            int32_t x12_1 = sx.d(*x10_4)
            
            if (x12_1 s< sx.d(x8_4.w))
                int64_t x14_1 = x11_2
                int16_t* x8_10
    ...
    switch (x8_1)
        ...
        case 4
            ...
            if (x9_7 s< x8_7)
                arg1[2] = x9_7.w
                arg2[-1] = x8_7.w
                int32_t x8_11 = sx.d(arg1[2])
                int32_t x9_8 = sx.d(arg1[1])
        ...
        case 5
            SystemHintOp_BTI()
            sub_109ac84(arg1, &arg1[1], &arg1[2], &arg1[3], arg2 - 2)
            x8_2 = 1
