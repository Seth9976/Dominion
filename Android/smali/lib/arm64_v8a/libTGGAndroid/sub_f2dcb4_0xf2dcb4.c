...
*result = &_vtable_for_std::__ndk1::__function::__func<botan_x509_cert_verify::$_34, std::__ndk1::allocator<botan_x509_cert_verify::$_34>, int32_t ()>{for `std::__ndk1::__function::__base<int32_t ()>'}
*(result + 8) = *(arg1 + 8)
v1 = *(arg1 + 0x48)
v2 = *(arg1 + 0x38)
v3 = *(arg1 + 0x28)
