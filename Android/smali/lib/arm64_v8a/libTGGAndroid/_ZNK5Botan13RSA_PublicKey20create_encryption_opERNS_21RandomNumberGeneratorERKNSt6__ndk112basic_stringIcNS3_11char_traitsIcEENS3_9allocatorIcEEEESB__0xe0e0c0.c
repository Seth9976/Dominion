// 函数: _ZNK5Botan13RSA_PublicKey20create_encryption_opERNS_21RandomNumberGeneratorERKNSt6__ndk112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEESB_
// 地址: 0xe0e0c0
...
std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >* 
    x0_2 = operator new(0x20)
int64_t result = Botan::PK_Ops::Encryption_with_EME::Encryption_with_EME(x0_2)
...
*x0_2 = &_vtable_for_Botan::(anonymous namespace)::RSA_Encryption_Operation{for `Botan::PK_Ops::Encryption_with_EME'}
std::__ndk1::basic_string<char, std::__ndk1::char_traits<char>, std::__ndk1::allocator<char> >** 
    entry_x8
*entry_x8 = x0_2
return result
