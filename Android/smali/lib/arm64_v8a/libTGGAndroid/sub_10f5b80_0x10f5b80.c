...
if (x8 + 7 u>= x10)
    ...
    *arg2 = x0
    ...
    x0 = *arg2
label_10f5bf0:
    __builtin_strncpy(x0 + x8, "\'lambda", 7)
    int64_t x8_3 = arg2[1] + 7
    arg2[1] = x8_3
    int64_t x22_1 = *(arg1 + 0x30)
    int64_t x9_1 = *(arg1 + 0x38)
    size_t x21_1 = x9_1 - x22_1
    
    if (x9_1 == x22_1)
        goto label_10f5c64
    
    int64_t x10_1 = arg2[2]
    int64_t bytes_6 = x8_3 + x21_1
    int64_t x0_1
    ...
    label_10f5c64:
        ...
        label_10f5ca4:
            x0_3[x8_3] = 0x27
            arg2[1] += 1
            return sub_10f5cdc(arg1, arg2) __tailcall
