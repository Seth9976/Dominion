...
final class zzbc implements ServiceConnection {
    ...
    zzbc(BillingClientImpl billingClientImpl0, BillingClientStateListener billingClientStateListener0, zzbb zzbb0) {
    ...
    final Object zza() throws Exception {
        ...
        try {
            while(v1 >= 3) {
                v = bundle0 == null ? this.zza.zzg.zzy(v1, "com.templegatesgames.DominionAndroid", "subs") : this.zza.zzg.zzc(v1, "com.templegatesgames.DominionAndroid", "subs", bundle0);
                if(v != 0) {
                    --v1;
                    continue;
                }
        ...
        label_21:
            ...
            int v3 = 22;
            while(v3 >= 3) {
                v = bundle0 == null ? this.zza.zzg.zzy(v3, "com.templegatesgames.DominionAndroid", "inapp") : this.zza.zzg.zzc(v3, "com.templegatesgames.DominionAndroid", "inapp", bundle0);
                if(v == 0) {
                    this.zza.zzk = v3;
            ...
            if(v2 == 42) {
                s = exception0.getClass().getSimpleName() + ": " + zzab.zzb(exception0.getMessage());
                if(s.length() > 70) {
                    s = s.substring(0, 70);
                }
            }
