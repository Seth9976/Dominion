...
public class FcmBroadcastProcessor {
    ...
    public FcmBroadcastProcessor(Context context0) {
        ...
        this.executor = new EnhancedIntentService..ExternalSyntheticLambda0();
    }
    ...
    public Task startMessagingService(Context context0, Intent intent0) {
        ...
        (((int)(((Integer)task0.getResult()))) == 402 ? FcmBroadcastProcessor.bindToMessagingService(context0, intent0).continueWith(new EnhancedIntentService..ExternalSyntheticLambda0(), (Task task0) -> 403) : task0);
