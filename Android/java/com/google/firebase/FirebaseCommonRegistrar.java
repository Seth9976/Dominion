...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List getComponents() {
        ...
        list0.add(LibraryVersionComponent.fromContext("android-installer", (Context context0) -> {
            String s = context0.getPackageManager().getInstallerPackageName("com.templegatesgames.DominionAndroid");
            return s == null ? "" : FirebaseCommonRegistrar.safeValue(s);
        }));
        list0.add(LibraryVersionComponent.create("kotlin", "1.7.10"));
        return list0;
    }
