...
public class FirebaseInstallationServiceClient {
    ...
    private String getFingerprintHashForPackage() {
        try {
            byte[] arr_b = AndroidUtilsLight.getPackageCertificateHashBytes(this.context, "com.templegatesgames.DominionAndroid");
            if(arr_b == null) {
                Log.e("ContentValues", "Could not get fingerprint hash for package: com.templegatesgames.DominionAndroid");
                return null;
            }
            return Hex.bytesToStringUppercase(arr_b, false);
        }
        catch(PackageManager.NameNotFoundException packageManager$NameNotFoundException0) {
            Log.e("ContentValues", "No such package: com.templegatesgames.DominionAndroid", packageManager$NameNotFoundException0);
            return null;
        }
    }
    ...
    private HttpURLConnection openHttpURLConnection(URL uRL0, String s) throws FirebaseInstallationsException {
        ...
        httpURLConnection0.addRequestProperty("X-Android-Package", "com.templegatesgames.DominionAndroid");
