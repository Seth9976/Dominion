...
public class FirebaseApp {
        ...
        private static void ensureBackgroundStateListenerRegistered(Context context0) {
            if(context0.getApplicationContext() instanceof Application) {
                ...
                if(GlobalBackgroundStateListener.INSTANCE.get() == null) {
                    ...
                    if(zap..ExternalSyntheticBackportWithForwarding0.m(GlobalBackgroundStateListener.INSTANCE, null, firebaseApp$GlobalBackgroundStateListener0)) {
    ...
    static class UserUnlockReceiver extends BroadcastReceiver {
        ...
        private static void ensureReceiverRegistered(Context context0) {
            if(UserUnlockReceiver.INSTANCE.get() == null) {
                ...
                if(zap..ExternalSyntheticBackportWithForwarding0.m(UserUnlockReceiver.INSTANCE, null, firebaseApp$UserUnlockReceiver0)) {
    ...
    public static FirebaseApp getInstance() {
        ...
        throw new IllegalStateException("Default FirebaseApp is not initialized in this process com.templegatesgames.DominionAndroid. Make sure to call FirebaseApp.initializeApp(Context) first.");
    }
