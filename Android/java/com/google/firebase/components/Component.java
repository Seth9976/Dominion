...
public final class Component {
    ...
    public static Component intoSet(Object object0, Class class0) {
        return Component.intoSetBuilder(class0).factory(new Component..ExternalSyntheticLambda0(object0)).build();
    }
    ...
    public static Component of(Class class0, Object object0) {
        return Component.builder(class0).factory(new Component..ExternalSyntheticLambda1(object0)).build();
    }

    @SafeVarargs
    public static Component of(Object object0, Class class0, Class[] arr_class) {
        return Component.builder(class0, arr_class).factory(new Component..ExternalSyntheticLambda2(object0)).build();
    }
