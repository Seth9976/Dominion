...
public final class zzga extends zzcs implements zzed {
    ...
    public static zzga zzA(byte[] arr_b, zzcd zzcd0) throws zzdc {
        return (zzga)zzcs.zzm(zzga.zzb, arr_b, zzcd0);
    }

    static void zzB(zzga zzga0, zzgk zzgk0) {
        zzgk0.getClass();
        zzga0.zzh = zzgk0;
        zzga0.zzd |= 2;
    }

    static void zzC(zzga zzga0, zzhb zzhb0) {
        zzhb0.getClass();
        zzga0.zzf = zzhb0;
        zzga0.zze = 4;
    }

    static void zzD(zzga zzga0, int v) {
        zzga0.zzg = v - 1;
        zzga0.zzd |= 1;
    }
    ...
    protected final Object zzx(int v, Object object0, Object object1) {
        if(v - 1 != 0) {
            switch(v - 1) {
                case 2: {
                    return zzga.zzq(zzga.zzb, "\u0001\u0003\u0001\u0001\u0001\u0004\u0003\u0000\u0000\u0000\u0001᠌\u0000\u0002ဉ\u0001\u0004<\u0000", new Object[]{"zzf", "zze", "zzd", "zzg", zzgb.zza, "zzh", zzhb.class});
                }
                case 3: {
                    return new zzga();
                }
