...
public final class zzfg {
    ...
    public final int zza() {
        ...
        if(v == -1) {
            ...
            for(int v1 = 0; v1 < this.zzb; ++v1) {
                ...
                switch(v3 & 7) {
                    case 0: {
                        v5 = zzby.zzw(v4 << 3) + zzby.zzx(((long)(((Long)this.zzd[v1]))));
                        break;
                    }
                    case 1: {
                    ...
                    case 2: {
                        int v7 = ((zzbq)this.zzd[v1]).zzd();
                        v5 = zzby.zzw(v4 << 3) + (zzby.zzw(v7) + v7);
                        break;
                    }
                    case 3: {
                        int v6 = zzby.zzw(v4 << 3);
                        v5 = v6 + v6 + ((zzfg)this.zzd[v1]).zza();
                        break;
                    }
                    case 5: {
    ...
    static zzfg zze(zzfg zzfg0, zzfg zzfg1) {
    ...
    final void zzk(zzfx zzfx0) throws IOException {
        for(int v = 0; v < this.zzb; ++v) {
            zzfx0.zzw(this.zzc[v] >>> 3, this.zzd[v]);
        }
    }

    public final void zzl(zzfx zzfx0) throws IOException {
        if(this.zzb != 0) {
            for(int v = 0; v < this.zzb; ++v) {
                int v1 = this.zzc[v];
