...
final class zzct extends zzba implements zzcx, zzek, RandomAccess {
    private static final zzct zza;
    private int[] zzb;
    private int zzc;

    static {
        zzct.zza = new zzct(new int[0], 0, false);
    }
    ...
    private zzct(int[] arr_v, int v, boolean z) {
        super(z);
        this.zzb = arr_v;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzct)) {
            return super.addAll(collection0);
        }
        int v = ((zzct)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzct)collection0).zzb, 0, this.zzb, this.zzc, ((zzct)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof zzct)) {
            return super.equals(object0);
        }
        if(this.zzc != ((zzct)object0).zzc) {
            return false;
        }
        int[] arr_v = ((zzct)object0).zzb;
    ...
    public final zzcz zzd(int v) {
        ...
        return new zzct(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
