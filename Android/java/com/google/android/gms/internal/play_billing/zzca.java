...
final class zzca extends zzba implements zzcz, zzek, RandomAccess {
    private static final zzca zza;
    private double[] zzb;
    private int zzc;

    static {
        zzca.zza = new zzca(new double[0], 0, false);
    }
    ...
    private zzca(double[] arr_f, int v, boolean z) {
        super(z);
        this.zzb = arr_f;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzca)) {
            return super.addAll(collection0);
        }
        int v = ((zzca)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzca)collection0).zzb, 0, this.zzb, this.zzc, ((zzca)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(this.zzc != ((zzca)object0).zzc) {
            return false;
        }
        double[] arr_f = ((zzca)object0).zzb;
    ...
    public final zzcz zzd(int v) {
        ...
        return new zzca(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
