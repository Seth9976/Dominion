...
final class zzbv extends zzby {
    ...
    @Override  // com.google.android.gms.internal.play_billing.zzby
    public final void zze(int v, zzbq zzbq0) throws IOException {
        this.zzq(v << 3 | 2);
        this.zzq(zzbq0.zzd());
        zzbq0.zzh(this);
    }
    ...
    public final void zzn(String s) throws IOException {
        ...
        try {
            v = this.zzd;
            int v1 = zzbv.zzw(s.length() * 3);
            int v2 = zzbv.zzw(s.length());
            if(v2 == v1) {
                int v3 = v + v2;
                this.zzd = v3;
                int v4 = zzfu.zzb(s, this.zzb, v3, this.zzc - v3);
                this.zzd = v;
                this.zzq(v4 - v - v2);
                this.zzd = v4;
                return;
