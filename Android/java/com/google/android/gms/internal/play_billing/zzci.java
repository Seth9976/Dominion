...
final class zzci {
    ...
    static int zza(zzfv zzfv0, int v, Object object0) {
        if(zzfv.zzj != null || !(((zzec)object0) instanceof zzaz)) {
            throw null;
        }
        zzaz zzaz0 = (zzaz)(((zzec)object0));
        throw null;
    }
    ...
    private static final int zzo(Map.Entry map$Entry0) {
        ...
        if(zzch0.zze() == zzfw.zzi && !zzch0.zzg() && !zzch0.zzf()) {
            if(object0 instanceof zzdh) {
                ...
                v1 = ((zzdh)object0).zza();
                return zzby.zzw(v1) + 3 + v + v1;
            }
            v = zzby.zzw(((zzch)map$Entry0.getKey()).zza()) + 1;
            v1 = ((zzec)object0).zzf();
            return zzby.zzw(v1) + v + v1 + 3;
        }
