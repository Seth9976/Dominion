...
final class zzfu {
    ...
    static int zzb(String s, byte[] arr_b, int v, int v1) {
        int v2 = s.length();
        int v3;
        for(v3 = 0; true; ++v3) {
            int v4 = v + v1;
        ...
        label_47:
            ...
            throw new zzft(v3, v2);
        }
        return v7;
    }

    static int zzc(String s) {
        int v = s.length();
        int v1 = 0;
        int v2;
    ...
    static boolean zzd(byte[] arr_b) {
        return zzfu.zzb.zzb(arr_b, 0, arr_b.length);
    }

    static boolean zze(byte[] arr_b, int v, int v1) {
        return zzfu.zzb.zzb(arr_b, v, v1);
    }
}
