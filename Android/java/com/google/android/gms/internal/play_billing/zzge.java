...
public final class zzge extends zzcs implements zzed {
    ...
    static void zzA(zzge zzge0, zzhb zzhb0) {
        zzhb0.getClass();
        zzge0.zzf = zzhb0;
        zzge0.zze = 2;
    }

    static void zzB(zzge zzge0, int v) {
        zzge0.zzg = v - 1;
        zzge0.zzd |= 1;
    }
    ...
    protected final Object zzx(int v, Object object0, Object object1) {
        if(v - 1 != 0) {
            switch(v - 1) {
                case 2: {
                    return zzge.zzq(zzge.zzb, "\u0001\u0003\u0001\u0001\u0001\u0003\u0003\u0000\u0000\u0000\u0001᠌\u0000\u0002<\u0000\u0003<\u0000", new Object[]{"zzf", "zze", "zzd", "zzg", zzgb.zza, zzhb.class, zzho.class});
                }
                case 3: {
                    return new zzge();
                }
