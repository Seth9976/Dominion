...
final class zzck extends zzba implements zzcz, zzek, RandomAccess {
    private static final zzck zza;
    private float[] zzb;
    private int zzc;

    static {
        zzck.zza = new zzck(new float[0], 0, false);
    }
    ...
    private zzck(float[] arr_f, int v, boolean z) {
        super(z);
        this.zzb = arr_f;
        this.zzc = v;
    }
    ...
    public final boolean addAll(Collection collection0) {
        ...
        if(!(collection0 instanceof zzck)) {
            return super.addAll(collection0);
        }
        int v = ((zzck)collection0).zzc;
        if(v == 0) {
            return false;
        }
        int v1 = this.zzc;
        ...
        System.arraycopy(((zzck)collection0).zzb, 0, this.zzb, this.zzc, ((zzck)collection0).zzc);
        this.zzc = v2;
        ++this.modCount;
        return true;
    }
    ...
    public final boolean equals(Object object0) {
        ...
        if(!(object0 instanceof zzck)) {
            return super.equals(object0);
        }
        if(this.zzc != ((zzck)object0).zzc) {
            return false;
        }
        float[] arr_f = ((zzck)object0).zzb;
    ...
    public final zzcz zzd(int v) {
        ...
        return new zzck(Arrays.copyOf(this.zzb, v), this.zzc, true);
    }
