...
public class WorkSourceUtil {
    ...
    static {
        ...
        try {
            ...
            method2 = null;
            method2 = WorkSource.class.getMethod("size", null);
        }
        catch(Exception unused_ex) {
        }
        try {
        ...
        try {
            ...
            method5 = WorkSource.class.getMethod("createWorkChain", null);
        }
        ...
        try {
            ...
            method7 = null;
            method7 = WorkSource.class.getMethod("isEmpty", null);
    ...
    public static void add(WorkSource workSource0, int v, String s) {
        ...
        if(method0 != null) {
            ...
            try {
                zkcvv.invoke(method0, workSource0, new Object[]{v, s});
            }
            catch(Exception exception0) {
        ...
        if(method1 != null) {
            try {
                zkcvv.invoke(method1, workSource0, new Object[]{v});
            }
            catch(Exception exception1) {
    ...
    public static WorkSource fromPackageAndModuleExperimentalPi(Context context0, String s, String s1) {
        ...
        label_10:
            ...
            if(method0 != null) {
                ...
                if(method1 != null) {
                    try {
                        Object object0 = zkcvv.invoke(method0, workSource0, null);
                        int v1 = WorkSourceUtil.zza;
                        if(v != v1) {
                            zkcvv.invoke(method1, object0, new Object[]{v, s});
                        }
                        zkcvv.invoke(method1, object0, new Object[]{v1, s1});
                    }
                    catch(Exception exception0) {
    ...
    public static int get(WorkSource workSource0, int v) {
        ...
        if(method0 != null) {
            try {
                Object object0 = zkcvv.invoke(method0, workSource0, new Object[]{v});
    ...
    public static String getName(WorkSource workSource0, int v) {
        ...
        if(method0 != null) {
            try {
                return (String)zkcvv.invoke(method0, workSource0, new Object[]{v});
            }
            catch(Exception exception0) {
                Log.wtf("WorkSourceUtil", "Unable to assign blame through WorkSource", exception0);
            }
