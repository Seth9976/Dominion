...
final class zzr implements Handler.Callback {
    ...
    public final boolean handleMessage(Message message0) {
        switch(message0.what) {
            case 0: {
                HashMap hashMap0 = zzs.zzh(this.zza);
                synchronized(hashMap0) {
                    zzo zzo0 = (zzo)message0.obj;
                    zzp zzp0 = (zzp)zzs.zzh(this.zza).get(zzo0);
                    if(zzp0 != null && zzp0.zzi()) {
                        if(zzp0.zzj()) {
                            zzp0.zzg("GmsClientSupervisor");
                        }
                        zzs.zzh(this.zza).remove(zzo0);
                    }
                    return true;
                }
            }
            case 1: {
                HashMap hashMap1 = zzs.zzh(this.zza);
                synchronized(hashMap1) {
                    zzo zzo1 = (zzo)message0.obj;
                    zzp zzp1 = (zzp)zzs.zzh(this.zza).get(zzo1);
