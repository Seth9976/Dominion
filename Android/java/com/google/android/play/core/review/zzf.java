...
final class zzf extends zzj {
    ...
    protected final void zza() {
        try {
            ...
            ((com.google.android.play.core.review.internal.zzf)iInterface0).zzc(zzi.zzc(this.zzb), bundle0, new zzh(this.zzb, this.zza, zzi.zzc(this.zzb)));
        }
        catch(RemoteException remoteException0) {
            zzi.zzb().zzc(remoteException0, "error requesting in-app review for %s", new Object[]{zzi.zzc(this.zzb)});
