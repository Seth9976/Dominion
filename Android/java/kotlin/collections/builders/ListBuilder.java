...
public final class ListBuilder extends AbstractMutableList implements Serializable, List, RandomAccess, KMutableList {
    ...
    public Object[] toArray() {
        ...
        Intrinsics.checkNotNull(arr_object, "null cannot be cast to non-null type kotlin.Array<kotlin.Any?>");
        return arr_object;
    }
    ...
    public Object[] toArray(Object[] arr_object) {
        ...
        Intrinsics.checkNotNull(arr_object2, "null cannot be cast to non-null type kotlin.Array<T of kotlin.collections.builders.ListBuilder.toArray>");
        ArraysKt.copyInto(arr_object2, arr_object, 0, this.offset, this.length + this.offset);
        int v1 = this.length;
