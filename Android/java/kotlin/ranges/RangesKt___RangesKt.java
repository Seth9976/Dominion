...
class RangesKt___RangesKt extends RangesKt__RangesKt {
    ...
    public static final Byte toByteExactOrNull(double f) {
        return f > 127.0 || -128.0 > f ? null : ((byte)(((int)f)));
    }

    public static final Byte toByteExactOrNull(float f) {
        return f > 127.0f || -128.0f > f ? null : ((byte)(((int)f)));
    }
    ...
    public static final Integer toIntExactOrNull(double f) {
        return f > 2147483647.0 || -2147483648.0 > f ? null : ((int)f);
    }

    public static final Integer toIntExactOrNull(float f) {
        return f > 2147483648.0f || -2147483648.0f > f ? null : ((int)f);
    }
    ...
    public static final Long toLongExactOrNull(double f) {
        return f > 9223372036854776000.0 || -9223372036854776000.0 > f ? null : ((long)f);
    }

    public static final Long toLongExactOrNull(float f) {
        return f > 9223372036854776000.0f || -9223372036854776000.0f > f ? null : ((long)f);
    }

    public static final Short toShortExactOrNull(double f) {
        return f > 32767.0 || -32768.0 > f ? null : ((short)(((int)f)));
    }

    public static final Short toShortExactOrNull(float f) {
        return f > 32767.0f || -32768.0f > f ? null : ((short)(((int)f)));
    }
