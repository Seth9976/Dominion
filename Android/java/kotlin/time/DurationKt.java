...
public final class DurationKt {
    ...
    private static final long parseDuration(String s, boolean z) {
            ...
            while(v5 < v1) {
                ...
                while(true) {
                    if(v6 < s.length()) {
                        int v7 = s.charAt(v6);
                        v8 = v4;
                        if(!new CharRange('0', '9').contains(((char)v7)) && !StringsKt.contains$default("+-.", ((char)v7), false, 2, null)) {
                            break;
                        }
                        else {
                            ++v6;
                ...
                if(durationUnit1 != DurationUnit.SECONDS || v10 <= 0) {
                    z2 = z1;
                    v = Duration.plus-LRDsOJo(v, DurationKt.toDuration(DurationKt.parseOverLongIsoComponent(s1), durationUnit1));
                }
                else {
                    ...
                    z2 = z1;
                    long v11 = Duration.plus-LRDsOJo(v, DurationKt.toDuration(DurationKt.parseOverLongIsoComponent(s2), durationUnit1));
                    Intrinsics.checkNotNull(s1, "null cannot be cast to non-null type java.lang.String");
                    String s3 = s1.substring(v10);
                    Intrinsics.checkNotNullExpressionValue(s3, "this as java.lang.String).substring(startIndex)");
                    v = Duration.plus-LRDsOJo(v11, DurationKt.toDuration(Double.parseDouble(s3), durationUnit1));
                }
                z1 = z2;
        ...
        for(boolean z3 = false; v2 < v13; z3 = true) {
            if(z3 && v12 != 0) {
            ...
            int v18 = StringsKt.indexOf$default(s4, '.', 0, false, 6, null);
            if(v18 > 0) {
                ...
                long v19 = Duration.plus-LRDsOJo(v, DurationKt.toDuration(Long.parseLong(s6), durationUnit3));
                Intrinsics.checkNotNull(s4, "null cannot be cast to non-null type java.lang.String");
                String s7 = s4.substring(v18);
                Intrinsics.checkNotNullExpressionValue(s7, "this as java.lang.String).substring(startIndex)");
                v = Duration.plus-LRDsOJo(v19, DurationKt.toDuration(Double.parseDouble(s7), durationUnit3));
                if(v2 < v13) {
