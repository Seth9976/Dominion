...
final class ModuleNameRetriever {
    ...
    private final Cache buildCache(BaseContinuationImpl baseContinuationImpl0) {
        try {
            Cache moduleNameRetriever$Cache0 = new Cache(Class.class.getDeclaredMethod("getModule", null), baseContinuationImpl0.getClass().getClassLoader().loadClass("java.lang.Module").getDeclaredMethod("getDescriptor", null), baseContinuationImpl0.getClass().getClassLoader().loadClass("java.lang.module.ModuleDescriptor").getDeclaredMethod("name", null));
    ...
    public final String getModuleName(BaseContinuationImpl baseContinuationImpl0) {
        ...
        Object object0 = moduleNameRetriever$Cache0.getModuleMethod == null ? null : zkcvv.invoke(moduleNameRetriever$Cache0.getModuleMethod, baseContinuationImpl0.getClass(), null);
        if(object0 == null) {
            return null;
        }
        Object object1 = moduleNameRetriever$Cache0.getDescriptorMethod == null ? null : zkcvv.invoke(moduleNameRetriever$Cache0.getDescriptorMethod, object0, null);
        if(object1 == null) {
            return null;
        }
        Object object2 = moduleNameRetriever$Cache0.nameMethod == null ? null : zkcvv.invoke(moduleNameRetriever$Cache0.nameMethod, object1, null);
