...
public final class WindowInsetsControllerCompat {
    ...
    static class Impl30 extends Impl {
        ...
        void addOnControllableInsetsChangedListener(OnControllableInsetsChangedListener windowInsetsControllerCompat$OnControllableInsetsChangedListener0) {
            ...
            WindowInsetsControllerCompat.Impl30..ExternalSyntheticLambda11 windowInsetsControllerCompat$Impl30$$ExternalSyntheticLambda110 = (WindowInsetsController windowInsetsController0, int v) -> if(this.mInsetsController == windowInsetsController0) {
                windowInsetsControllerCompat$OnControllableInsetsChangedListener0.onControllableInsetsChanged(this.mCompatController, v);
            };
            this.mListeners.put(windowInsetsControllerCompat$OnControllableInsetsChangedListener0, windowInsetsControllerCompat$Impl30$$ExternalSyntheticLambda110);
            this.mInsetsController.addOnControllableInsetsChangedListener(windowInsetsControllerCompat$Impl30$$ExternalSyntheticLambda110);
        }
        ...
        @Override  // androidx.core.view.WindowInsetsControllerCompat$Impl
        void removeOnControllableInsetsChangedListener(OnControllableInsetsChangedListener windowInsetsControllerCompat$OnControllableInsetsChangedListener0) {
            WindowInsetsController.OnControllableInsetsChangedListener windowInsetsController$OnControllableInsetsChangedListener0 = Trace..ExternalSyntheticApiModelOutline0.m(this.mListeners.remove(windowInsetsControllerCompat$OnControllableInsetsChangedListener0));
