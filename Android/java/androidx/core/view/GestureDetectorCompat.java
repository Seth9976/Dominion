    ...
    static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent0) {
                ...
                switch(v & 0xFF) {
                    case 1: {
                        ...
                        if(this.mIsDoubleTapping) {
                            ...
                            float f6 = velocityTracker0.getYVelocity(v9);
                            float f7 = velocityTracker0.getXVelocity(v9);
                            z1 = Math.abs(f6) > ((float)this.mMinimumFlingVelocity) || Math.abs(f7) > ((float)this.mMinimumFlingVelocity) ? this.mListener.onFling(this.mCurrentDownEvent, motionEvent0, f7, f6) : false;
                        }
                    ...
                    case 2: {
                        if(!this.mInLongPress) {
                            ...
                            if(this.mAlwaysInTapRegion) {
                                ...
                                int v12 = v10 * v10 + v11 * v11;
                                if(v12 > this.mTouchSlopSquare) {
                                    z1 = this.mListener.onScroll(this.mCurrentDownEvent, motionEvent0, f8, f9);
                                    this.mLastFocusX = f2;
                                    this.mLastFocusY = f3;
                                    this.mAlwaysInTapRegion = false;
                                    this.mHandler.removeMessages(3);
                            ...
                            if(Math.abs(f8) >= 1.0f || Math.abs(f9) >= 1.0f) {
                                boolean z3 = this.mListener.onScroll(this.mCurrentDownEvent, motionEvent0, f8, f9);
                                this.mLastFocusX = f2;
                                this.mLastFocusY = f3;
                                return z3;
                            }
            ...
            if(this.mIsLongpressEnabled) {
                ...
                long v14 = (long)ViewConfiguration.getLongPressTimeout();
                this.mHandler.sendEmptyMessageAtTime(2, v13 + ((long)GestureDetectorCompatImplBase.TAP_TIMEOUT) + v14);
            }
            long v15 = this.mCurrentDownEvent.getDownTime();
            this.mHandler.sendEmptyMessageAtTime(1, v15 + ((long)GestureDetectorCompatImplBase.TAP_TIMEOUT));
