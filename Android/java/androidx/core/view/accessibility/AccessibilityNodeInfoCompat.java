...
public class AccessibilityNodeInfoCompat {
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            AccessibilityActionCompat.ACTION_SHOW_TEXT_SUGGESTIONS = new AccessibilityActionCompat(accessibilityNodeInfo$AccessibilityAction0, 0x1020058, null, null, null);
        }
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        public TouchDelegateInfoCompat(Map map0) {
            if(Build.VERSION.SDK_INT >= 29) {
                this.mInfo = Trace..ExternalSyntheticApiModelOutline0.m(map0);
                return;
            }
            this.mInfo = null;
        }
    ...
    public boolean isTextSelectable() {
        return Build.VERSION.SDK_INT < 33 ? false : Api33Impl.isTextSelectable(this.mInfo);
    }
