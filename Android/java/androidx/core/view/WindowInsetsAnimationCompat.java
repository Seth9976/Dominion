...
public final class WindowInsetsAnimationCompat {
    ...
    static class Impl30 extends Impl {
        static class ProxyCallback extends WindowInsetsAnimation.Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets0, List list0) {
                ...
                for(int v = list0.size() - 1; v >= 0; --v) {
                    WindowInsetsAnimation windowInsetsAnimation0 = ViewCompat..ExternalSyntheticApiModelOutline0.m(list0.get(v));
        ...
        Impl30(int v, Interpolator interpolator0, long v1) {
            this(ViewCompat..ExternalSyntheticApiModelOutline0.m(v, interpolator0, v1));
        }
        ...
        public static WindowInsetsAnimation.Bounds createPlatformBounds(BoundsCompat windowInsetsAnimationCompat$BoundsCompat0) {
            return ViewCompat..ExternalSyntheticApiModelOutline0.m(windowInsetsAnimationCompat$BoundsCompat0.getLowerBound().toPlatformInsets(), windowInsetsAnimationCompat$BoundsCompat0.getUpperBound().toPlatformInsets());
        }
