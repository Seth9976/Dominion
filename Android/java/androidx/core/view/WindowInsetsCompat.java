...
public class WindowInsetsCompat {
    ...
    static class BuilderImpl29 extends BuilderImpl {
        ...
        BuilderImpl29() {
            this.mPlatBuilder = ViewCompat..ExternalSyntheticApiModelOutline0.m();
        }

        BuilderImpl29(WindowInsetsCompat windowInsetsCompat0) {
            super(windowInsetsCompat0);
            WindowInsets windowInsets0 = windowInsetsCompat0.toWindowInsets();
            this.mPlatBuilder = windowInsets0 == null ? ViewCompat..ExternalSyntheticApiModelOutline0.m() : ViewCompat..ExternalSyntheticApiModelOutline0.m(windowInsets0);
        }
    ...
    static class Impl20 extends Impl {
        ...
        private Insets getVisibleInsets(View view0) {
            ...
            if(method0 != null && Impl20.sAttachInfoClass != null && Impl20.sVisibleInsetsField != null) {
                try {
                    Object object0 = zkcvv.invoke(method0, view0, null);
                    if(object0 == null) {
        ...
        private static void loadReflectionField() {
            try {
                Impl20.sGetViewRootImplMethod = View.class.getDeclaredMethod("getViewRootImpl", null);
                Class class0 = Class.forName("android.view.View$AttachInfo");
    ...
    static class Impl {
        ...
        @Override
        public int hashCode() {
            Insets insets0 = this.getSystemWindowInsets();
            Insets insets1 = this.getStableInsets();
            return ObjectsCompat.hash(new Object[]{Boolean.valueOf(this.isRound()), Boolean.valueOf(this.isConsumed()), insets0, insets1, this.getDisplayCutout()});
        }
        ...
        static int toPlatformType(int v) {
            ...
            for(int v2 = 1; v2 <= 0x100; v2 <<= 1) {
                if((v & v2) != 0) {
                    switch(v2) {
                        case 1: {
                            v1 |= ViewCompat..ExternalSyntheticApiModelOutline0.m();
                            break;
                        }
                        case 2: {
                            v1 |= ViewCompat..ExternalSyntheticApiModelOutline0.m$1();
                            break;
                        }
                        case 4: {
                            v1 |= Trace..ExternalSyntheticApiModelOutline0.m();
                            break;
                        }
                        case 8: {
                            v1 |= Trace..ExternalSyntheticApiModelOutline0.m$1();
                            break;
                        }
                        case 16: {
                            v1 |= Trace..ExternalSyntheticApiModelOutline0.m$2();
                            break;
                        }
                        case 0x20: {
                            v1 |= Trace..ExternalSyntheticApiModelOutline0.m$3();
                            break;
                        }
                        case 0x40: {
                            v1 |= Trace..ExternalSyntheticApiModelOutline0.m$4();
                            break;
                        }
                        case 0x80: {
                            v1 |= Trace..ExternalSyntheticApiModelOutline0.m$5();
                        }
                    }
                }
            }
