...
final class WeightTypefaceApi21 {
    ...
    private static long nativeCreateFromTypefaceWithExactStyle(long v, int v1, boolean z) {
        try {
            Long long0 = (Long)zkcvv.invoke(WeightTypefaceApi21.sNativeCreateFromTypeface, null, new Object[]{v, ((int)(z ? 2 : 0))});
            long0.longValue();
            return (long)(((Long)zkcvv.invoke(WeightTypefaceApi21.sNativeCreateWeightAlias, null, new Object[]{long0, v1})));
        }
        catch(IllegalAccessException illegalAccessException0) {
            throw new RuntimeException(illegalAccessException0);
        }
    ...
    private static long nativeCreateWeightAlias(long v, int v1) {
        try {
            return (long)(((Long)zkcvv.invoke(WeightTypefaceApi21.sNativeCreateWeightAlias, null, new Object[]{v, v1})));
        }
        catch(IllegalAccessException illegalAccessException0) {
            throw new RuntimeException(illegalAccessException0);
        }
