...
public final class ICUCompat {
    ...
    private static String addLikelySubtagsBelowApi21(Locale locale0) {
        ...
        if(method0 != null) {
            try {
                return (String)zkcvv.invoke(method0, null, new Object[]{s});
            }
    ...
    public static String maximizeAndGetScript(Locale locale0) {
        ...
        try {
            return Api21Impl.getScript(((Locale)zkcvv.invoke(ICUCompat.sAddLikelySubtagsMethod, null, new Object[]{locale0})));
        }
        catch(InvocationTargetException invocationTargetException0) {
            Log.w("ICUCompat", invocationTargetException0);
