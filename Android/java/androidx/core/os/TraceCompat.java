...
public final class TraceCompat {
    ...
    public static void beginAsyncSection(String s, int v) {
        ...
        try {
            zkcvv.invoke(TraceCompat.sAsyncTraceBeginMethod, null, new Object[]{TraceCompat.sTraceTagApp, s, v});
        }
    ...
    public static void endAsyncSection(String s, int v) {
        ...
        try {
            zkcvv.invoke(TraceCompat.sAsyncTraceEndMethod, null, new Object[]{TraceCompat.sTraceTagApp, s, v});
        }
        catch(Exception unused_ex) {
    ...
    public static boolean isEnabled() {
        ...
        try {
            return ((Boolean)zkcvv.invoke(TraceCompat.sIsTagEnabledMethod, null, new Object[]{TraceCompat.sTraceTagApp})).booleanValue();
        }
        catch(Exception unused_ex) {
    ...
    public static void setCounter(String s, int v) {
        ...
        try {
            zkcvv.invoke(TraceCompat.sTraceCounterMethod, null, new Object[]{TraceCompat.sTraceTagApp, s, v});
        }
        catch(Exception unused_ex) {
