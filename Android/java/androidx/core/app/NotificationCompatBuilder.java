...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    NotificationCompatBuilder(Builder notificationCompat$Builder0) {
        ...
        this.mBuilder = Build.VERSION.SDK_INT >= 26 ? NotificationCompat..ExternalSyntheticApiModelOutline0.m(notificationCompat$Builder0.mContext, notificationCompat$Builder0.mChannelId) : new Notification.Builder(notificationCompat$Builder0.mContext);
