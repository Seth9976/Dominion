...
public class NotificationCompat {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor0) {
            ...
            if(this.mPictureIcon != null) {
                if(Build.VERSION.SDK_INT >= 0x1F) {
                    ...
                    Api31Impl.setBigPicture(notification$BigPictureStyle0, this.mPictureIcon.toIcon(context1));
                }
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle bundle0) {
            ...
            if(arr_s2 != null && arr_s2.length == 1) {
                if(remoteInput0 != null) {
                    ...
                    boolean z = remoteInput0.getAllowFreeFormInput();
                    if(Build.VERSION.SDK_INT >= 29) {
                        v = remoteInput0.getEditChoicesBeforeSending();
                    }
                    notificationCompat$CarExtender$UnreadConversation0 = new RemoteInput(s1, charSequence0, arr_charSequence, z, v, remoteInput0.getExtras(), null);
                }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor0) {
            if(Build.VERSION.SDK_INT >= 24) {
                notificationBuilderWithBuilderAccessor0.getBuilder().setStyle(NotificationCompat..ExternalSyntheticApiModelOutline0.m());
            }
        }
        ...
        private RemoteViews generateActionButton(Action notificationCompat$Action0) {
            ...
            RemoteViews remoteViews0 = new RemoteViews("com.templegatesgames.DominionAndroid", (z ? layout.notification_action_tombstone : layout.notification_action));
            IconCompat iconCompat0 = notificationCompat$Action0.getIconCompat();
            if(iconCompat0 != null) {
                remoteViews0.setImageViewBitmap(id.action_image, this.createColoredBitmap(iconCompat0, this.mBuilder.mContext.getResources().getColor(color.notification_action_color_filter)));
            }
    ...
    public static class MessagingStyle extends Style {
        public static final class Message {
                ...
                try {
                    if(bundle0.containsKey("text") && bundle0.containsKey("time")) {
                        if(bundle0.containsKey("person")) {
                            ...
                            person0 = Person.fromAndroidPerson(NotificationCompat..ExternalSyntheticApiModelOutline0.m(bundle0.getParcelable("sender_person")));
                        }
                        else {
            ...
            Notification.MessagingStyle.Message toAndroidMessage() {
                ...
                if(Build.VERSION.SDK_INT >= 28) {
                    ...
                    notification$MessagingStyle$Message0 = NotificationCompat..ExternalSyntheticApiModelOutline0.m(charSequence0, v, person1);
                }
                else {
                    ...
                    notification$MessagingStyle$Message0 = NotificationCompat..ExternalSyntheticApiModelOutline0.m(charSequence1, v1, ((CharSequence)person1));
                }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor0) {
            ...
            if(Build.VERSION.SDK_INT >= 24) {
                Notification.MessagingStyle notification$MessagingStyle0 = Build.VERSION.SDK_INT < 28 ? NotificationCompat..ExternalSyntheticApiModelOutline0.m(this.mUser.getName()) : NotificationCompat..ExternalSyntheticApiModelOutline0.m(this.mUser.toAndroidPerson());
    ...
    public static abstract class Style {
        ...
        public RemoteViews applyStandardTemplate(boolean z, int v, boolean z1) {
            ...
            RemoteViews remoteViews0 = new RemoteViews("com.templegatesgames.DominionAndroid", v);
            int v1 = 0;
            ...
            if(this.mBuilder.mContentInfo != null) {
                ...
                if(this.mBuilder.mNumber > v9) {
                    ...
                    remoteViews0.setTextViewText(id.info, numberFormat0.format(((long)this.mBuilder.mNumber)));
                }
                remoteViews0.setViewVisibility(id.info, 0);
                z2 = true;
                v8 = 1;
            ...
            if(this.mBuilder.getWhenIfShowing() == 0L) {
                ...
                remoteViews0.setLong(id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
            ...
            remoteViews0.setViewVisibility(v10, v1);
            return remoteViews0;
        }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews0, RemoteViews remoteViews1) {
            ...
            remoteViews0.setViewPadding(id.notification_main_column_container, 0, this.calculateTopPadding(), 0, 0);
        }
        ...
        private Bitmap createIconWithBackground(int v, int v1, int v2, int v3) {
            ...
            Bitmap bitmap0 = this.createColoredBitmap(v4, v3, v1);
