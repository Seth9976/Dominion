                    ...
                    public void run() {
                        try {
                            if(ActivityRecreator.performStopActivity3ParamsMethod != null) {
                                zkcvv.invoke(ActivityRecreator.performStopActivity3ParamsMethod, ActivityRecreator.mainThreadField.get(activity0), new Object[]{object1, Boolean.FALSE, "AppCompat recreation"});
                                return;
                            }
                            zkcvv.invoke(ActivityRecreator.performStopActivity2ParamsMethod, ActivityRecreator.mainThreadField.get(activity0), new Object[]{object1, Boolean.FALSE});
                        }
