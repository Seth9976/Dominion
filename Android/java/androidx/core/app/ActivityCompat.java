...
public class ActivityCompat extends ContextCompat {
    ...
    public static void requestPermissions(Activity activity0, String[] arr_s, int v) {
        ...
        class androidx.core.app.ActivityCompat.1 implements Runnable {
            ...
            @Override
            public void run() {
                int[] arr_v = new int[this.val$permissionsArray.length];
                PackageManager packageManager0 = this.val$activity.getPackageManager();
                for(int v = 0; v < this.val$permissionsArray.length; ++v) {
                    arr_v[v] = packageManager0.checkPermission(this.val$permissionsArray[v], "com.templegatesgames.DominionAndroid");
                }
                ((OnRequestPermissionsResultCallback)this.val$activity).onRequestPermissionsResult(this.val$requestCode, this.val$permissionsArray, arr_v);
            }
        }
