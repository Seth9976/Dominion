...
public final class LocationRequestCompat {
    static class Api19Impl {
        ...
        public static Object toLocationRequest(LocationRequestCompat locationRequestCompat0, String s) {
            try {
                ...
                Object object0 = zkcvv.invoke(Api19Impl.sCreateFromDeprecatedProviderMethod, null, new Object[]{s, locationRequestCompat0.getIntervalMillis(), locationRequestCompat0.getMinUpdateDistanceMeters(), Boolean.FALSE});
                if(object0 == null) {
                    return null;
                }
                ...
                zkcvv.invoke(Api19Impl.sSetQualityMethod, object0, new Object[]{locationRequestCompat0.getQuality()});
                ...
                zkcvv.invoke(Api19Impl.sSetFastestIntervalMethod, object0, new Object[]{locationRequestCompat0.getMinUpdateIntervalMillis()});
                if(locationRequestCompat0.getMaxUpdates() < 0x7FFFFFFF) {
                    ...
                    zkcvv.invoke(Api19Impl.sSetNumUpdatesMethod, object0, new Object[]{locationRequestCompat0.getMaxUpdates()});
                }
                if(locationRequestCompat0.getDurationMillis() < 0x7FFFFFFFFFFFFFFFL) {
                    ...
                    zkcvv.invoke(Api19Impl.sSetExpireInMethod, object0, new Object[]{locationRequestCompat0.getDurationMillis()});
                }
                return object0;
            }
    ...
    public LocationRequest toLocationRequest(String s) {
        return Build.VERSION.SDK_INT < 0x1F ? Insets..ExternalSyntheticApiModelOutline0.m(Api19Impl.toLocationRequest(this, s)) : this.toLocationRequest();
    }
