...
public class ViewDragHelper {
    public static abstract class Callback {
        public int clampViewPositionHorizontal(View view0, int v, int v1) [...] // Inlined contents

        public int clampViewPositionVertical(View view0, int v, int v1) [...] // Inlined contents

        public int getOrderedChildIndex(int v) [...] // Inlined contents

        public int getViewHorizontalDragRange(View view0) [...] // Inlined contents
        ...
        public boolean onEdgeLock(int v) [...] // Inlined contents
    ...
    private boolean checkNewEdgeDrag(float f, float f1, int v, int v1) {
        float f2 = Math.abs(f);
        return (this.mInitialEdgesTouched[v] & v1) == v1 && (this.mTrackingEdges & v1) != 0 && (this.mEdgeDragsLocked[v] & v1) != v1 && (this.mEdgeDragsInProgress[v] & v1) != v1 && ((f2 > ((float)this.mTouchSlop) || Math.abs(f1) > ((float)this.mTouchSlop)) && (this.mEdgeDragsInProgress[v] & v1) == 0 && f2 > ((float)this.mTouchSlop));
    }
    ...
    private int computeSettleDuration(View view0, int v, int v1, int v2, int v3) {
        ...
        if(v4 != 0) {
            f = (float)v8;
            f1 = (float)v10;
            return v5 == 0 ? ((int)(((float)this.computeAxisDuration(v, v4, 0)) * (f / f1) + ((float)this.computeAxisDuration(v1, 0, 0)) * (((float)v7) / ((float)v11)))) : ((int)(((float)this.computeAxisDuration(v, v4, 0)) * (f / f1) + ((float)this.computeAxisDuration(v1, v5, 0)) * (((float)v9) / ((float)v10))));
        }
        f = (float)v6;
        f1 = (float)v11;
        return v5 == 0 ? ((int)(((float)this.computeAxisDuration(v, 0, 0)) * (f / f1) + ((float)this.computeAxisDuration(v1, 0, 0)) * (((float)v7) / ((float)v11)))) : ((int)(((float)this.computeAxisDuration(v, 0, 0)) * (f / f1) + ((float)this.computeAxisDuration(v1, v5, 0)) * (((float)v9) / ((float)v10))));
    }
    ...
    public void processTouchEvent(MotionEvent motionEvent0) {
        ...
        switch(v) {
            case 0: {
                ...
                int v14 = motionEvent0.getPointerId(0);
                View view1 = this.findTopChildUnder(((int)f8), ((int)f9));
                this.saveInitialMotion(f8, f9, v14);
                this.tryCaptureViewForDrag(view1, v14);
                boolean z = (this.mInitialEdgesTouched[v14] & this.mTrackingEdges) == 0;
                break;
            }
            case 1: {
                if(this.mDragState == 1) {
            ...
            case 2: {
                if(this.mDragState != 1) {
                    ...
                    while(v2 < v12) {
                        int v13 = motionEvent0.getPointerId(v2);
                        if(this.isValidPointerForActionMove(v13)) {
                            float f4 = motionEvent0.getX(v2);
                            float f5 = motionEvent0.getY(v2);
                            float f6 = f4 - this.mInitialMotionX[v13];
                            float f7 = f5 - this.mInitialMotionY[v13];
                            this.reportNewEdgeDrags(f6, f7, v13);
                            if(this.mDragState == 1) {
                                break;
                            }
                            View view0 = this.findTopChildUnder(((int)f4), ((int)f5));
                            if(!this.checkTouchSlop(view0, f6, f7) || !this.tryCaptureViewForDrag(view0, v13)) {
                                goto label_68;
                            }
                            break;
                        }
                    ...
                    int v8 = motionEvent0.findPointerIndex(this.mActivePointerId);
                    float f2 = motionEvent0.getX(v8);
                    float f3 = motionEvent0.getY(v8);
                    int v9 = this.mActivePointerId;
                    int v10 = (int)(f2 - this.mLastMotionX[v9]);
                    int v11 = (int)(f3 - this.mLastMotionY[v9]);
            ...
            case 5: {
                ...
                if(this.mDragState == 0) {
                    ...
                    if((this.mInitialEdgesTouched[v7] & this.mTrackingEdges) != 0) {
                        return;
                    }
                }
    ...
    public boolean shouldInterceptTouchEvent(MotionEvent motionEvent0) {
        ...
        switch(v) {
            case 0: {
                ...
                boolean z = (this.mInitialEdgesTouched[v2] & this.mTrackingEdges) == 0;
            ...
            case 2: {
                if(this.mInitialMotionX != null && this.mInitialMotionY != null) {
                    ...
                    for(int v4 = 0; v4 < v3; ++v4) {
                        ...
                        if(this.isValidPointerForActionMove(v5)) {
                            float f2 = motionEvent0.getX(v4);
                            float f3 = motionEvent0.getY(v4);
                            float f4 = f2 - this.mInitialMotionX[v5];
                            float f5 = f3 - this.mInitialMotionY[v5];
                            View view1 = this.findTopChildUnder(((int)f2), ((int)f3));
                            if(view1 != null && this.checkTouchSlop(view1, f4, f5)) {
                                view1.getLeft();
                                view1.getTop();
                                break;
                            }
                            this.reportNewEdgeDrags(f4, f5, v5);
                            if(this.mDragState != 1) {
                                continue;
                            }
                            break;
            ...
            case 5: {
                int v6 = motionEvent0.getPointerId(v1);
                float f6 = motionEvent0.getX(v1);
                float f7 = motionEvent0.getY(v1);
                this.saveInitialMotion(f6, f7, v6);
                int v7 = this.mDragState;
                if(v7 == 0) {
                    return (this.mInitialEdgesTouched[v6] & this.mTrackingEdges) == 0 ? this.mDragState == 1 : this.mDragState == 1;
                }
                if(v7 == 2) {
                    View view2 = this.findTopChildUnder(((int)f6), ((int)f7));
                    if(view2 == this.mCapturedView) {
                        this.tryCaptureViewForDrag(view2, v6);
                        return this.mDragState == 1;
                    }
                }
                break;
