...
public final class Trace {
    ...
    private static void beginAsyncSectionFallback(String s, int v) {
        try {
            ...
            zkcvv.invoke(Trace.sAsyncTraceBeginMethod, null, new Object[]{Trace.sTraceTagApp, s, v});
        }
    ...
    private static void endAsyncSectionFallback(String s, int v) {
        try {
            ...
            zkcvv.invoke(Trace.sAsyncTraceEndMethod, null, new Object[]{Trace.sTraceTagApp, s, v});
        }
        catch(Exception exception0) {
    ...
    private static boolean isEnabledFallback() {
        try {
            ...
            return ((Boolean)zkcvv.invoke(Trace.sIsTagEnabledMethod, null, new Object[]{Trace.sTraceTagApp})).booleanValue();
        }
        catch(Exception exception0) {
    ...
    private static void setCounterFallback(String s, int v) {
        try {
            ...
            zkcvv.invoke(Trace.sTraceCounterMethod, null, new Object[]{Trace.sTraceTagApp, s, v});
        }
        catch(Exception exception0) {
