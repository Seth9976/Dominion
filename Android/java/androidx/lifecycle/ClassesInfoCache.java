        ...
        void invokeCallback(LifecycleOwner lifecycleOwner0, Event lifecycle$Event0, Object object0) {
            try {
                switch(this.mCallType) {
                    case 0: {
                        zkcvv.invoke(this.mMethod, object0, null);
                        return;
                    }
                    case 1: {
                        zkcvv.invoke(this.mMethod, object0, new Object[]{lifecycleOwner0});
                        return;
                    }
                    case 2: {
                        zkcvv.invoke(this.mMethod, object0, new Object[]{lifecycleOwner0, lifecycle$Event0});
                    }
                }
            }
